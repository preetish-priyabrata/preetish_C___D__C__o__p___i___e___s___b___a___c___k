...
<div class="header">
  <div class="header-content">
    <div class="page-title"><i class="icon-display4"></i>View Candidate Application  List For Driver Post </div>
    <ul class="breadcrumb">
      <li><a href="admin_dashboard.php"></a></li>
      <li><a href="#"></a>Candidate Application Form System</li>
      <li class="active">Candidate Application  List For Driver Post </li>
    </ul>
  </div>
</div>
<div class="container-fluid page-content">
  ...
  <div class="container-fluid page-content">
    <div class="row">
     ...
     // WHERE condition
                     $paids="SELECT * FROM `ilab_group_candidate_info` left JOIN `ilab_payment_info` on ilab_payment_info.slno_group_pay=ilab_group_candidate_info.paid_id_slno  WHERE ilab_group_candidate_info.candidate_mobile='$result[candidate_mobile]' AND ilab_group_candidate_info.paid_status='1' and ilab_group_candidate_info.group_id_slno='1'";

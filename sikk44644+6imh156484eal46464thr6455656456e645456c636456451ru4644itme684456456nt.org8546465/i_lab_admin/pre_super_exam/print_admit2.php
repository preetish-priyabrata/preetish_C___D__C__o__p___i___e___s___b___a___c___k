            ...
            <div class="row">
              ...
              <!-- <div style="text-align:center;"> -->
                <h4 style="text-transform:uppercase; ">
                 ...
                 <strong>DEPARTMENT OF HEALTH CARE, HUMAN SERVICES AND FAMILY WELFARE</strong><br>
                 <small><u>TASHILING SECRETARIAT, GANGTOK</u></small>
                 </h4>
                  <h5 style="text-transform:uppercase; "><b>e-Admit Card <?=date('Y')?></b> </h5>              
              <!-- </div> -->
            </div>
                            ...
                            <table class="table table-bordered" align="center"  cellspacing="0" cellpadding="1" >
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td></td>         
                                  <td rowspan="10" width="10%"><img src="../../images/photo/<?=$res_cand_info['candidate_photo']?>" alt="" style="width: 330px; height: 404px;" id="photopreview" name="photopreview">
                                ...
                                <tr>
                                  ...
                                  <td>:</td>         
                                  <td><small class="text-capitalize"><?=$res_cand_info['candidate_gender']?></small></td>
                                  <td></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td>:</td>         
                                  <td><small>06-May-2018</small></td>
                                  <td></td>  
                                </tr>
                                <tr>
                                  <td><label>Exam Time</label></td>
                                  <td>:</td>         
                                  <td><small><?php if($res_exam['slno_group']==1){
                            ...
                            <table cellspacing="0" cellpadding="1" align="Center" width="100%">
                              <thead>
                                <tr>
                                  ...
                                  <th><br>&nbsp;&#160;</th>
                                  <th><br>&nbsp;&#160;</th>
                                  <th><img style="width:150px; height:100px;" src="sing_logo.png"/>

                            ...
                            <table class="table table-bordered" align="center"  cellspacing="0" cellpadding="0" >
                              ...
                              <tbody>
                                      ...
                                      <!-- <div class="col-md-6"> -->
                                        <!-- <div class="thumbnail"> -->
                                          <!-- <a href="/w3images/lights.jpg"> -->
                                            ...
                                            <!-- <div class="caption">
                                              <p><?=$res_cand_info['candidate_name']?></p>
                                            </div> -->
                                          <!-- </a> -->
                                        <!-- </div> -->
                                      <!-- </div> -->
                               ...
                               <!--  <tr>
                                  ...
                                  <td>:</td>         
                                  <td colspan="2"><small class="text-capitalize"><?=$res_cand_info['candidate_gender']?></small></td>
                                
                                </tr> -->
                                <!-- <tr>
                                  <td><label>Application No </label></td>
                                  <td>:</td>         
                                  <td colspan="2"><small><?=$res['candidate_application']?></small></td>

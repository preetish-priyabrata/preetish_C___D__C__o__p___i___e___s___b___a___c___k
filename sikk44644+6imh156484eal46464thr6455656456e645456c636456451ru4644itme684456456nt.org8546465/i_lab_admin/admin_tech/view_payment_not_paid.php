...
?>
    ...
    <div class="header">
        <div class="header-content">
            <div class="page-title"><i class="icon-display4"></i>view Unpaid List </div>
            <ul class="breadcrumb">
                <li><a href="#">Manage Payment</a></li>
                <li class="active">View Unpaid List</li>
            </ul>
        </div>
    </div>
    <!-- /Page Header-->
        ...
        <?php $msg->display(); ?>
             ...
             <table id="example21" class="display nowrap" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php 
                                        $x=0;
                                        $query_sql="SELECT * FROM `ilab_payment_info` WHERE `payment_status`='0'";

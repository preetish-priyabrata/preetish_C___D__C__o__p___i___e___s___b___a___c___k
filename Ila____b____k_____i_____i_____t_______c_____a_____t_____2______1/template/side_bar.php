            ...
            <div class="menu-container screen">
               <ul class="sidebar-accordion">
                 ...
                 <li><a href="enquiryList.php"><i class="icon-display4"></i><span class="list-label"> Enquiry List</span></a></li>
                    <li><a href="#"><i class="icon-stack2"></i> <span>Requsition Information</span></a>
                       <ul> 
                             <li><a href="zonal_mr_raised.php">Raise M.R <span class="label label-success">New</span></a></li>                           
                            <li class="acc-parent-li">
                                <a href="#" class="acc-parent">M.R Histroy<span class="acc-icon"></span></a>
                                <ul style="display: block;">
                                    <!-- <li><a href="admin_location_add_hq.php">Add HQ <span class="label label-success">New</span></a></li> -->
                                    
                                    <li><a href="admin_location_add_hq_view.php"></a>M.R Received</li>
                                    <li><a href="admin_location_add_hq_view.php">M.R Send</a></li>
                                </ul>
                            </li>
                           <!--  <li class="acc-parent-li">
                    ...
                    <!-- end of location -->
                   <!--  <li><a href="#"><i class="icon-stack2"></i> <span>Machine Category</span></a>
                        <ul> 
                            <li><a href="admin_add_machine_category.php">Add Category <span class="label label-success">New</span></a></li>
                            <li><a href="admin_add_machine_category_view.php">View Category</a></li>
                        </ul>
                    </li>  --> 

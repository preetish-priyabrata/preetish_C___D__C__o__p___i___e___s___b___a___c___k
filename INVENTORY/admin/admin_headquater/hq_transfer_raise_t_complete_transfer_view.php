			...
			<div class="col-md-12 col-sm-12">
				<div class="panel panel-default">
			   		<div class="panel-heading">
						<div class="panel-title">List Of Transfer Request Completed </div>
				    </div>
			        		...
			        		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
				        		...
				        		<tbody>
									...
									?></td>
				        				...
				        				<td><?=strtoupper($result['issue_date'])?></td>
				        				<td><?=strtoupper($result['issue_time'])?></td>
				        				<td><?=strtoupper($result['challan_id_mr'])?></td
				        			</tr>
				        				<?php }?>
				        		</tbody>
			    			</table>

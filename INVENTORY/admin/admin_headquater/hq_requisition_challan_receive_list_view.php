	...
	<div class="header">
		<div class="header-content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">View Material Received </li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
				     ...
				     <div class="panel-body">
					    ...
					    <table id="example77" class="display nowrap" width="100%" cellspacing="0">
				        	...
				        	<tbody>
				        		...
				        		$x=0;
		        				$GET_INFO="SELECT * FROM `lt_master_hq_challan_generate` WHERE `hqcg_site_mr_id`='$hqcg_site_mr_id' and `hqcg_status`='1' and `hqcg_receive_status`='1'";
		        				...
		        				while ($res=mysqli_fetch_assoc($sql_exe)) {
		        					...
		        					<tr>
									    ...
									    <td><?=strtoupper($res['hqcg_challan_no'])?></td>
			 						    <td><?=strtoupper($res['hqcg_date'])?></td>
			 						    <td><?=strtoupper($res['hqcg_time'])?></td>
			 						    <td>
			 						    	<a class="btn btn-default btn-xs" style="background: lightgreen" href="hq_requisition_challan_receive_view.php?token_name=<?=$lid?>&Token_id=<?=$site_list?>&access=<?php echo web_encryptIt('3')?>" target="_blank" >View Received Detail</a>

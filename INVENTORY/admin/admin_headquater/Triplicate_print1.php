                    ...
                    <table class="table" id="table_data">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><small style='line-height:1.5; font-size:10px; margin-bottom: 0px;'><?=strtoupper($fetch_item['hqzis_primary_id'])?></small></td>
        ...
        <div class="table-responsive">
          <div class="Deposit">
            <table class="table">
                ...
                <tr>
                  <th>In Words:</th>
                  <td>Rs. <?=strtoupper(convertNum($Total_id1))?></td>
                </tr>

				 ...
				 <div class="panel-title">Requsition Detail</div>
				     ...
				     <div class="panel-body">
					   	<form name="myFunction" class="form-horizontal" action="approver_mr_raised_detail_issue_section_save.php" method="POST" >
							...
							<div class="form-group">
							    ...
							    <div class="col-lg-8">
									...
									<p><?=strtoupper($zmr_unqiue_mr_id)?></p>
							   </div>
							</div>
							<div class="form-group">
						...
						<div class="col-lg-6">
							...
							<div class="form-group">
							    <label class="control-label col-lg-4 text-right"> Indent Date : </label>
							    <div class="col-lg-8">
									
									<input type="text" name="Indent_dated" class="form-control" data-toggle="datepicker" placeholder="Enter Date"  required="">
							   </div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							    <label class="control-label col-lg-4 text-right">Place To : </label>
							    <div class="col-lg-8">
									
									<input type="text" name="place_to" class="form-control" placeholder="Enter Place Name "  required="">
							   </div>
							</div>
							<br>
						</div>
					        					...
					        					<tbody>
					        						<?php 
                                                        ...
                                                        <tr>
					        								...
					        								<td><?=strtoupper($fetch_item['hqzis_item_name'])?></td>
		 	   	  ...
		 	   	  <input type="submit" class="btn btn-success btn-md" name="Next" onclick="return confirm('Are you sure you want to Issue This Challan To Zonal Site?');" value="Complete Issue">
		 	   </div>
			</form>
			</div>
			</div>						

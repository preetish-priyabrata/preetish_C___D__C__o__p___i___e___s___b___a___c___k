                       		...
                       		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
	        					...
	        					<tbody>
	        						<?php
	        						   ...
	        						   <tr>
		                 				<td><?=$x?></td> 									    
						                <td><?=strtoupper($fetch_item['zonal_damage_challan'])?></td>
						                <td><?php 
									...
									?></td>
						                ...
						                <td><?=$fetch_item['time_entry']?></td>
						                 <td>
				        					<a class="btn btn-success btn-xs" href="headquarter_return_challan_list_view.php?token_name=<?=$lid?>&token_id=<?=$site_list?>" >View Detail <br>Confirm Receive Of Damage</a>
				        				</td>
		            					</tr>
	        						<?php
	        						}

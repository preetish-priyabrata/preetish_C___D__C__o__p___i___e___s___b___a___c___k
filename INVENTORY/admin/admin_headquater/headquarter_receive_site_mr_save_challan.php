...
.panel-body p {
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>Saved Challan List</div>
			<ul class="breadcrumb">
				<li><a href="zonal_dashboard.php"></a></li>
				<li class="">Dashboards</li>
				<li class="">Saved Challan</li>
				<li class="active">S.M.R Saved Challan List</li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
		 ...
		 <div class="col-md-12 col-sm-12">
			 ...
			 <div class="panel panel-default">
			   <div class="panel-heading">
				 <div class="panel-title">List Of Saved Challan</div>
				   </div>

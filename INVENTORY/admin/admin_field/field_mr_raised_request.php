...
.form-control[disabled],.form-control[readonly] {
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>View F.M.R Of List</div>
			<ul class="breadcrumb">
				<li><a href="zonal_dashboard.php"></a></li>
				<li class="">Dashboards</li>
				<li class="">F.M.R Management </li>
				<li class="active">View F.M.R Of List </li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
			...
			<div class="col-md-12 col-sm-12">
			 ...
			 <div class="panel panel-default">
			   <div class="panel-heading">
				 <div class="panel-title">F.M.R Of List Details</div>
				   </div>
					   	...
					   	<div class="table-responsive">
                       		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
    							...
    							$x=0;
    							 ...
    							 $item="SELECT * FROM `lt_master_field_material_requsition` WHERE `fmr_site_from_location_id`='$field_place' and `send_mr_zonal`='0' and `status`='1' order by `fmr_slno` desc";

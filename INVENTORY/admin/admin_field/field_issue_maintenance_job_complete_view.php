					   	...
					   	<div class="table-responsive">
			        		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
				        		...
				        		<tbody>
				        			<?php 
				        				$x=0;
				        				echo $Requsition_query="SELECT * FROM `lt_master_field_maintenance_job`  ";
				        			...
				        			<tr>
				        				...
				        				<td><a class="btn btn-success" href="field_maintenance_new_issue_view.php?token_name=<?=$lid?>&Token_id=<?=$site_list?>&access=<?php echo web_encryptIt('3')?>" >Click To View</a>

...
if($_SESSION['admin']){
 ...
 // exit;
  ...
  $num=mysqli_num_rows($sql_check); // check it number rows is affected 
    ...
    if($num==0){
            $query ="UPDATE `lt_master_zonal_place` SET `zonal_name`='$zonal_name',`address_1`='$address1',`address_2`='$address2',`address_3`='$address3',`address_4`='$address4',`address_5`='$address5',`address_6`='$address6',`address_7`='$address7',`address_8`='$address8' , `address9`='$address9' WHERE `slno`='$slno'";

...
?>
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>List Machine History Of Assigned Location</div>
			<ul class="breadcrumb">
			  	<li><a href="admin_dashboard.php"></a></li>
			   	<li><a href="#"></a>Assign Machine Information</li>
			 	<li class="active">Machine History Of Assigned Location</li>
			</ul>
		</div>
	</div>
			...
			<div class="col-md-12 col-sm-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="panel-title">Machine History Of Assigned Location </div>
					</div>
						 ...
						 <div class="table-responsive">
                           <table id="example" class="display nowrap table" width="100%" cellspacing="0">
	        					...
	        					<tbody>
	        						<?php 
	        							$x=0;
	        							$query_sql="SELECT * FROM `lt_master_machine__transfer_information` WHERE `t_status`='2' order by `slno` desc ";

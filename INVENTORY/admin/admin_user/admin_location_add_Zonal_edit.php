						...
						<form class="form-horizontal" action="admin_location_add_Zonal_edit_save.php" method="POST">
                         <?php
               			...
               			<input type="hidden" value="<?php echo $rec['slno']; ?>" name="slno">
							...
							<div class="form-group">
								<label class="control-label col-lg-4 text-right">GSTN No</label>
								<div class="col-lg-8">
									<input value="<?php echo strtoupper($rec['address9']);?>" class="form-control" name="address9" placeholder="Enter GSTN No" type="number" required="">
								</div>
							</div>

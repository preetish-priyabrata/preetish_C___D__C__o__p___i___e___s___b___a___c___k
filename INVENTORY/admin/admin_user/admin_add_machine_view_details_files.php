...
?>
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>Machine Attach More Files</div>
			<ul class="breadcrumb">
			  	<li><a href="admin_dashboard.php"></a></li>
			   	<!-- <li><a href="#"></a>Assign Machine Information</li> -->
			 	<li class="active">Machine Attach More Files</li>
			</ul>
		</div>
	</div>
			  ...
			  <div class="panel panel-default">
				  <div class="panel-heading">
					 <div class="panel-title">Machine Info</div>
					    	...
					    	<form action="admin_add_machine_view_details_files_save.php" method="POST" enctype="multipart/form-data">
                         ...
                         <div class="pull-right">
                         	<input type="submit" name="complete" value="Click To Complete" onclick="return confirm('Are you sure? Want to Continue');">
					</div>
				</div>						
			</div>
		</div>

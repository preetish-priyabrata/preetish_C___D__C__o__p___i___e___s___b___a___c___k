				                           ...
				                           <table id="example77" class="display nowrap table" width="100%" cellspacing="0">
					        					...
					        					<tbody>
					        						<?php 
										                ...
										                <td><?=$zmrd_second_code=strtoupper($fetch_item['zmrd_second_code'])?></td>	
										                 <td><?=$zmrd_second_code=strtoupper($fetch_item['zmrd_second_code'])?></td>	
										               ...
										               <td><?=strtoupper($fetch_item['zmrd_category_name'])?></td>
										                ...
										                <td><input type="text" name="remarks_detail[]" placeholder="Please Enter Remark" value="<?=strtoupper($fetch_item['remark_id'])?>" required ></td>

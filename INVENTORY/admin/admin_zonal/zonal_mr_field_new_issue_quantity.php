										         ...
										         <thead>
					        						...
					        						<?php 
					        						   ...
					        						   <tr>
						                 				<td><?=$x?></td>
				 									    <!-- <td>Primary Code</td> -->
										                <td><?=strtoupper($fetch_item['zqzis_primary_id'])?></td><input type="hidden" name="fmrd_slno[]" value="<?=$fetch_item['fmrd_slno']?>" required=""><input type="hidden" name="zqzis_slno[]" value="<?=$fetch_item['zqzis_slno']?>" required="">

...
.form-control[disabled],.form-control[readonly] {
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>Stock Returned Challan Received From Field</div>
			<ul class="breadcrumb">
				<li><a href="zonal_dashboard.php"></a></li>
				<li class="">Dashboards</li>
				<li class="">Return Management</li>
				<li class="active">Stock Return Challan From Field</li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
			...
			<div class="col-md-12 col-sm-12">
			 ...
			 <div class="panel panel-default">
			   <div class="panel-heading">
				 <div class="panel-title">Return Challan Received From Field </div>
				   </div>
                       		...
                       		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
	        					...
	        					<tbody>
	        						<?php
	        							...
	        							$x=0;
	        							$item="SELECT * FROM `lt_master_field_challan_damage` WHERE `location_to`='$zonal_place' and `receive_status`='0' order by `slno` desc ";
									...
									?></td>
						                ...
						                <td><?=$fetch_item['time_entry']?></td>
						                 <td>
						                 	<a class="btn btn-success btn-xs" href="zonal_stock_challan_return_field_view.php?token_name=<?=$lid?>&token_id=<?=$site_list?>" >View Detail <br>Confirm Receive Of Damage</a>
				        					<!-- <div class="btn-group">

 ...
 */
    ...
    function user_hhi_crop_info_post(){   
        ...
        if($this->post('employee_id') && $this->post('employee_id')!="" && $this->post('userid') && $this->post('userid')!="" && $this->post('type_form_input') && $this->post('type_form_input')!="" && $this->post('your_id_delete_crop') && $this->post('your_id_delete_crop')!=""){
        ...
        if($this->post('employee_id') && $this->post('employee_id')!="" && $this->post('userid') && $this->post('userid')!=""
           ...
           $data=array('employee_id'=>trim($this->post('employee_id')),'status'=>'1','assign_status'=>'1','sl_no'=>trim($this->post('userid')));
            ...
            switch ($activity) {
                ...
                default:
                     $det= array('response_status'=>"2",'msg'=>"Invalid User2");
                    $this->response($det, 200);
                    break;
            }
              // array('Thematic_key' =>1 ,'Thematic_name'=>'HKG'),
    ...
    function user_lst_info_post(){  
        ...
        if($this->post('employee_id') && $this->post('employee_id')!="" && $this->post('userid') && $this->post('userid')!="" && $this->post('district_name') && $this->post('district_name')!="" && $this->post('block_name') && $this->post('block_name')!=""  && $this->post('GP_name') && $this->post('GP_name')!="" && $this->post('Village_name') && $this->post('Village_name')!="" && $this->post('enter_lat') && $this->post('enter_lat')!="" && $this->post('enter_long') && $this->post('enter_long')!="" && $this->post('month_no') && $this->post('month_no')!=""  && $this->post('present_year') && $this->post('present_year')!="" && $this->post('care_hhi_slno') && $this->post('care_hhi_slno')!="" && $this->post('Spouse') && $this->post('Spouse')!="" && $this->post('care_hhi') && $this->post('care_hhi')!="" && $this->post('women_name') && $this->post('women_name')!="" && $this->post('your_id_delete_lst_id') && $this->post('your_id_delete_lst_id')!="" ){
                ...
                if($this->post('male_present') && $this->post('male_present')!="" && $this->post('female_present') && $this->post('female_present')!="" && $this->post('traget_active_id') && $this->post('traget_active_id')!="" && $this->post('demostration_date') && $this->post('demostration_date')!="" && $this->post('device_implement_status') && $this->post('device_implement_status')!="" && $this->post('farmer_implement_male') && $this->post('farmer_implement_male')!="" && $this->post('farmer_implement_female') && $this->post('farmer_implement_female')!="" && $this->post('implemant_device_name') && $this->post('implemant_device_name')!="" && $this->post('class_training_status') && $this->post('class_training_status')!=""){
     ...
     function user_live_stock_info_post(){ 
        if($this->post('employee_id') && $this->post('employee_id')!="" && $this->post('userid') && $this->post('userid')!="" && $this->post('district_name') && $this->post('district_name')!="" && $this->post('block_name') && $this->post('block_name')!=""  && $this->post('GP_name') && $this->post('GP_name')!="" && $this->post('Village_name') && $this->post('Village_name')!="" && $this->post('enter_lat') && $this->post('enter_lat')!="" && $this->post('enter_long') && $this->post('enter_long')!="" && $this->post('month_no') && $this->post('month_no')!=""  && $this->post('present_year') && $this->post('present_year')!="" && $this->post('care_hhi_slno') && $this->post('care_hhi_slno')!="" && $this->post('Spouse') && $this->post('Spouse')!="" && $this->post('care_hhi') && $this->post('care_hhi')!="" && $this->post('women_name') && $this->post('women_name')!="" && $this->post('your_id_delete_livestock_id') && $this->post('your_id_delete_livestock_id')!="" && $this->post('type_insert_live_stock') && $this->post('type_insert_live_stock')!=""  ){
                if($this->post('input_training') && $this->post('input_training')!="" && $this->post('input_extension_suport') && $this->post('input_extension_suport')!="" && $this->post('input_medicine') && $this->post('input_medicine')!="" && $this->post('input_vaccination') && $this->post('input_vaccination')!=""  && $this->post('input_other') && $this->post('input_other')!="" && $this->post('animal_present_no') && $this->post('animal_present_no')!="" && $this->post('cultivating_fodder') && $this->post('cultivating_fodder')!="" && $this->post('cultivated_area_fodder') && $this->post('cultivated_area_fodder')!="" && $this->post('new_farmer') && $this->post('new_farmer')!=""  && $this->post('continued_farmer') && $this->post('continued_farmer')!="" && $this->post('care_LS_QP_extension_support') && $this->post('care_LS_QP_extension_support')!=""  ){
                ...
                switch ($type_live_stock_insert) {
                    case '1':
                        $live_stock_data = array(
                            'care_LS_hhid'=>trim($this->post('care_hhi')),
                            'care_LS_women_farmer'=>trim($this->post('women_name')),
                            'care_LS_spouse_name'=>trim($this->post('Spouse')),

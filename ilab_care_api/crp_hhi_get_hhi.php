                              ...
                              <td>
                                <select class="form-control" name="form_id" required="">
                                  ...
                                  <optgroup label="Crop Diversification Farmland">
                                    ...
                                    <!-- 
                                      <option value="1">Pulses Farmland</option>
                                    <option value="2">Legumes Farmland</option>
                                    <option value="3">Vegetables Farmland</option> -->
                                  </optgroup>
                                  <optgroup label="Crop Diversification Kitchen Garden">
                                    <option value="4">Kitchen Garden</option>
                                    <!-- <option value="4">Pulses Kitchen Garden</option>
                                    <option value="5">Legumes Kitchen Garden</option>
                                    <option value="6">Vegetables Kitchen Garden</option> -->
                                  </optgroup>

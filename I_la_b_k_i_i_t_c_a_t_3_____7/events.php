                                        ...
                                        <ul class="list-unstyled clear-margins">
                                            ...
                                            <li class="widget-container widget_recent_news"><!-- widgets list -->
                                                ...
                                                <ul class="list-unstyled list-downloads"><!-- downloads list -->
                                                    ...
                                                    $query = "SELECT * FROM `tbl_notice` WHERE `upload_type` = 'Event' AND `notice_status` = 'Active'  ORDER BY notice_id DESC ";
                                                    ...
                                                    while ($row = mysqli_fetch_array($res)) {
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="<?php echo "../cs/" . $row['notice_doc']; ?>" download title="Notice" class="download-link">

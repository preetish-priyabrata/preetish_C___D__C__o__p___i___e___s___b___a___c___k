                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div id="accordion" class="panel-group">
                                            ...
                                            if (!isset($_GET['c']) || empty($_GET['c'])) {
                                                ...
                                                include_once './course/ibm-course-list.php';
                                            } else {
                                                ...
                                                if ($id == 'ibm136') {
                                                    ...
                                                    include_once './course/ibm136.php';
                                                } elseif ($id == 'ibm819') {

                                                    include_once './course/ibm819.php';
                                                } elseif ($id == 'ibmDB2') {

                                                    include_once './course/ibmDB2.php';
                                                } elseif ($id == 'ibmWebSphere') {

                                                    include_once './course/ibmWebSphere.php';
                                                } else {
                                                    ?>

                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div id="accordion" class="panel-group">
                                            ...
                                            if (!isset($_GET['c']) || empty($_GET['c'])) {
                                                ...
                                                include_once './course/oracle-course-list.php';
                                            } else {
                                                ...
                                                if ($id == 'oracle285') {
                                                    ...
                                                    include_once './course/oracle285.php';
                                                } elseif ($id == 'oracle110') {

                                                    include_once './course/oracle110.php';
                                                } elseif ($id == 'oracleIntro') {

                                                    include_once './course/oracleIntro.php';
                                                } elseif ($id == 'oraclePlSql') {

                                                    include_once './course/oraclePlSql.php';
                                                } elseif ($id == 'oracleServJsp') {

                                                    include_once './course/oracleServJsp.php';
                                                } else {
                                                    ?>

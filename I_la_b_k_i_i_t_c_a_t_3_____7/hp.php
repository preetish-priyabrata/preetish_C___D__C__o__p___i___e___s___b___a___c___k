                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div id="accordion" class="panel-group">
                                            ...
                                            if (!isset($_GET['c']) || empty($_GET['c'])) {
                                                include_once './course/hp-course-list.php';
                                            } else {
                                                ...
                                                if ($id == 'hpA01') {
                                                    ...
                                                    include_once './course/hpA01.php';
                                                } elseif ($id == 'hpA02') {

                                                    include_once './course/hpA02.php';
                                                } elseif ($id == 'hpA03') {

                                                    include_once './course/hpA03.php';
                                                } elseif ($id == 'hpA04') {

                                                    include_once './course/hpA04.php';
                                                } else {
                                                    ?>

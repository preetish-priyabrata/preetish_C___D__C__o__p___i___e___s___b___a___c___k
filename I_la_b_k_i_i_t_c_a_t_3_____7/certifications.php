                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <div id="accordion" class="panel-group">
                                            ...
                                            if (!isset($_GET['c']) || empty($_GET['c'])) {
                                                include_once './course/microsoft-course-list.php';
                                            } else {
                                                ...
                                                if ($id == 'mta372') {
                                                    ...
                                                    include_once './course/mta372.php';
                                                } elseif ($id == 'mta373') {

                                                    include_once './course/mta373.php';
                                                } elseif ($id == 'mta374') {

                                                    include_once './course/mta374.php';
                                                } elseif ($id == 'mta365') {

                                                    include_once './course/mta365.php';
                                                } elseif ($id == 'mta366') {

                                                    include_once './course/mta366.php';
                                                } elseif ($id == 'mta367') {

                                                    include_once './course/mta367.php';
                                                } elseif ($id == 'mta361') {

                                                    include_once './course/mta361.php';
                                                } elseif ($id == 'mta362') {

                                                    include_once './course/mta362.php';
                                                } elseif ($id == 'mta364') {

                                                    include_once './course/mta364.php';
                                                } else {
                                                    ?>

...
//Module details    
                                            ...
                                            if (isset($_GET['r'])) {
                                                ...
                                                include "./course/trainingModule_course.php";
                                            } else {
                                                //Find All Active Program List
                                                $queryCourse = "SELECT * FROM `tbl_program` WHERE `program_status` = '1'";
                                                        ...
                                                        <div class = "panel panel-default">
                                                            ...
                                                            <div class = "panel-collapse collapse" id = "collapse<?php echo $i; ?>">
                                                                <div class = "panel-body">
                                                                    <p><a href="training_course.php?r=<?php echo encryptIt_webs($rowCourse['sl_no']) ?>">Click Here</a> to View Details</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <?php

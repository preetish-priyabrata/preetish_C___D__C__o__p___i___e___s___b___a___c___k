			...
			<div class="col-md-12 col-sm-12">
				<div class="panel panel-default">
			   		<div class="panel-heading">
						<div class="panel-title">List Of Transfer Challan To Be Generated </div>
				    </div>
			        		...
			        		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
				        		...
				        		<tbody>
				        			<?php 
				        				...
				        				$x=0;
				        				$Requsition_query="SELECT * FROM `lt_master_hq_transfer_mr_zonal` WHERE `location_to`='$hq_store_id' and `request_status`='1' and  `issue_status`='1' ";
				        				...
				        				<td>
				        					<div class="btn-group">
			                                    ...
			                                    <ul class="dropdown-menu">
			                                        <li><a href="hq_transfer_raise_t_issue_view.php?token_name=<?=$lid?>&token_id=<?=$site_list?>&status=<?php echo web_encryptIt('3')?>" >Generate Challan</a></li>
			                                        <li class="divider"></li>
			                                    </ul>
			                                </div>
				        				</td>

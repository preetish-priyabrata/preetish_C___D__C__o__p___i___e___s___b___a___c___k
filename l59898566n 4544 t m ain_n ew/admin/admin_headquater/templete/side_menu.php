               ...
               <ul class="sidebar-accordion">
                 ...
                 <li><a href="#"><i class="icon-stack2"></i> <span>Stock Management</span></a>
                    ...
                    <li><a href="#"><i class="icon-stack2"></i> <span>Return Challan Mgnt</span></a>
                        <ul> 
                            <li><a href="headquarter_return_challan_list.php">History Of Return Challan<span class="label label-success">New</span> </a></li>
                          <!--   <li><a href="#">History Of Return Challan Received  </a></li> -->
                        </ul>
                    </li>
                    ...
                    <li><a href="#"><i class="icon-stack2"></i> <span>Transfer Management</span></a>
                        <ul> 
                            ...
                            <li><a href="hq_transfer_raise_t_issue.php">Issue Of Tranfer MR From HQ</a></li>

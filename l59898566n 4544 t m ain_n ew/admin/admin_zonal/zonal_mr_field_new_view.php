					   	...
					   	<form name="myFunction" class="form-horizontal" action="approver_mr_raised_detail_issue_section_save.php" method="POST" >
						   	...
						   	<div class="col-lg-6">
						   	 <div class="form-group">
								    ...
								    <div class="col-lg-8">
								    <p><?=$fetch_check['fmr_site_from_location_id']?></p>
							   </div>
							</div>
							<div class="form-group">
					        					...
					        					<tbody>
					        						<?php 
					        						   ...
					        						   <tr>
										                ...
										                <td><?=$fetch_item['fmrd_name_item']?></td>
										              	<td><?=$fetch_item['fmrd_category_name']?></td>
										                <td><?=$fetch_item['maintenance_id']?>
										                </td>
										                <td><?=$fetch_item['fmrd_units_required']?>
										                </td>
										                <td><?=$fetch_item['fmrd_request_qnt']?>
										                </td>

					        					...
					        					<tbody>
					        						<?php 
					        							...
					        							while ($fetch_item=mysqli_fetch_assoc($sql_item_exe)) {
						                 				...
						                 				<td><?=$x?></td>
				 									    <!-- <td>Primary Code</td> -->
										                <td><?=$zmrd_second_code=$fetch_item['zmrd_second_code']?></td>					<input type="hidden" name="slno_item[]" value="<?=$fetch_item['zmrd_slno']?>" required=""> 	    
										               <td><?=$fetch_item['zmrd_category_name']?></td>
										              	<td><?=$fetch_item['zmrd_machine_no']?></td>
										              	<?php 
										                ...
										                <td><input type="number" name="quantity_req[]" placeholder="Please Enter Quantity" required=""> <?=$fetch_item['zmrd_units_required']?></td>

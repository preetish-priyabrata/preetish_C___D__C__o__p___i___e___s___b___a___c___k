				                           ...
				                           <table id="" class="display nowrap table table-bordered" width="100%" cellspacing="0">
					        					...
					        					<tfoot>
					                				...
					                				<?php 
										                	...
										                	?>
					                					<td><?=$fmrd_name_item=$fetch_details['fmrd_name_item']?>
										                </td>
										                <!-- Item Name -->
										                <td><?=$maintenance_id=$fetch_details['maintenance_id']?>
										                </td>
										                <!-- Machine No -->
										                <td><?=$fmrd_request_qnt=$fetch_details['fmrd_request_qnt']?>
										                </td>
										                <!-- Request Quantity -->
										                <td><?=$zqzis_issue_qnt=$fetch_item['zqzis_issue_qnt']?>
										                </td>

				        				...
				        				<td>
				        					<div class="btn-group">
			                                    ...
			                                    <ul class="dropdown-menu">
			                                        <li><a href="zonal_mr_field_new_view.php?token_name=<?=$lid?>&Token_id=<?=$site_list?>&access=<?php echo web_encryptIt(3)?>" target="_blank" >View Details</a></li>
			                                        <li class="divider"></li>
			                                        <li><a href="zonal_mr_field_new_issue.php?token_name=<?=$lid?>&Token_id=<?=$site_list?>&access=<?php echo web_encryptIt(3)?>&fmr_slno=<?=$result['fmr_slno']?>" target="_blank">Issue</a></li>

...
.form-control[disabled],.form-control[readonly] {
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>Transfer Of  Damage Stock </div>
			<ul class="breadcrumb">
				<li><a href="zonal_dashboard.php"></a></li>
				<li class="">Dashboards</li>
				<li class="">Stock Information </li>
				<li class="active">Stock Damage Transfer Form</li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
			...
			<div class="col-md-12 col-sm-12">
			 ...
			 <div class="panel panel-default">
			   <div class="panel-heading">
				 <div class="panel-title">Stock Damage Transfer Form</div>
				   </div>
	        					...
	        					// `field_slno`, `field_primary_code`, `field_secondary_code`, `field_component_name`, `field_component_id`, `field_category_name`, `field_category_id`, `field_unit`, `field_qnty`, `damage_loss`, `damage_loss_status`, `field_date`, `field_time`, `field_location_id`
	        						   ...
	        						   <tr>
	        						   	...
	        						   	<tr>
						        				...
						        				<td><?=$result['damage_loss']?> <?=$result['field_unit']?></td>

...
.panel-body p {
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>  List Of Challan Received By Field</div>
			<ul class="breadcrumb">
				<li><a href="zonal_dashboard.php"></a></li>
				<li class="">Dashboards</li>
				<li class="">Challan Information</li>
				<li class="active">History Of Field Challan Received</li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
		...
		<?php $msg->display(); ?>
			 ...
			 <div class="panel panel-default">
			   <div class="panel-heading">
				 <div class="panel-title">History Of Challan List</div>
				   </div>
			        		...
			        		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
				        		...
				        		<tbody>
				        			<?php 
				        				...
				        				$x=0;
				        				$Requsition_query="SELECT * FROM `lt_master_zonal_challan_generate` WHERE  `zqcg_status`='1' and `zqcg_zonal_location_id`='$field_place' and `zqcg_receive_status`='1'";
				        				...
				        				<td>
				        					<div class="btn-group">
			                                    ...
			                                    <ul class="dropdown-menu">
			                                        <li><a href="field_challan_new_issue_receive_history_view.php?token_name=<?=$lid?>&Token_id=<?=$site_list?>&access=<?php echo web_encryptIt('3')?>" target="_blank" >View Challan</a></li>

				                            ...
				                            <table id="example21" class="table table-bordered table-hover">
												...
												while ($res=mysqli_fetch_assoc($sql_material)) {?>
													...
													<tr>
														...
														<td ><?=$res['fmgd_secondary_id']?></td>
														<td><?=$res['fmgd_item_name']?></td>
														<td ><?=$res['fmgd_category_name']?></td>
														<td ><?=$res['fmgd_unit_id']?></td>
														<td><?=$hq_qnty_single=$res['fmgd_available_id']?></td>
														<td ><?=$hqzis_approve_qnt_single=$res['fmgd_quantity_id']?></td>
														<?php
										                	if($hq_qnty_single == 0){
																$remain=0;
										                ...
										                ?>
														<td ><input type="number" min="0" max="<?=$hqzis_approve_qnt_single?>" value="<?=$hqzis_approve_qnt_single?>" name="zqzis_issue_qnt[]" required placeholder=" Enter Quantity"></td>

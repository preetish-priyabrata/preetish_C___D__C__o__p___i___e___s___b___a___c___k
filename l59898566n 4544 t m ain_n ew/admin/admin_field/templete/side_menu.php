        ...
        <div class="clearfix">
            <ul class="pull-right top-icons">
                ...
                <li class="dropdown user-dropdown">
                    <a class="user-name hidden-xs" data-toggle="dropdown">usha <i class="icon-more2"></i><small>Field Officer</small></a>
                    ...
                    <div class="dropdown-menu no-padding">
                        <div class="user-icon text-center p-t-15">
                            ...
                            <h5 class="text-center p-b-15 text-semibold">Hi! Usha</h5>
                        </div>
                        <!-- <ul class="user-links">
                 ...
                 <li class="list-title">Field Store Menu</li>
                    <li><a href="#"><i class="icon-stack2"></i> <span>Requsition Management</span></a>
                       <ul> 
                        ...
                        if($num_check_mr=='0'){
                            ?>
                             <li><a href="field_mr_raised.php">Raise Field M.R <span class="label label-success">New</span></a></li>
                            <?php
                        }else{
                    ...
                    <li><a href="#"><i class="icon-stack2"></i> <span>Return Management</span></a>
                     ...
                     <li><a href="#"><i class="icon-stack2"></i> <span>Maintenance Job Mgnt </span></a>
                        <ul> 
                            ...
                            <li><a href="field_issue_maintenance_job_complete_view.php">Complete Job Cards<span class="label label-success"></span></a></li>
                        </ul>
                    </li>

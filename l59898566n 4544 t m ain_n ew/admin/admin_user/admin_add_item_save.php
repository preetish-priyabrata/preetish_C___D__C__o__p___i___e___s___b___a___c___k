...
if($_SESSION['admin']){
    ...
    $num=mysqli_num_rows($sql_check); // check it number rows is affected 
   	...
   	if ($num==0){
 	    $query_insert="INSERT INTO `lt_master_item_detail`(`slno`,`item_primary_code`,`item_category_id`,`item_second_code`,`item_name`,`manufacture_name`, `brand_name`,`date`,`time`,`it_de_unit_m`) VALUES (Null,'$item_primary_code','$item_category_id','$item_second_code','$item_name','$manufacture_name','$brand_name','$date','$time','$name_unit')";
 	    // execute query

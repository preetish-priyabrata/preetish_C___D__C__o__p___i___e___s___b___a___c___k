					...
					<!-- 	 <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-lg-8">
							 	...
							 	<input type='text' name="machine_Mfg" placeholder="Enter Machine Mfg Date" class='form-control datepicker-here' data-language='en' required />
							</div>
						</div>
						<!-- <div class="form-group">
						    <label class="control-label col-lg-4 text-right">Machine Mfg Date</label>
						...
						<div class="form-group">
						    ...
						    <div class="col-lg-8">
								...
								<input type='text' name="machine_commission" placeholder="Enter Machine Commissioning Date" class='form-control datepicker-here' data-language='en' required />
						   </div>
						</div>

				    ...
				    <form name="myFunction" class="form-horizontal" action="admin_add_Users_edit_save.php" method="POST">
		               ...
		               ?>
                        ...
                        <div class="form-group">
						    ...
						    <div class="col-lg-8">
								 <input type="text" class="form-control" name="user_name" value="<?php echo $rec['user_name'];?>" >
						   </div>
						</div>
						...
						<div class="form-group">
						    ...
						    <div class="col-lg-8">
								 <input type="text" class="form-control" name="user_designation" value="<?php echo $rec['user_designation'];?>" >
						   </div>
						</div>
						<div class="form-group">
						    <label class="control-label col-lg-4 text-right">Date Of Birth</label>
						    <div class="col-lg-8">
								<input type="text" class='form-control datepicker-here' data-language='en' name="dob" id="dob" placeholder="Enter Date of Birth" autocomplete="off" value="<?php echo $rec['user_dob'];?>" required="">
						   </div>
						</div>
						...
						<div class="form-group">
						    ...
						    <div class="col-lg-8">
								 <input type="text" class="form-control" name="user_mobile" value="<?php echo $rec['user_mobile'];?>" >
						   </div>
						</div>

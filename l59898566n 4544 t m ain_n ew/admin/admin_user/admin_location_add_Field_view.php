	        					...
	        					<tbody>
	        						...
	        						<tr style="text-align: center;">
	        							...
	        							$hq_code=$result['hq_code'];
	        								...
	        								echo $result1['hq_name'];
	        							?>
	        							<td>
	        							<?php if($result['status']=="2"){ ?>
	        								<a href="admin_location_add_Zonal_update_status.php?slno=<?=$result['slno']?>&unq_id=<?=$result['field_code']?>&status=<?=$result['status']?>">In-Active</a>
	        							<?php }else{  ?>
	        								<a href="admin_location_add_Zonal_update_status.php?slno=<?=$result['slno']?>&unq_id=<?=$result['field_code']?>&status=<?=$result['status']?>">Active</a>
	        							<?php }?>

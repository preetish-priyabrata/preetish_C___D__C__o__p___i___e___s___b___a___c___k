          ...
          <div class="panel panel-default">
           <div class="panel-heading">
            <div class="panel-title">Edit Machine Details </div>
              ...
              <div class="form-group">
                <label class="control-label col-lg-4 text-right">Machine Unique Id</label>
                 <div class="col-lg-8">
               <?php echo $rec['machine_unique_id']; ?><input type="hidden" value="<?php echo $rec['machine_unique_id']; ?>" name="machine_unique_id">
               </div>
             </div>
              ...
              <div class="form-group">
                <label class="control-label col-lg-4 text-right">Machine Name</label>
                 <div class="col-lg-8">
                  <input type="text" class="form-control" name="machine_name" value="<?php echo $rec['machine_name'];?>" >
                </div>
             </div>
              <!--  <div class="form-group">
             ...
             <div class="form-group">
                <label class="control-label col-lg-4 text-right">Machine Commissioning Date</label>
                 <div class="col-lg-8">
                   <input type="text" class="form-control" name="machine_commissioning" value="<?php echo $rec['machine_commissioning'];?>">
               </div>
             </div>
            ...
            <div class="form-group">
              ...
              <a href="admin_add_machine_details_view.php" class="btn btn-info"> Back</a>

    ...
    color: red;
      ...
      <div class="content-wrapper" >
        ...
        <section class="content-header">
          <h1>
            View Received 1st Level Approved Application
            <!-- <small>(Content/Urls)</small> -->
          </h1>
          <ol class="breadcrumb">
            <li><a href="admin-dashboard"><i class="fa fa-dashboard"></i> Home</a></li>            
            <li class="active"> Admin View Received 1st Level Approved Application</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#Received" data-toggle="tab"><strong>Personal Info Approved Application List</strong></a></li>
                          ...
                          <div class="table-responsive">
                            <table class="table" id="example3">
                              ...
                              <?php
                                ...
                                if($application_details->status == 3 || $application_details->status == 2){
                                ?>              
                                  <tr>
                                    <td><?=$x;?></td>
                                    <td>
                                    <?php
                                        ...
                                        ?>
                                    <a href="view-personal-approved-application-details/<?=ucwords($application_details->token_no);?>"><?=ucwords($application_details->token_no);?></a>
                                    <?php }else if($application_details->status == 2){?>
                                    <?=ucwords($application_details->token_no);?><?php }?>
                                    ...
                                    <td>
                                        <?php
                                          if ($application_details->status == 3) {
                                        ?>
                                          <a href="#" name='active'  class="btn btn-success btn-xs">Vechile Info Avalilable</a>
                                         <?php }else if($application_details->status == 2){

                                          ?><a href="#" name='active'  class="btn btn-warning btn-xs">Vechile Info Not Avalilable</a>
                                      <?php }?>
                                    </td>

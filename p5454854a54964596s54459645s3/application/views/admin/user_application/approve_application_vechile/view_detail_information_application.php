...
<?php 
 ...
 $token_id=$token;
            ...
            $data1=array('token_no'=>$token_id,'status'=>"3");
             $data1_v=array('token_no'=>$token_id,'status'=>"0");
            $table="pass_detail_form";
            $table_v="vehicle_detail_info";
           ...
           $results11=$results1->num_rows();
            if($results11==0){
                ...
                $query1_detail_v = $this->db->get_where($table_v, $data1_v);
                      ...
                      <div class="row">
                        <div class="col-md-12">
                           <div class="box box-primary">
                            ...
                            <!-- vechile information -->
                            <?php
                            foreach ($query1_detail_v->result() as $query1_v ) { ?>
                            <div class="box box-primary">
                                <div class="box-header with-border"  style="background-color: orange">
                                  <h3 class="box-title">Vehicle Document</h3>
                                </div> 
                                <div class="box-body">
                                <div class="col-sm-8">  
                                   
                                    <div class="form-group">
                                      <label class="control-label col-sm-3" for="Desigination_user">Vehicle No :</label>
                                      <div class="col-sm-4">                                
                                       <?=$query1_v->vehicle_no?> 
                                      </div>
                                    </div>
                                      <div class="form-group">
                                      <label class="control-label col-sm-3" for="Desigination_user">Driver Name :</label>
                                      <div class="col-sm-4">                                
                                       <?=$query1_v->driver_name?> 
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      <label class="control-label col-sm-3" for="Desigination_user">Driver Licence :</label>
                                      <div class="col-sm-4">                                
                                       <?=$query1_v->driver_licence?> 
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      <label class="control-label col-sm-3" for="Desigination_user">Vehicle Model :</label>
                                      <div class="col-sm-4">                                
                                       <?=$query1_v->vehicle_mode?> 
                                      </div>
                                    </div>
                                   <!-- <div class="form-group">
                                      <label class="control-label col-sm-3" for="Desigination_user">Vechicle Rc Scan:</label>
                                      <div class="col-sm-4">                                
                                        <?=$query1_v->applicant_id_no?>
                                      </div>
                                    </div> -->
                                    ...
                                    <div class="col-sm-4">    
                                    <div class="pull-right">
                                        <label class="control-label col-sm-3" for="Desigination_user">Vehicle Rc Scan:</label>
                                      <div class="col-sm-6">                                
                                        <img class="img-responsive" src="<?=base_url('upload/vehicle/rc_book') . '/' .$query1_v->vehicle_rc_card_scan?>">
                                      </div>
                                  ...
                                  <div class="col-sm-4"> 
                                    <div class="pull-right">
                                        <label class="control-label col-sm-3" for="Desigination_user"> Driver Licence Scan:</label>
                                      <div class="col-sm-6">                                
                                        <img class="img-responsive" src="<?=base_url('upload/vehicle/driver_scan') . '/' .$query1_v->driver_licence_scan?>">
                                      </div>
                                    ...
                                    <div class="col-sm-4"> 
                                    <div class="pull-right">
                                        <label class="control-label col-sm-3" for="Desigination_user"> Vehicle Insurance Scan:</label>
                                      <div class="col-sm-6">                                
                                        <img class="img-responsive" src="<?=base_url('upload/vehicle/insurance') . '/' .$query1_v->vehicle_insurance_scan?>">
                                      </div>
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title"> Vehicle Approval Form</h4>
                      </div>
                      <form id="records" action="<?=base_url()?>save-details-conform-Vehicle" method="POST">

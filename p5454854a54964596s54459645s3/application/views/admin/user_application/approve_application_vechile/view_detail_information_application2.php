                      ...
                      <div class="row">
                        <div class="col-md-12">
                           <div class="box box-primary">
                            ...
                            <form action="<?=base_url()?>save-details-confirm-personal" id="records" role="form" class="form-horizontal" >
                            <?php  foreach ($results1->result() as $query1 ) { ?>
                             ...
                             <?php }?>
                              ...
                              <div class="text-center">
                                ...
                                <a href="<?=base_url()?>View-received-Application" class="btn btn-default" >Back</a>
                              </div>
              ...
              <div class="modal fade" id="myModal" role="dialog">
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <form id="records" action="<?=base_url()?>save-details-confirm-personal" method="POST">
                      <div class="modal-body">
                        <label for="1">
                          <input type="radio" id="1" value="Yes" onclick="show1()" name="verify1"  aria-required="true">Pending
                        </label>
                        <label for="2">
                          <input type="radio" id="2" value="No" onclick="hide1()" name="verify1">Approved
                        </label>
                      ...
                      <input type="text" name="token_id" value="<?=$token_id?>">
                  ...
                  verify2:{
                        required: {
                            depends: function (element) {
                                return $("input[name='verify1'][value='Yes']").is(":checked");
                            }
                        }
                    },
                },

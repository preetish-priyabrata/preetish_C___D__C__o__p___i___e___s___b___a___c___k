    ...
    color: red;
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Generate Pass For Application
            <!-- <small>(Content/Urls)</small> -->
          </h1>
          <ol class="breadcrumb">
            <li><a href="admin-dashboard"><i class="fa fa-dashboard"></i> Home</a></li>            
            <li class="active"> Generate Pass For Application</li>
          </ol>
        </section>
            ...
            <div class="col-md-12">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#Received" data-toggle="tab"><strong>Approved Verfication List</strong></a></li>
                          ...
                          <div class="table-responsive">
                            <table class="table" id="example3">
                              ...
                              <?php
                                ...
                                $data2=array('date_journey >='=>$date ,'paid_status'=>'1' ,'pending_status'=>'0','status'=>'5');
                                $x=1;
                                ...
                                foreach ($query1->result() as $application_details ) {?>              
                                  <tr>
                                    <td><?=$x;?></td>
                                    <td>
                                   <!--  <a href="view-received-application-details/<?=ucwords($application_details->token_no);?>"> -->
                                    <?=ucwords($application_details->token_no);?>
                                    <!-- </a> -->
                                    </td>
                                   ...
                                   <!--  <td><?=ucwords($application_details->transaction_id);?></td>
                                    ...
                                    <td> <a href="admin-generate-pass/<?=ucwords($application_details->token_no)?>" name='active'  class="btn btn-success btn-xs">Click Generate Pass</a></td>
                                  </tr>
                                <?php 
                                $x++;
                                }?>

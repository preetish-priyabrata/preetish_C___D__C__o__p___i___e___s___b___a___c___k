...
include 'config.php';
 $msg = new \Preetish\FlashMessages\FlashMessages();
  ...
  $query_challan="SELECT * FROM `rhc_master_dh_block_challan_no` WHERE `challen_no`='$challen' and  `status`='1'";
...
// exit;
  ...
  $query_get_place="SELECT * FROM `rhc_master_place_district` WHERE `place_district_id`='$place_id1'";
  $sql_exe_get_place=mysqli_query($conn,$query_get_place);
   ...
   if($result_list['place_status']=='1'){
    ...
    $place_full_name=strtoupper($block_fetch_detail['block_name']).'['.$block_fetch_detail['place_block_id'].']';
      ...
      if($result_list['place_status']=='2'){
        ...
        $sql_exec_dh=mysqli_query($conn,$get_dh);
        $dh_fetch_detail=mysqli_fetch_assoc($sql_exec_dh);
        $place_full_name=strtoupper($dh_fetch_detail['uphc_name']).'['.$dh_fetch_detail['place_aphc_id'].']';
      }
    }
      ...
      <div id="section-to-print">
            <div class="col-md-12">
              ...
              <tbody align="center">
                  <?php 
                  $x=1;
                 $query_list_item="SELECT * FROM `rhc_master_dh_block_item_details_challan_no` WHERE `challan_no`='$challen' and `status`='1' ";

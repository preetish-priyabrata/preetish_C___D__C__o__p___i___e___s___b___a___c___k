...
include 'config.php';
 $msg = new \Preetish\FlashMessages\FlashMessages();
  ...
  $query_list="SELECT * FROM `rhc_master_dh_block_indent` WHERE `indent_place_raised_by`='$place_id' and `indent_id`='$indent_id' and  `status`='1' ";
  ...
  $place_id_district=$result_list['indent_place_raised_to'];
  ...
  $user_palce=strtoupper($district_fetch_detail['district_name']).'['.$district_fetch_detail['place_district_id'].']';
  
  $place_hostpital_id=$result_list['indent_place_raised_by'];
  $get_block="SELECT * FROM `rhc_master_place_dh` WHERE `place_hostpital_id`='$place_hostpital_id'";
  $sql_exec_block=mysqli_query($conn,$get_block);
  $block_fetch_detail=mysqli_fetch_assoc($sql_exec_block);
  $user_palce1= strtoupper($block_fetch_detail['hosptial_name']).'['.$block_fetch_detail['place_hostpital_id'].']';
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="admin_receive_indent_history.php">Cancel Indent </a></li>
      ...
      <div class="panel panel-default">
        ...
        <div class="demo">
          <div class="panel-body">
            <form class="form-inline" id="issue_forms" action="admin_raise_indent_Cancel_view_save.php" method="POST">
            <div class="col-md-12">
              <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="receiver_id" value="<?=$place_block_id?>">
              ...
              <div class="col-md-6">
               <div class="form-group">
                ...
                <input type="hidden" name="issuer_id" id="issuer_id" value="<?=$place_id_district?>">
               <?php echo $user_palce?>
                <!-- <input type="email" class="form-control" id="email" value="Maner" readonly=""> -->
              </div>
              </div>
           ...
           <button type="submit" class="btn btn-default pull-right">Cancel Indent</button>

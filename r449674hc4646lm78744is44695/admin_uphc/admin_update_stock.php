        ...
        <div class="demo">
          <div class="panel-body">
            <form class="form-inline" id="issue_forms" action="admin_update_stock_save.php" method="POST">
              ...
              <?php
              $x=0;
                $query_item="SELECT * FROM `rhc_master_stock_district_hospital_items` WHERE `dh_place_id`='$place_id_dh'";
                ...
                while ($result_list_item=mysqli_fetch_assoc($sql_exe)) {
                 ...
                 <tr>
                  ...
                  <td><input type="text" id="temp_quantity<?=$x?>" readonly name="item_quantity[]" value="<?=$result_list_item['item_quantity']?>">

          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php
                      ...
                      $query_list="SELECT * FROM `rhc_master_dh_block_indent` WHERE `indent_place_raised_by`='$place_id' AND `status`='1'";
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        echo strtoupper($block_fetch_detail['hosptial_name']).'['.$block_fetch_detail['place_hostpital_id'].']';
                        ?>
                      </td>

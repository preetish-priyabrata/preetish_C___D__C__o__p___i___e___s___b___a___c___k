...
$place_id=$result_fetch_challen['issuer_place_id'];
  ...
  $query_list="SELECT * FROM `rhc_master_indent` WHERE `indent_place_raised_to`='$place_id' and `indent_id`='$indent_id' AND `status`='2'";
  $sql_exe_list=mysqli_query($conn,$query_list);
  $num_rows=mysqli_num_rows($sql_exe_get_place);
  // if($num_rows!=0){
      ...
      <div class="panel panel-default">
        ...
        <div class="demo">
          <div class="panel-body">
            <form class="form-inline" action="admin_issue_challan_save.php" method="POST" >
        <div  id="printarea">
      <div id="section-to-print">
            <div class="col-md-12">
              ...
              <tbody align="center">
                  <?php 
                  $x=1;
                 $query_list_item="SELECT * FROM `rhc_master_itemdetails_challan_no` WHERE `challan_no`='$challen' and `status`='0' or `status`='2' ";

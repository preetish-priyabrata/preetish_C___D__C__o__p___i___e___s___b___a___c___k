...
for ($i=0; $i <count($item_code_batch) ; $i++) { 
	...
	if($server_output){
	 ...
	 // $mobileno=$result_fetch1['user_mobile'];
		 ...
		 $new_message1='Updated Sent Success-fully'.$datetime;

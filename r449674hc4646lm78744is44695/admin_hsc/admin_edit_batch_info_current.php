...
$batch_no=$_REQUEST['batch_no'];
	//here we have get information of batch total stock and avaliable stock in particular 
	 $sql_query="SELECT * FROM `rhc_master_stock_phc_subcenter_batch_details` WHERE `slno`='$slno' and `batch_nos`='$batch_no'and `phc_sub_stock_batch_id`='$batch_store_id'";
	...
	if($num!=0){
		...
		$state_item="SELECT * FROM `rhc_master_stock_phc_subcenter_items` WHERE `phc_sub_stock_batch_id`='$batch_store_id' and`phc_sub_place_id`='$place_id_district'";

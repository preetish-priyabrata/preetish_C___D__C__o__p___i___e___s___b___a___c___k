...
include 'config.php';
 $msg = new \Preetish\FlashMessages\FlashMessages();
  ...
  $query_list="SELECT * FROM `rhc_master_asha_indent` WHERE `indent_place_raised_to`='$place_id' and `indent_id`='$indent_id' AND `status`='1'";
  ...
  $get_block="SELECT * FROM `rhc_master_place_phc_sub_center` WHERE `place_phc_sub_id`='$place_id_block'";
          ...
          <div class="panel-body">
            ...
            <div class="col-md-12">
              ...
              <tbody>
                  <?php 
                  $x=0;
                $query_list_item="SELECT * FROM `rhc_master_asha_indent_id_details` WHERE `indent_id`='$indent_id'";

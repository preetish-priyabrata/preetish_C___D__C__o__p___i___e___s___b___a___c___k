...
include 'config.php';
 $msg = new \Preetish\FlashMessages\FlashMessages();
  ...
  $query_list="SELECT * FROM `rhc_master_phc_asha_indent` WHERE `indent_place_raised_by`='$place_id' and `indent_id`='$indent_id' and  `status`='1' ";
  ...
  $user_palce=strtoupper($block_fetch_detail['phc_name']).'['.$block_fetch_detail['place_phc_id'].']';

  

    $place_phc_sub_id=$result_list['indent_place_raised_by'];
    $get_block="SELECT * FROM `rhc_master_place_phc_sub_center` WHERE `place_phc_sub_id`='$place_phc_sub_id'";
    $sql_exec_block=mysqli_query($conn,$get_block);
    $block_fetch_detail=mysqli_fetch_assoc($sql_exec_block);
    $user_palce1= strtoupper($block_fetch_detail['phc_sub_center_name']).'['.$block_fetch_detail['place_phc_sub_id'].']';
          ...
          <div class="panel-body">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="receiver_id" value="<?=$place_phc_id?>">
              ...
              <div class="col-md-6">
               <div class="form-group">
                ...
                <input type="hidden" name="issuer_id" id="issuer_id" value="<?=$place_block_id?>">
               <?php echo $user_palce?>
                <!-- <input type="email" class="form-control" id="email" value="Maner" readonly=""> -->
              </div>
              </div>

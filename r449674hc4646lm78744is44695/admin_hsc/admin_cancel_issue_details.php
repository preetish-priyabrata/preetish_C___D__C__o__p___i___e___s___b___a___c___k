...
$result_fetch_challen =mysqli_fetch_assoc($sql_exe_challan); 
 ...
 $place_id1=$result_fetch_challen['receiver_place_id'];
  ...
  $query_list="SELECT * FROM `rhc_master_asha_indent` WHERE `indent_place_raised_by`='$place_id1' and `indent_id`='$indent_id' and `status`='2'";
  ...
  //   exit;
  // }
  $get_block="SELECT * FROM `rhc_master_place_phc_sub_center` WHERE `place_phc_sub_id`='$place_id'";
    $sql_exec_block=mysqli_query($conn,$get_block);
    $block_fetch_detail=mysqli_fetch_assoc($sql_exec_block);
    $place_full_name1=strtoupper($block_fetch_detail['phc_sub_center_name']).'['.$block_fetch_detail['place_phc_sub_id'].']';
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-12">
      ...
      <div id="section-to-print">
                    ...
                    <td>
                      <table class="table table-striped" border="1" width="100%">
                        ...
                        $item_batch_id=$res_item['item_batch_id'];
                          $query_batch_details="SELECT * FROM `rhc_master_asha_receive_batch_detail_item` WHERE `item_batch_id`='$item_batch_id'";
            ...
            <a href="admin_cancel_issue.php"  class="btn btn-default">Back</a>             

...
// reciver level
  	$raise_level_mobile="SELECT * FROM `rhc_master_login_user` WHERE `user_mobile`='$receiver_id' and `user_designation`='9' and `status`='2' ";
	...
	// PHC
	$raise_level_mobile3="SELECT * FROM `rhc_master_login_user` WHERE `place_phc_aphc_id`='$place_phc_aphc_id' and `user_designation`='5' And `status`='1'";
	$sql_exe_top_level_mobile=mysqli_query($conn,$raise_level_mobile3);
	while($res_top_level_mobile=mysqli_fetch_assoc($sql_exe_top_level_mobile)){
					// print_r($res);
		$array_list_user_mobile[]=$res_top_level_mobile['user_mobile'];

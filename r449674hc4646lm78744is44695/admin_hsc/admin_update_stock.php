          ...
          <div class="panel-body">
            <form class="form-inline" id="issue_forms" action="admin_update_stock_save.php" method="POST">
              ...
              <div class="form-group pull-right">
                ...
                <?php $place_id_phc=$_SESSION['place_id']?>
                <?php 
                $get_block="SELECT * FROM `rhc_master_place_phc_sub_center` WHERE `place_phc_sub_id`='$place_id_phc'";
                ...
                <input type="hidden" name="top_place_id" value="<?=$block_fetch_detail['place_phc_id']?>">
                <input type="hidden" name="raise_place_id" value="<?=$block_fetch_detail['place_phc_sub_id']?>">
              ...
              <?php
              $x=0;
                $query_item="SELECT * FROM `rhc_master_stock_phc_subcenter_items` WHERE `phc_sub_place_id`='$place_id_phc'";

...
?>
    ...
    <section class="content-header">
      <h1>
        Cancel Indent 
        <small>Indent Raised Lists</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Indent</a></li>
        <li  class="active"><a href="#">Cancel Indent</a></li>
          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php
                      ...
                      $query_list="SELECT * FROM `rhc_master_phc_asha_indent` WHERE `indent_place_raised_by`='$place_id' AND `status`='1'";
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        echo strtoupper($block_fetch_detail['phc_sub_center_name']).'['.$block_fetch_detail['place_phc_sub_id'].']'?>
                      ...
                      ?></td>
                      <td>
                      <a href="admin_raise_indent_Cancel_view.php?indent_id=<?=$result_list['indent_id'];?>" class="btn btn-info" role="button">More</a></td>

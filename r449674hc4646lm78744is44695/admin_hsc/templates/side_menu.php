...
require 'config.php';
  ...
  $place_phc_hsc_id=$_SESSION['place_id']; 
  $get_phc="SELECT * FROM `rhc_master_place_phc_sub_center` WHERE `place_phc_sub_id`='$place_phc_hsc_id'";
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="admin_avaliable_stock_view.php"><i class="fa fa-circle-o"></i>Stock In  <?php  echo $phc_fetch_detail['phc_sub_center_name'];?></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="admin_received_issue.php"><i class="fa fa-circle-o"></i>Challan Received</a></li>
             <li >

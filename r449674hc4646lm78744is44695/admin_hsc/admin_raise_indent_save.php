...
if($_SESSION['admin_emails']){
	...
	// Array ( [place_id] => HSC-RAM [place_status] => 7 [top_place_id] => PHC-ATHM [raise_place_id] => HSC-RAM [item_code] => Array ( [0] => ocp ) [item_type] => Array ( [0] => f ) [item_quantity] => Array ( [0] => 15 ) [txtOccupation] => Array ( [0] => 1500 ) )

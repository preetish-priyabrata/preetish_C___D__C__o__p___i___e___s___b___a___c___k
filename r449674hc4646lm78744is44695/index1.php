...
<div class="col-sm-12">
    <div class="panel panel-default">
      <div class="panel-body text-center" style="border:1px solid blue;"><h2 class="text-effect" style="color: #651616; margin-top: 0px; margin-bottom: 0px;"><b> Know Us Better</b></h2></div>
    </div>
</div>
</div>

<nav id="ids_me1"  class="navbar navbar-default bootsnav" style="background-color:#98bf21; top:-21px ">

...
include 'config.php';
 $msg = new \Preetish\FlashMessages\FlashMessages();
  ...
  $get_district="SELECT * FROM `rhc_master_place_phc` WHERE `place_phc_id`='$place_phc_id'";
  $sql_exec_district=mysqli_query($conn,$get_district);
  $district_fetch_detail=mysqli_fetch_assoc($sql_exec_district);
  $user_palce1=strtoupper($district_fetch_detail['phc_name']).'['.$district_fetch_detail['place_phc_id'].']';

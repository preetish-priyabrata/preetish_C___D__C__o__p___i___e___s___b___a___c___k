                ...
                while ($result_list_item=mysqli_fetch_assoc($sql_exe)) {
                  ...
                  $res_lis_type=mysqli_fetch_assoc($sql_exe_item_type);
                   ...
                   //issue value  will be find here only6
                    $query_issued="SELECT SUM(quantity_issued) FROM `rhc_master_district_item_details_challan_no` WHERE `receiver_place_id`='$place_district_id' and `item_code`='$item_code' and `item_type`='$item_types' and  `date_creation` BETWEEN '$date_one' AND '$date_two' order by `slno` desc";
            ...
            while ($result_list_item=mysqli_fetch_assoc($sql_exe)) {
              ...
              $res_lis_type=mysqli_fetch_assoc($sql_exe_item_type);
               ...
               $labels2[]=$item_names;                
                ...
                //issue value  will be find here only6
                $query_issued="SELECT SUM(quantity_issued) FROM `rhc_master_dh_block_indent_id_details` WHERE `receiver_place_id`='$block_dh_uphc' and `item_code`='$item_code' and `item_type`='$item_types' and  `date_creation` BETWEEN '$date_one' AND '$date_two' order by `slno` desc";
            ...
            if($num_aphc_present==0){
              ...
              $res_lis_type=mysqli_fetch_assoc($sql_exe_item_type);
               ...
               $labels2[]=$item_names;                
                  ...
                  //issue value  will be find here only6
                $query_issued="SELECT SUM(quantity_issued) FROM `rhc_master_phc_aphc_indent_id_details` WHERE `receiver_place_id`='$phc_aphc' and `item_code`='$item_code' and `item_type`='$item_types' and  `date_creation` BETWEEN '$date_one' AND '$date_two' order by `slno` desc";
               ...
               exit;
                ...
                while ($result_list_item=mysqli_fetch_assoc($sql_exe)) {
                  ...
                  $res_lis_type=mysqli_fetch_assoc($sql_exe_item_type);
                   ...
                   //issue value  will be find here only6
                    $query_issued="SELECT SUM(quantity_issued) FROM `rhc_master_phc_asha_item_details_challan_no` WHERE `receiver_place_id`='$place_district_id' and `item_code`='$item_code' and `item_type`='$item_types' and  `date_creation` BETWEEN '$date_one' AND '$date_two' order by `slno` desc";
                      ...
                      // forecasting amount
                      // 
                      $query_forecasting="SELECT * FROM `rhc_master_forcasting_indent` WHERE `place_id`='$hsc_ids' and `place_status`='7' and `item_code`='$item_code'and `item_type`='$item_types'";
                      $sql_exe_forecasting=mysqli_query($conn,$query_forecasting);
                      $fetch_forecasting=mysqli_fetch_array($sql_exe_forecasting);  

...
?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Item Wise Quarterly Indenting Vs Received Report
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Report</a></li>
         <li><a href="#">Report</a></li>
        <li class="active">Item Wise Quarterly Indenting Report </li>
      </ol>
    </section>
  ...
  function get_indent_detail(argument) {
    ...
    if(hsc_ids!=""){
      var place_id = "5";
         $.ajax({
              type:'POST',
              url:'admin_get_stock_details_indent_Distributed.php',
      ...
      if(phc_aphc!=""){
        ...
        if(block_dh_uphc!=""){
          ...
          if(district_ids!=""){
            ...
            alert('There No Asha & ANN Or Staff Details In District Level'); 
          }else{
            $('#get_indent_result').html();
            alert('There No Asha & ANN Or Staff Details In State Level');
          }
        }
      }
    }

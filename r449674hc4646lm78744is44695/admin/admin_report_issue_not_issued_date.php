     ...
     if(startDate!="" && endDate){
      ...
      if(hsc_ids!=""){
        var place_id = "5";
           $.ajax({
                type:'POST',
                url:'admin_get_issued_details_not_issued.php',
                data:'state_id='+state_id+'&district_id='+district_ids+'&block_dh_uphc='+block_dh_uphc+'&phc_aphc='+phc_aphc+'&place_id='+place_id+'&startDate='+startDate+'&endDate='+endDate+'&hsc_ids='+hsc_ids,
                success:function(html){

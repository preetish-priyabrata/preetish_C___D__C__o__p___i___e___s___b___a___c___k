    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Report</a></li>
         <li><a href="#">Report</a></li>
        <li class="active">Quarterly Quarterly Type Wise</li>
      </ol>
    </section>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-1">:</div>
                    <div class="col-md-8">
                        <select class="form-control text-center" name="type" id="types" required="" >
...
<script type="text/javascript">
 function get_indent() {
  ...
  function get_indent_detail(argument) {
    ...
    var types_item=$('#types').val();
    var hsc_ids=$('#hsc_id').val();
    if(hsc_ids!=""){
      var place_id = "5";
         $.ajax({
              type:'POST',
              url:'admin_get_graph_indent_quarterly_details_types.php',
              data:'state_id='+state_id+'&district_id='+district_ids+'&block_dh_uphc='+block_dh_uphc+'&phc_aphc='+phc_aphc+'&place_id='+place_id+'&years='+years+'&quarterly='+quarterly+'&hsc_ids='+hsc_ids+'&types_item='+types_item,
              success:function(html){
      ...
      if(phc_aphc!=""){
        var place_id = "3";
         $.ajax({
              type:'POST',
              url:'admin_get_graph_indent_quarterly_details_types.php',
              data:'state_id='+state_id+'&district_id='+district_ids+'&block_dh_uphc='+block_dh_uphc+'&phc_aphc='+phc_aphc+'&place_id='+place_id+'&years='+years+'&quarterly='+quarterly+'&types_item='+types_item+'&hsc_ids='+hsc_ids,
              success:function(html){
                 $('#get_indent_result').html(html);
                 // $('#get_raised_Indent').html('')
              }

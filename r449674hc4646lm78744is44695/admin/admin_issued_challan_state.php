...
// print_r($result_fetch_challen);
  ...
  $query_list="SELECT * FROM `rhc_master_indent` WHERE `indent_place_raised_to`='$place_id' and `indent_id`='$indent_id'";
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong> Challan Indormation </strong></div>
        <div class="demo">

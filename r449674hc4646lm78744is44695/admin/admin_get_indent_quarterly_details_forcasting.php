<?php
//print_r($_POST);
//Array ( [state_id] => BR [district_id] => Pat [block_dh_uphc] => ATHM [phc_aphc] => PHC-ATHM [place_id] => 5 [years] => 2017-2018 [quarterly] => 04-06 [hsc_ids] => HSC-RAM ) 
      ...
      <table id="example1" class="table table-bordered table-striped table-hover text-center">
              ...
              $x=1;
               ...
               $query_item="SELECT * FROM `rhc_master_stock_state_items` WHERE `state_place_id`='$state_id'";
                ...
                if($num_forcast!=0){
                  ...
                  $num_rows_forcast="Not Forcasted";

                }else{
                  $num_rows_forcast="In-vaild";
                }
            ...
            <tr>
             <!--  <td><?=$x?></td> -->
              ...
              <!-- <td>Bihar</td> -->
              <td><?=$item_names;?></td>
              <td><?php  if($num_forcast!=0){ echo $num_rows_forcast;
                          }else if($num_forcast==0){
                           echo $num_rows_forcast;
                         }else{
                          echo $num_rows_forcast;
                         }
                ?></td>
              <td><?php  if($num_forcast!=0){ echo $num_rows_indent;
                          }else if($num_forcast==0){
                           echo $num_rows_indent;
                         }else{
                          echo $num_rows_indent;
                         }
                ?>

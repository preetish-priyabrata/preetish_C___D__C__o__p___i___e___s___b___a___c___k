  ...
  function get_indent_detail(argument) {
    ...
    if(hsc_ids!=""){
      var place_id = "5";
         $.ajax({
              type:'POST',
              url:'admin_get_indent_quarterly_details_types.php',
              data:'state_id='+state_id+'&district_id='+district_ids+'&block_dh_uphc='+block_dh_uphc+'&phc_aphc='+phc_aphc+'&place_id='+place_id+'&years='+years+'&quarterly='+quarterly+'&hsc_ids='+hsc_ids,
              success:function(html){
      ...
      if(phc_aphc!=""){
        var place_id = "3";
         $.ajax({
              type:'POST',
              url:'admin_get_indent_quarterly_details_types.php',
              data:'state_id='+state_id+'&district_id='+district_ids+'&block_dh_uphc='+block_dh_uphc+'&phc_aphc='+phc_aphc+'&place_id='+place_id+'&years='+years+'&quarterly='+quarterly+'&types_item='+types_item,
              success:function(html){
                 $('#get_indent_result').html(html);
                 // $('#get_raised_Indent').html('')
              }

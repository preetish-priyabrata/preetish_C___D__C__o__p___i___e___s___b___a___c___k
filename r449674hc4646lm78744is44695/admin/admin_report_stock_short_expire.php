  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Short Expiry Report </li>
      </ol>
    </section>
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      ...
                      <div class="col-md-8">
                        ...
                        <select class="form-control text-center" name="nos_month" id="nos_month" required="">
  ...
  function get_indent_detail(argument) {
    ...
    if(hsc_ids!=""){
      var place_id = "5";
         $.ajax({
              type:'POST',
              url:'admin_get_stock_details_short_expire.php',
              data:'state_id='+state_id+'&district_id='+district_ids+'&block_dh_uphc='+block_dh_uphc+'&phc_aphc='+phc_aphc+'&place_id='+place_id+'&nos_month='+nos_month+'&hsc_ids='+hsc_ids,
              success:function(html){

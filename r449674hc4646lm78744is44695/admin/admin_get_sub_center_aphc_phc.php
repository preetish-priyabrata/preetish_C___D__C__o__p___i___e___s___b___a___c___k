	...
	<div class="form-group" id="phc_subcenter1">
    	<label class="control-label col-sm-2" for="phc_subcenter1">Indent Level:</label>
     		<div class="col-sm-6">
				...
				<label class="radio-inline" id="hide_sub_phc3"><input type="radio" name="asha_level_anm_level" required="" value="3">APHC </label>
				<label class="radio-inline" id="hide_sub_phc4"><input type="radio" name="asha_level_anm_level" required=""  value="2" >HSC/PHC Sub-Center</label>

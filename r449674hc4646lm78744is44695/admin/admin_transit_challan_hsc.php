...
$query_challan="SELECT * FROM `rhc_master_asha_challan_no` WHERE `challen_no`='$challen' and `status`!='1'";
 ...
 $place_id1=$result_fetch_challen['receiver_place_id'];
  $place_id=$result_fetch_challen['issuer_place_id'];
   $num_rows=mysqli_num_rows($sql_exe_challan);
    if($num_rows==0){
        $msg->error('Invalid Issued Challan No');      
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Challan Information</a></li>
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>Challan Information </strong></div>
        <div class="demo">
      ...
      <div id="section-to-print">
            <div class="col-md-12">
              ...
              <div class="col-md-6">      
              <div class="form-group">
                 <label for="email">Challan Status :</label>
                <input type="hidden" name="receiver_id" value="<?=$place_id?>">
                <b style="color: red">Transit</b>
                <!-- <input type="email" class="form-control" id="email" value="Maner" readonly=""> -->
              </div>
              </div>
            </div>
              ...
              <tbody align="center">
                ...
                while ($res_item=mysqli_fetch_assoc($sql_exe_list_item)) {?>
                 <tr>
                    ...
                    <!-- <td> <?=$received=$res_item['quantity_received']?></td> -->
                    <td>

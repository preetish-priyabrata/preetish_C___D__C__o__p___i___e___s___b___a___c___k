...
?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Minimum Stock Level Analysis
       <!--  <small>it all starts here</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#"> Graphical Report</a></li>
        <li class="active">Minimum Stock Level Analysis </li>
      </ol>
    </section>
  ...
  function get_indent_detail(argument) {
    ...
    if(hsc_ids!=""){
      var place_id = "5";
         $.ajax({
              type:'POST',
              url:'admin_get_graph_stock_details.php',
              data:'state_id='+state_id+'&district_id='+district_ids+'&block_dh_uphc='+block_dh_uphc+'&phc_aphc='+phc_aphc+'&place_id='+place_id+'&hsc_ids='+hsc_ids,
              success:function(html){

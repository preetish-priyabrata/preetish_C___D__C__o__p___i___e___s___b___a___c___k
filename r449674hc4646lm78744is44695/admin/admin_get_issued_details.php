    ...
    $hsc_ids=trim($_POST['hsc_ids']);
      ...
      ?>
          ...
          <table id="example1" class="table table-bordered table-striped table-hover text-center">
            ...
            <tbody>
              ...
              <td> <a target="_blank" href="admin_issued_challan_state.php?challen_no=<?=$res_list['challen_no'];?>" class="btn btn-info" role="button">More</a></td>
              </tr>
              <?php }?>
            </tbody>
          </table>
	 ...
	 <?php
      ...
      case '5': 
        ...
        $num_hsc=mysqli_num_rows($sql_exec_hsc);
          ...
          if($num_hsc!=0){
              ...
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?=date('d-m-Y',strtotime(trim($res_list['date_creation'])));?></td>
                    <td><?=date('h:i:s a',strtotime(trim($res_list['time_creation'])));?></td>
                    <td> <a target="_blank" href="admin_issued_challan_hsc_asha.php?challen_no=<?=$res_list['challen_no'];?>" class="btn btn-info" role="button">More</a></td> 
                  </tr>
                  <?php }?>
                </tbody>
              </table>
            ...
            echo "<h1> No Search HSC Is Present</h1>";
          }   

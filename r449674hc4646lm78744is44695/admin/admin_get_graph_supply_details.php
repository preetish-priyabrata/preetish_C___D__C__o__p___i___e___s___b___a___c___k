         ...
         $place_dist=array();
                ...
                for ($i=0; $i <count($place_dist) ; $i++) { 
                   $place_district_id=$place_dist[$i]['place_code'] ; 
                     ...
                     $query_list="SELECT  SUM(rhc_master_district_indent_id_details.item_quantity) FROM rhc_master_district_indent_id_details INNER JOIN rhc_master_district_indent ON rhc_master_district_indent_id_details.indent_id=rhc_master_district_indent.indent_id WHERE rhc_master_district_indent.indent_place_raised_by='$place_district_id' and rhc_master_district_indent_id_details.item_code='$item_code' and rhc_master_district_indent_id_details.Item_type='$item_type'";
                     $sql_exe_list=mysqli_query($conn,$query_list);
                      $fetch=mysqli_fetch_array($sql_exe_list);

                      $query_issued="SELECT SUM(quantity_issued) FROM `rhc_master_district_item_details_challan_no` WHERE `receiver_place_id`='$place_district_id' and `item_code`='$item_code' and `item_type`='$item_type'";
              ...
              $sql_exec_block=mysqli_query($conn,$get_block);
                ...
                for ($i=0; $i <count($place_dist) ; $i++) { 
                  ...
                  // $query_list="SELECT * FROM `rhc_master_dh_block_indent` WHERE `indent_place_raised_by`='$place_indent_id' ORDER BY `slno` DESC";
                      $query_list="SELECT  SUM(rhc_master_dh_block_indent_id_details.item_quantity) FROM rhc_master_dh_block_indent_id_details INNER JOIN rhc_master_dh_block_indent ON rhc_master_dh_block_indent_id_details.indent_id=rhc_master_dh_block_indent.indent_id WHERE rhc_master_dh_block_indent.indent_place_raised_by='$place_indent_id' and rhc_master_dh_block_indent_id_details.item_code='$item_code' and rhc_master_dh_block_indent_id_details.Item_type='$item_type'";
                     $sql_exe_list=mysqli_query($conn,$query_list);
                      $fetch=mysqli_fetch_array($sql_exe_list);

                      $query_issued="SELECT SUM(quantity_issued) FROM `rhc_master_dh_block_item_details_challan_no` WHERE `receiver_place_id`='$place_indent_id' and `item_code`='$item_code' and `item_type`='$item_type'";
        ...
        if($num_aphc!=0){          
         ...
         for ($i=0; $i <count($place_dist) ; $i++) { 
                   $place_indent_id=$place_dist[$i]['place_code'] ;   
                      ...
                      $query_list="SELECT  SUM(rhc_master_phc_aphc_indent_id_details.item_quantity) FROM rhc_master_phc_aphc_indent_id_details INNER JOIN rhc_master_phc_aphc_indent ON rhc_master_phc_aphc_indent_id_details.indent_id=rhc_master_phc_aphc_indent.indent_id WHERE rhc_master_phc_aphc_indent.indent_place_raised_by='$place_indent_id' and rhc_master_phc_aphc_indent_id_details.item_code='$item_code' and rhc_master_phc_aphc_indent_id_details.Item_type='$item_type'";
                     $sql_exe_list=mysqli_query($conn,$query_list);
                      $fetch=mysqli_fetch_array($sql_exe_list);

                      $query_issued="SELECT SUM(quantity_issued) FROM `rhc_master_phc_aphc_item_details_challan_no` WHERE `receiver_place_id`='$place_indent_id' and `item_code`='$item_code' and `item_type`='$item_type'";
          ...
          if($num_aphc!=0){
            ...
            $sql_exec_phc1=mysqli_query($conn,$get_phc1);
              ...
              $sql_asha_query="SELECT * FROM `rhc_master_login_user` WHERE `asha_top_level`='3' and `status`='1'";
              $exe_asha=mysqli_query($conn,$sql_asha_query);
              $num_no_asha=mysqli_num_rows($exe_asha);
              if($num_no_asha!=0){
                while ($res=mysqli_fetch_assoc($exe_asha)) {
               ...
               for ($i=0; $i <count($place_dist) ; $i++) { 
                  ...
                  $query_list="SELECT * FROM `rhc_master_aphc_asha_indent` WHERE `indent_place_raised_by`='$place_indent_id' ";
                     $query_list="SELECT  SUM(rhc_master_aphc_asha_indent_id_details.item_quantity) FROM rhc_master_aphc_asha_indent_id_details INNER JOIN rhc_master_aphc_asha_indent ON rhc_master_aphc_asha_indent_id_details.indent_id=rhc_master_aphc_asha_indent.indent_id WHERE rhc_master_aphc_asha_indent.indent_place_raised_by='$place_indent_id' and rhc_master_aphc_asha_indent_id_details.item_code='$item_code' and rhc_master_aphc_asha_indent_id_details.Item_type='$item_type'";
                     $sql_exe_list=mysqli_query($conn,$query_list);
                      $fetch=mysqli_fetch_array($sql_exe_list);

                      $query_issued="SELECT SUM(quantity_issued) FROM `rhc_master_aphc_asha_item_details_challan_no` WHERE `receiver_place_id`='$place_indent_id' and `item_code`='$item_code' and `item_type`='$item_type'";
            ...
            $sql_asha_query="SELECT * FROM `rhc_master_login_user` WHERE `asha_top_level`='2' and `status`='1'";
              ...
              for ($i=0; $i <count($place_dist) ; $i++) { 
                   $place_indent_id=$place_dist[$i]['place_code'] ;   
                      ...
                      $query_list="SELECT  SUM(rhc_master_asha_indent_id_details.item_quantity) FROM rhc_master_asha_indent_id_details INNER JOIN rhc_master_asha_indent ON rhc_master_asha_indent_id_details.indent_id=rhc_master_asha_indent.indent_id WHERE rhc_master_asha_indent.indent_place_raised_by='$place_indent_id' and rhc_master_asha_indent_id_details.item_code='$item_code' and rhc_master_asha_indent_id_details.Item_type='$item_type'";
                     $sql_exe_list=mysqli_query($conn,$query_list);
                      $fetch=mysqli_fetch_array($sql_exe_list);

                      $query_issued="SELECT SUM(quantity_issued) FROM `rhc_master_asha_item_details_challan_no` WHERE `receiver_place_id`='$place_indent_id' and `item_code`='$item_code' and `item_type`='$item_type'";

...
// exit;
  ...
  $place_id=$result_list['indent_place_raised_by'];
  

   $query_list="SELECT * FROM `rhc_master_phc_aphc_indent` WHERE `indent_place_raised_by`='$place_id' and `indent_id`='$indent_id' AND `status`='2'";

         ...
         $place_dist=array();
               ...
               $query_item="SELECT * FROM `rhc_master_stock_state_items` WHERE `state_place_id`='$state_id'";
                ...
                $res_lis_type=mysqli_fetch_assoc($sql_exe_item_type);
                 ...
                 $query_list1="SELECT * FROM rhc_master_phc_asha_indent_id_details INNER JOIN rhc_master_phc_asha_indent ON rhc_master_phc_asha_indent_id_details.indent_id=rhc_master_phc_asha_indent.indent_id WHERE rhc_master_phc_asha_indent.status!='0' rhc_master_phc_asha_indent.indent_place_raised_by='$hsc_ids' and rhc_master_phc_asha_indent_id_details.item_code='$item_code' and rhc_master_phc_asha_indent_id_details.Item_type='$item_types' and  YEAR(rhc_master_phc_asha_indent.date_creation) BETWEEN '$year_one' AND '$year_two'";
                $sql_exe_list=mysqli_query($conn,$query_list1);
                $datasets2[]=mysqli_num_rows($sql_exe_list);
              }
                 //print_r($datasets2);

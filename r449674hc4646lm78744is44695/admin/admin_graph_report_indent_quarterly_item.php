...
?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Graphical Item Wise Quarterly Indenting Report
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Report</a></li>
         <li><a href="#">Report</a></li>
        <li class="active">Graphical Item Wise Quarterly Indenting Report </li>
      </ol>
    </section>
  ...
  function get_indent_detail(argument) {
    ...
    if(hsc_ids!=""){
      var place_id = "5";
         $.ajax({
              type:'POST',
              url:'admin_get_graph_indent_quarterly_item_details.php',

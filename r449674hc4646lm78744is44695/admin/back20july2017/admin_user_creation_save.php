...
if($num==0){
	if($Desigination_user==1){
		...
		$sub_center_dis_hos=trim($_POST['sub_center_dis_hos']);
		if($sub_center_dis_hos==11){
			$user_name=trim($_POST['user_name']);
			$user_email=trim($_POST['user_email']);
			$user_mobile=trim($_POST['user_mobile']);
			$user_alt_mobile=trim($_POST['user_alt_mobile']);
			...
			$query_insert="INSERT INTO `rhc_master_login_user`(`slno`, `user_name`,  `user_designation`, `user_designation_name`, `user_email`, `user_mobile`,  `user_id`, `password`, `place_state_id`, `place_district_id`, `place_block_dh_status`, `place_block_dh_id`, `date_creation`, `time_creation`,`village`,`sim`,`asha_top_level`) VALUES (NULL,'$user_name' ,'9','$Desigination_name','$user_email','$user_mobile','$user_id','$user_Password','$state_id','$district_id','$optradio','$district_hospital_id','$date','$time','$village','$sim','8')";	
		}
		...
		$sub_center_dis_hos=trim($_POST['sub_center_dis_hos']);
			...
			$query_insert="INSERT INTO `rhc_master_login_user`(`slno`, `user_name`,  `user_designation`, `user_designation_name`, `user_email`, `user_mobile`,  `user_id`, `password`, `place_state_id`, `place_district_id`, `place_block_dh_status`, `place_block_dh_id`, `date_creation`, `time_creation`,`village`,`sim`,`asha_top_level`) VALUES (NULL,'$user_name' ,'9','$Desigination_name','$user_email','$user_mobile','$user_id','$user_Password','$state_id','$district_id','$optradio','$district_hospital_id','$date','$time','$village','$sim','6')";
		}
	}else{

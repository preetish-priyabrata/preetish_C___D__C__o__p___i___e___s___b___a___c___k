	...
	if($search_table==1){ ?>
    	...
    	<label class="control-label col-sm-2" for="district_id">Indent Raised To :</label>
     		<div class="col-sm-6">
				...
				<label class="radio-inline" id="hidde_aphc"><input type="radio" name="sub_center_dis_hos" value="12" required="">District-Hospital</label>
     		</div>
    </div> 
	...
	var Desigination_users = $('#Desigination_user').val();
     if(Desigination_users=='3'){
       ...
       //    $("#user_pass_hiden").show();
        ...
        // get_block_dh();
    }else if(Desigination_users=='5' || Desigination_users=='7'){
    	 $("#hidde_block").show();
    	$("#hidde_block_center").show();
    	 $("#hidde_aphc").hide();
    	 $('input:radio[name="sub_center"][value="1"]').attr('checked', true);
    }else if(Desigination_users=='6' ||  Desigination_users=='8'){
    	 $("#hidde_block").show();
    	$("#hidde_block_center").show();
    	 $("#hidde_phc").hide();
    	 $('input:radio[name="sub_center"][value="2"]').attr('checked', true);
    }else if(Desigination_users=='9' || Desigination_users=='10'){
    	$("#hidde_block").show();
    	$("#hidde_block_center").show();
    	 $("#hidde_phc").show();
    }

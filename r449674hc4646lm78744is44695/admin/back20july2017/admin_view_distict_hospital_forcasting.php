  ...
  <div class="content-wrapper">
    ...
    <div class="box box-info">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>List Of Forcasting District Hospital(DH)</strong></div>
        <div class="demo">
          <div class="panel-body">
              ...
              <?php 
              $x=0;
              $query="SELECT * FROM `rhc_master_forcasting_indent` WHERE `place_status`='4'";
              $sql_exe=mysqli_query($conn,$query);
              while($res=mysqli_fetch_assoc($sql_exe)){

                  $place_id=$res['place_id'];
                  $query_place="SELECT * FROM `rhc_master_place_dh` WHERE `place_hostpital_id`='$place_id'";
                  $sql_exe_place=mysqli_query($conn,$query_place);
                  $res_place=mysqli_fetch_assoc($sql_exe_place);

                  $district=$res_place['place_district_id'];
               ...
               <tr>
                ...
                ?>
                 ...
                 <td><?php
                  echo $res_place['hosptial_name']."[".$res_place['place_hostpital_id']."]";

  ...
  <div class="content-wrapper">
    ...
    <div class="box box-info">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>List Of Forcasting District</strong></div>
        <div class="demo">
          <div class="panel-body">
              ...
              <?php 
              $x=0;
              $query="SELECT * FROM `rhc_master_forcasting_indent` WHERE `place_status`='2'";
              ...
              while($res=mysqli_fetch_assoc($sql_exe)){
               ...
               <tr>
                ...
                <td><?php
                  ...
                  $query_place="SELECT * FROM `rhc_master_place_district` WHERE `place_district_id`='$place_id'";
                  $sql_exe_place=mysqli_query($conn,$query_place);
                  $res_place=mysqli_fetch_assoc($sql_exe_place);
                  echo $res_place['district_name']."[".$res_place['place_district_id']."]";
                ?>
                </td>

...
?>
    ...
    <section class="content-header">
      <h1>
        PHC Sub-Center Forecasting
        <!-- <small>it all starts here</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">PHC Sub-Center Forecasting</li>
        ...
        <div class="col-sm-10">
          ...
          <div class="box box-primary">
            <div class="box-header with-border"  style="background-color: orange">
              <h3 class="box-title">PHC Sub-center Forecast </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" class="form-horizontal" action="admin_forcasting_save.php" method="POST">
            <input type="hidden" name="place_status" value="7">
              <div class="box-body">
                

                <div class="form-group">
                  <label class="control-label col-sm-2" for="sub1">PHC Sub-Center  :</label>
                  <div class="col-sm-6">
                  <select class="form-control text-center" onchange="check_quantity()" name="sub1" id="sub1" required="">
                            
                   <?php 
                      $query_aphc="SELECT * FROM `rhc_master_place_phc_sub_center` ";
                      ...
                      if($num_aphc!=0){
                        ...
                        while ($res_aphc=mysqli_fetch_assoc($sql_exe_aphc)) {?>
                          <option value="<?=$res_aphc['place_phc_sub_id']?>"> <?=$res_aphc['phc_sub_center_name']?> [<?=$res_aphc['place_phc_sub_id']?>]</option> 
                        <?php }
                      }else{
                        ?>
                          <option value="">-- No PHC sub-center Is Present In This PHC-- </option>  
                      <?php
                      }?>
                  </select>
  ...
  function check_quantity() {
    ...
    if(Quantity!=""){
      $.ajax({
        ...
        data:{place_id:aphc_id,item_code:item_code,item_type:item_type,Quantity:Quantity,status_places:status_place},

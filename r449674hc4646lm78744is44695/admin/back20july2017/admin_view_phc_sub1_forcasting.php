  ...
  <div class="content-wrapper">
    ...
    <div class="box box-info">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>List Of Forcasting PHC-HSC</strong></div>
        <div class="demo">
          <div class="panel-body">
              ...
              <?php 
              $x=0;
              $query="SELECT * FROM `rhc_master_forcasting_indent` WHERE `place_status`='7'";
              ...
              while($res=mysqli_fetch_assoc($sql_exe)){
                  ...
                  $query_place="SELECT * FROM `rhc_master_place_phc_sub_center` WHERE `place_phc_sub_id`='$place_id'";
                  $sql_exe_place=mysqli_query($conn,$query_place);
                  $res_place=mysqli_fetch_assoc($sql_exe_place);

                  $place_phc_id=$res_place['place_phc_id'];
                  $query_phc="SELECT * FROM `rhc_master_place_phc` WHERE `place_phc_id`='$place_phc_id'";
                  $sql_exe_phc=mysqli_query($conn,$query_phc);
                  $res_phc=mysqli_fetch_assoc($sql_exe_phc);

                  $block=$res_phc['place_block_id'];
               ...
               <tr>
                ...
                ?>
                 ...
                 <td><?php
                  echo $res_phc['phc_name']."[".$res_phc['place_phc_id']."]";
                  
                ?>
                </td>
                <td><?php
                  echo $res_place['phc_sub_center_name']."[".$res_place['place_phc_sub_id']."]";

  ...
  <div class="content-wrapper">
    ...
    <div class="box box-info">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>List Of Forcasting APHC</strong></div>
        <div class="demo">
          <div class="panel-body">
              ...
              <?php 
              $x=0;
              $query="SELECT * FROM `rhc_master_forcasting_indent` WHERE `place_status`='6'";
              $sql_exe=mysqli_query($conn,$query);
              while($res=mysqli_fetch_assoc($sql_exe)){

                  $place_id=$res['place_id'];
                  $place_id=$res['place_id'];
                  $query_place="SELECT * FROM `rhc_master_place_aphc` WHERE `place_aphc_id`='$place_id'";
               ...
               <tr>
                ...
                ?>
                 ...
                 <td><?php
                  echo $res_place['aphc_name']."[".$res_place['place_aphc_id']."]";

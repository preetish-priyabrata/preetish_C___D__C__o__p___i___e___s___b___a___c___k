...
?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">District Forecasting</li>
        ...
        <div class="col-sm-10">
          ...
          <div class="box box-primary">
            <div class="box-header with-border"  style="background-color: orange">
              <h3 class="box-title">District Forcast </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" class="form-horizontal" action="admin_forcasting_save.php" method="POST">
            <input type="hidden" name="place_status" value="2">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                   <select class="form-control text-center" onchange="check_quantity()" name="district_id" id="district_id" required="" >
  ...
  function check_quantity() {
    ...
    if(Quantity!=""){
      $.ajax({
        ...
        data:{place_id:district_id,item_code:item_code,item_type:item_type,Quantity:Quantity,status_places:status_place},
        success:function(html){  
          ...
          if(html==1){
              ...
              if(html==2){
                document.getElementById("myerror").innerHTML = "Item Code And Type Already Existed For This District";
               $("#save").hide();
             }
             if(html==0){

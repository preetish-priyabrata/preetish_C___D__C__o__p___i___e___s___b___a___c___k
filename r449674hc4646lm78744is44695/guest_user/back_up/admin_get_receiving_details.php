...
?>
        ...
        <tbody>
          ...
          $x=0;
          $query_list="SELECT * FROM `rhc_master_district_challan_no` WHERE `receiver_place_id`='$district_id' and  `status`='1'  ";
...
?>
        ...
        <table id="example1" class="table table-bordered table-striped table-hover text-center">
          ...
          $x=0;
             $query_list="SELECT * FROM `rhc_master_dh_block_challan_no` WHERE `receiver_place_id`='$block_dh_uphc' and  `status`='1'  ";
            $sql_exe_list=mysqli_query($conn,$query_list);
            while ($res_list=mysqli_fetch_assoc($sql_exe_list)) {
              $x++;
              ?>              
...
?>
          ...
          <table id="example1" class="table table-bordered table-striped table-hover text-center">
            ...
            <tbody>
              ...
              $x=0;
              $query_list="SELECT * FROM `rhc_master_phc_aphc_challan_no` WHERE `receiver_place_id`='$phc_aphc' and  `status`='1'  ";
              $sql_exe_list=mysqli_query($conn,$query_list);
              while ($res_list=mysqli_fetch_assoc($sql_exe_list)) {
              $x++;
              ?>              

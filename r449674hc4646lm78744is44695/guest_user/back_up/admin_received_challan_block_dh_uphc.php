...
// exit;
  ...
  // $get_place_fetch_detail=mysqli_fetch_assoc($sql_exe_get_place);
   ...
   $query_list="SELECT * FROM `rhc_master_dh_block_indent` WHERE `indent_id`='$indent_id' AND `status`!='1'";
      ...
      <div id="section-to-print">
            <div class="col-md-12">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="email">Date :</label>                 
                    <?=date('d-m-Y',strtotime(trim($res_list['date_update_status'])));?>
              ...
              <div class="form-group ">
               ...
               <?=date('h:i:s a',strtotime(trim($res_list['time_update_status'])));?>

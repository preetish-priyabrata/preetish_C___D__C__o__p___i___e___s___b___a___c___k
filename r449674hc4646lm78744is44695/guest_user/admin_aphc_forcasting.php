...
?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">APHC Forecasting</li>
            ...
            <input type="hidden" name="place_status" value="6">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                  <select class="form-control text-center" onchange="check_quantity()" name="aphc_id" id="aphc_id" required="">
                            
                   <?php 
                      $query_aphc="SELECT * FROM `rhc_master_place_aphc` ";

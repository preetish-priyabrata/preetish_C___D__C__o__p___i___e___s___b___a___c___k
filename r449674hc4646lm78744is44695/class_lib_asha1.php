    	  ...
    	  $message1=strtolower($sms_district);
    	   if (preg_match('/ind/',$message1)){
    	   		...
    	   		if (preg_match('/update/',$message1)){
    	   			...
    	   			// echo "hello";
    	   			return asha_iss_rec($message1,$mobs);
    	   		}
...
// ///////////////////////////////////////////////////////////////////////////////////////////////
//																								// 
// 			                  receive setion of  HERE IT SEPRATED	        					//
// 																								//
// ///////////////////////////////////////////////////////////////////////////////////////////////

function asha_iss_rec($message1,$mobs){
	...
	if(($num_rows==1) && ($num_rows1==0)){
		...
		return asha_receive($message_value,$mobs_value,$challan_value,$item_details1,$receiver_id,$issuer_id);

	}else if(($num_rows==0) && ($num_rows1==1)){
		echo "sorry Issue feature is not Avaliable with AHSA User";
		exit;
		// $fetch_get_details=mysqli_fetch_assoc($sql_exe_check_challan);
		// $receiver_id=$fetch_get_details['receiver_place_id'];
	 //    $issuer_id=$fetch_get_details['issuer_place_id'];
...
//////////////////////////////////////////////////////////////////////////////////////////////////
// receiver section
function asha_receive($message_value,$mobs_value,$challan_value,$item_details1,$receiver_id,$issuer_id){
	global $conn;

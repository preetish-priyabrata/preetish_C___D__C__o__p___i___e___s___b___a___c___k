...
$batch_no=$_REQUEST['batch_no'];
	//here we have get information of batch total stock and avaliable stock in particular 
	 $sql_query="SELECT * FROM `rhc_master_stock_district_hospital_batch_details` WHERE `slno`='$slno' and `batch_nos`='$batch_no'and `dh_stock_batch_id`='$batch_store_id'";
	...
	if($num!=0){
		...
		$state_item="SELECT * FROM `rhc_master_stock_district_hospital_items` WHERE `dh_stock_batch_id`='$batch_store_id' and `dh_place_id`='$place_id_dh'";

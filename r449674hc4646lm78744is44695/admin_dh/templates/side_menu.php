      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="admin_avaliable_stock_view.php"><i class="fa fa-circle-o"></i>Stock In  <?php  echo $dh_fetch_detail['place_hostpital_id'];?></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li >
                  ...
                  <ul class="treeview-menu " style="display: none;">
                            <?php if($_SESSION['designation']!='1'){?>
                    <li><a href="admin_update_stock_sent_list.php"><i class="fa fa-circle-o"></i> Update Sent</a></li>
                    <?php }?>
                    <!-- <li><a href="admin_receive_indent_history.php"><i class="fa fa-circle-o"></i>Update Received</a></li> -->
                  </ul>
                </li>
          </ul>
        </li>

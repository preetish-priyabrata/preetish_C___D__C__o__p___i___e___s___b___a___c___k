...
include 'config.php';
 $msg = new \Preetish\FlashMessages\FlashMessages();
  ...
  $query_list="SELECT * FROM `rhc_master_dh_block_indent` WHERE `indent_place_raised_by`='$place_id' and `indent_id`='$indent_id' ";
  ...
  $user_palce=strtoupper($district_fetch_detail['district_name']).'['.$district_fetch_detail['place_district_id'].']';
    ...
    $get_block="SELECT * FROM `rhc_master_place_dh` WHERE `place_hostpital_id`='$place_block_id'";

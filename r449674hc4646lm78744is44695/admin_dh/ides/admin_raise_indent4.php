      ...
      <div class="panel panel-default">
        ...
        <div class="demo">
          <div class="panel-body">
           ...
           <table id="dataTable" class="form table table-striped text-center" border="1">
            <thead align="center">
              <tr>
               <!--  <th>Slno</th> -->
                <th>Item Code</th>
                <th>Type</th>
                <th>Quantity</th>
                <th id="btnAdd" class="button-add"><button type="button" value="" onClick="addRow('dataTable')" >Add New Item</th>
              </tr>
              </thead>
             <tbody>
              <tr>
...
function addRow(tableID) {
  ...
  if(rowCount < 12){                            // limit the user from creating fields more than your limits
    ...
    for(var i=0; i <colCount; i++) {
     ...
     alert("Maximum Indent value Is 12");

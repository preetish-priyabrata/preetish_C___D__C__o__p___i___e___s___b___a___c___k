  ...
  $item=$array_lists[$j]['item'];
    ...
    if($x_item_batch==$x_item_rec){
      if($qnt!=0){
        ...
        $query_get_item_code_id1="SELECT * FROM `rhc_master_stock_district_hospital_items` WHERE `item_types`='$Item_type_batchs' and `item_codes`='$item_code_batchs' and `dh_place_id`='$receiver_id'";

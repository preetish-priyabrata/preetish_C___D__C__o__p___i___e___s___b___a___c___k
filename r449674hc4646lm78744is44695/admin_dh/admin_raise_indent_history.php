          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php
                      ...
                      $query_list="SELECT * FROM `rhc_master_dh_block_indent` WHERE `indent_place_raised_by`='$place_id' AND `status`!='0'";
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        $get_block="SELECT * FROM `rhc_master_place_dh` WHERE `place_hostpital_id`='$place_district_id'";

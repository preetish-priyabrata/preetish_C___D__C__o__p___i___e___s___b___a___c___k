...
require 'config.php';
 ...
 $query_item="SELECT * FROM `rhc_master_update_district_stock` WHERE `updated_place_from`='$place_id_district' and `slno`='$slno'";
          ...
          <div class="panel-body">
            <form class="form-inline" id="issue_forms" >
             <div  id="printarea">
              ...
              <div class="row">
              <div class="col-md-12">
              <table id="myTable" class="table table-striped text-center" border="1" width="100">
              <thead align="center">
              <tr>
                <th>Slno</th>
                <th>Item Code</th>

...
?>
    ...
    <section class="content-header">
      <h1>
        Receipt Confirmation  Sent List
        <small></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#"> Receipt Confirmation  Sent List</a></li>
    ...
    <div class="col-sm-11">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>List Of  Confirmation Sent</strong></div>
        <div class="demo">
          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    $x=0;
                      $query_list="SELECT * FROM `rhc_master_district_challan_no` WHERE `receiver_place_id`='$place_id' and  `status`='1'  ";

...
legend {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Confirmation Receipt Details Of Commodities
        <mdall></mdall>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#"> Receive </a></li>
        <li class="active"><a href="#">Confirmation Receipt Details Of Commodities</a></li>
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>Confirmation Receipt Details</strong></div>
        <div class="demo">

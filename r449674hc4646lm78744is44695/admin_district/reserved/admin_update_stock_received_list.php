          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php
                      ...
                      $query_list="SELECT * FROM `rhc_master_update_dh_block_stock` WHERE `updated_place_to`='$place_id' ORDER BY `slno` DESC ";
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        if($result_list['place_status']=='1'){
                          $block_id=$result_list['updated_place_from'];
                          ...
                          if($result_list['place_status']=='2'){
                            $dh_id=$result_list['updated_place_from'];

        ...
        <div class="demo">
          <div class="panel-body">
            <form class="form-inline" id="issue_forms" action="admin_update_stock_save.php" method="POST">
              ...
              <?php
              $x=0;
                $query_item="SELECT * FROM `rhc_master_stock_district_items` WHERE `distrct_place_id`='$place_id_district'";
                ...
                while ($result_list_item=mysqli_fetch_assoc($sql_exe)) {
                 ...
                 <tr>
                  ...
                  ?>
                    <input type="hidden"  id="temp1_quantity<?=$x?>" name="item_quantity1[]" value="<?=$result_list_item['item_quantity']?>">
                  </td>
                  <td>
                  <input type="hidden"  id="temp1_quantity<?=$x?>" name="item_quantity1[]" value="<?=$result_list_item['item_quantity']?>">
                  </td> -->
                  <td><input type="text" id="temp_quantity<?=$x?>" name="item_quantity[]" value="<?=$result_list_item['item_quantity']?>" readonly>

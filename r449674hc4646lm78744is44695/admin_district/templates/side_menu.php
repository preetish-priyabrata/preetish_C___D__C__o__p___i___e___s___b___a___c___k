...
?>
          <ul class="treeview-menu">
            ...
            <li><a href="admin_avaliable_stock_view.php"><i class="fa fa-circle-o"></i>Stock In <?php  echo strtoupper($district_fetch_detail['district_name']).'['.$district_fetch_detail['place_district_id'].']'?></a></li>

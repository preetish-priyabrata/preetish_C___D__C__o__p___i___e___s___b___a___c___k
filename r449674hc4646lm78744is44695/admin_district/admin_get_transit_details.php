	...
	if(!empty($_POST['place_id'])){
      ...
      ?>
          ...
          <table id="example1" class="table table-bordered table-striped table-hover text-center">
            ...
            <tbody>
              ...
              $x=0;
              $query_list="SELECT * FROM `rhc_master_district_challan_no` WHERE `issuer_place_id`='$state_id' and `status`!='1' ";
      ...
      <table id="example1" class="table table-bordered table-striped table-hover text-center">
        ...
        <tbody>
          ...
          $x=0;
          $query_list="SELECT * FROM `rhc_master_dh_block_challan_no` WHERE `issuer_place_id`='$place_id' and `status`!='1' ORDER BY `slno` DESC ";
          $sql_exe_list=mysqli_query($conn,$query_list);
          while ($res_list=mysqli_fetch_assoc($sql_exe_list)) {
          $x++;
          ?>   
	 ...
	 <?php
      ...
      <table id="example1" class="table table-bordered table-striped table-hover text-center">
        ...
        $x=0;
        $query_list="SELECT * FROM `rhc_master_phc_aphc_challan_no` WHERE `issuer_place_id`='$place_id'  and `status`!='1'  ORDER BY `slno` DESC ";
        $sql_exe_list=mysqli_query($conn,$query_list);
        while ($res_list=mysqli_fetch_assoc($sql_exe_list)) {
          // print_r($res_list);
        $x++;
          ...
          ?>
            ...
            <table id="example1" class="table table-bordered table-striped table-hover text-center">
                ...
                <tbody>
                  ...
                  $place_id=$phc_aphc;
                  $x=0;
                  $query_list="SELECT * FROM `rhc_master_aphc_asha_challan_no` WHERE `issuer_place_id`='$place_id'   and `status`!='1' ORDER BY `slno` DESC ";
                  $sql_exe_list=mysqli_query($conn,$query_list);
                  while ($res_list=mysqli_fetch_assoc($sql_exe_list)) {
                  $x++;
                  ?>              

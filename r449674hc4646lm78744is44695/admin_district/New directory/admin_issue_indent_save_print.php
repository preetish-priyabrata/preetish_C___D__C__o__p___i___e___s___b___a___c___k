...
include 'config.php';
 $msg = new \Preetish\FlashMessages\FlashMessages();
  ...
  $query_list="SELECT * FROM `rhc_master_indent` WHERE `indent_place_raised_to`='$place_id' and `indent_id`='$indent_id' AND `status`='2'";
...
$query_challan="SELECT * FROM `rhc_master_challan_no` WHERE `challen_no`='$challen'";
      ...
      <div class="panel panel-default">
        ...
        <div class="demo">
          <div class="panel-body">
            <form class="form-inline" action="admin_issue_indent_print_save.php" method="POST" >
        <div  id="printarea">
  		<div id="section-to-print">
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="receiver_id" value="<?=$block_fetch_detail['place_block_id']?>">
              ...
              <tbody align="center">
                  <?php 
                  $x=1;
                $query_list_item="SELECT * FROM `rhc_master_itemdetails_challan_no` WHERE `challan_no`='$challen'";
                    ...
                    <td>
                    	<table class="table table-striped" border="1" width="100%">
                    		...
                    		$item_batch_id=$res_item['item_batch_id'];
                    			$query_batch_details="SELECT * FROM `rhc_master_receive_batch_detail_item_block` WHERE `item_batch_id`='$item_batch_id'";

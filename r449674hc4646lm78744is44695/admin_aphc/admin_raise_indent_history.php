          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php
                      ...
                      $query_list="SELECT * FROM `rhc_master_phc_aphc_indent` WHERE `indent_place_raised_by`='$place_id' AND `status`!='0'";
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        $get_block="SELECT * FROM `rhc_master_place_aphc` WHERE `place_aphc_id`='$place_phc_id'";

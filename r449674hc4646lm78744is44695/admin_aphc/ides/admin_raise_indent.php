          ...
          <div class="panel-body">
            <form class="form-inline" id="indent" action="admin_raise_indent_save.php" method="POST">
              ...
              <div class="form-group pull-right">
                ...
                <?php $place_id_block=$_SESSION['place_id']?>
                <?php 
                ...
                <input type="hidden" name="top_place_id" value="<?=$block_fetch_detail['place_district_id']?>">
                <input type="hidden" name="raise_place_id" value="<?=$block_fetch_detail['place_block_id']?>">

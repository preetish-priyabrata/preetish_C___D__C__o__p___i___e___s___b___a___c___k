            ...
            <form role="form" class="form-horizontal" action="admin_user_creation_save.php" method="POST">
              <div class="box-body">
                <div class="form-group">
                  <label class="control-label col-sm-2" for="Desigination_user">Designation:</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" onkeyup="user_auto()" id="user_email" name="user_email" placeholder="Enter Email Id" required="">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" for="user_mobile">Mobile No:</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="user_mobile" name="user_mobile" placeholder="Enter Mobile No" required="">
                  </div>
                </div>
                <div class="hidden">
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="user_alt_mobile" name="user_alt_mobile" placeholder="Enter Mobile">
                    </div>
                  </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
  ...
  function get_selection_designa() {
    ...
    if(Desigination_users=='2'){
        $("#dist_hidden").show();
         $("#user_pass_hiden").show();
    }else if(Desigination_users=='4'){
       $("#dist_hidden").show();

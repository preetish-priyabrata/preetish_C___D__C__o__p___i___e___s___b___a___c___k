...
$time=date('H:i:s');
	if($Desigination_user==1){
		...
		$query_insert="INSERT INTO `rhc_master_login_user`(`slno`, `user_name`,  `user_designation`, `user_email`, `user_mobile`,  `user_id`, `password`, `place_state_id`,`date_creation`, `time_creation`) VALUES (NULL,'$user_name' ,'$Desigination_user','$user_email','$user_mobile','$user_id','$user_Password','$state_id','$date','$time')";
		...
		$query_insert="INSERT INTO `rhc_master_login_user`(`slno`, `user_name`,  `user_designation`, `user_email`, `user_mobile`, `user_id`, `password`, `place_state_id`, `place_district_id`, `date_creation`, `time_creation`) VALUES (NULL,'$user_name' ,'$Desigination_user','$user_email','$user_mobile','$user_id','$user_Password','$state_id','$district_id','$date','$time')";
		...
		$query_insert="INSERT INTO `rhc_master_login_user`(`slno`, `user_name`,  `user_designation`, `user_email`, `user_mobile`,  `user_id`, `password`, `place_state_id`, `place_district_id`, `place_block_dh_status`, `place_block_dh_id`, `date_creation`, `time_creation`) VALUES (NULL,'$user_name' ,'$Desigination_user','$user_email','$user_mobile','$user_id','$user_Password','$state_id','$district_id','$optradio','$block_id','$date','$time')";
		...
		$query_insert="INSERT INTO `rhc_master_login_user`(`slno`, `user_name`,  `user_designation`, `user_email`, `user_mobile`,  `user_id`, `password`, `place_state_id`, `place_district_id`, `place_block_dh_status`, `place_block_dh_id`, `date_creation`, `time_creation`) VALUES (NULL,'$user_name' ,'$Desigination_user','$user_email','$user_mobile','$user_id','$user_Password','$state_id','$district_id','$optradio','$district_hospital_id','$date','$time')";
		...
		$optradio=trim($_POST['optradio']);
		$block_id=trim($_POST['block_id']);
		$sub_center=trim($sub_center);
		$phc_id=trim($phc_id);

		 $query_insert="INSERT INTO `rhc_master_login_user`(`slno`, `user_name`,  `user_designation`, `user_email`, `user_mobile`,  `user_id`, `password`, `place_state_id`, `place_district_id`, `place_block_dh_status`, `place_block_dh_id`, `plsce_phc_aphc_status`, `place_phc_aphc_id`, `date_creation`, `time_creation`) VALUES (NULL,'$user_name' ,'$Desigination_user','$user_email','$user_mobile','$user_id','$user_Password','$state_id','$district_id','$optradio','$block_id','$sub_center','$phc_id','$date','$time')";
		...
		$query_insert="INSERT INTO `rhc_master_login_user`(`slno`, `user_name`,  `user_designation`, `user_email`, `user_mobile`,  `user_id`, `password`, `place_state_id`, `place_district_id`, `place_block_dh_status`, `place_block_dh_id`, `plsce_phc_aphc_status`, `place_phc_aphc_id`, `sub_center_id`,  `date_creation`, `time_creation`) VALUES (NULL,'$user_name' ,'$Desigination_user','$user_email','$user_mobile','$user_id','$user_Password','$state_id','$district_id','$optradio','$block_id','$sub_center','$APHC_id','$sub_APHC_id','$date','$time')";

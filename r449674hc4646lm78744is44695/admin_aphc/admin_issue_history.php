...
?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Issued Challan List</a></li>
    ...
    <div class="col-sm-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>List Of Challans Issued</strong></div>
        <div class="demo">
          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    $x=0;
                       $query_list="SELECT * FROM `rhc_master_aphc_asha_challan_no` WHERE `issuer_place_id`='$place_id' and `status`='1' or `status`='0' or `status`='2' ORDER BY `slno` DESC ";
                    ...
                    <td><?=$x?></td>                       
                    <td>
                      <a href="admin__issue_challan_detail.php?challen_no=<?=$res_list['challen_no']?>"><?=$res_list['challen_no']?></a>
                    </td>

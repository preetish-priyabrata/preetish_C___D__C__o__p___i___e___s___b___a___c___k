        ...
        <div class="demo">
          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php 
                    $x=0;
                      $query_list="SELECT * FROM `rhc_master_challan_no` WHERE  `status`='0' or `status`='2'";
                    ...
                    <td><?=$x?></td>
                        ...
                        <td><a href="admin_issue_challan.php?challen_no=<?=$res_list['challen_no']?>"><?=$res_list['challen_no']?></a></td>

      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="admin_confirmation_history.php"><i class="fa fa-circle-o"></i>Confirmation History</a></li>
          ...
          <ul class="treeview-menu">
            ...
            <!-- <li >
                  ...
                  <ul class="treeview-menu " style="display: none;">
                    ...
                    <?php }?>
                    <li><a href="admin_update_stock_received_list.php"><i class="fa fa-circle-o"></i>Update Received</a></li>
                  </ul>
                </li> -->
          </ul>
        </li>

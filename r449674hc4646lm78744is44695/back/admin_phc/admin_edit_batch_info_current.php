...
$batch_no=$_REQUEST['batch_no'];
	//here we have get information of batch total stock and avaliable stock in particular 
	 $sql_query="SELECT * FROM `rhc_master_stock_phc_batch_details` WHERE `slno`='$slno' and `batch_nos`='$batch_no'and `phc_stock_batch_id`='$batch_store_id'";
	...
	if($num!=0){
		...
		$state_item="SELECT * FROM `rhc_master_stock_phc_items` WHERE `phc_stock_batch_id`='$batch_store_id' and`phc_place_id`='$place_id_district'";

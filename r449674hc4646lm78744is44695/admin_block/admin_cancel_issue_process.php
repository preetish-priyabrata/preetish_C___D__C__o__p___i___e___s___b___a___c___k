...
$query_challan="SELECT * FROM `rhc_master_phc_aphc_challan_no` WHERE `challen_no`='$challen'";
...
$result_fetch_challen =mysqli_fetch_assoc($sql_exe_challan); 
 ...
 $issuer_id=$place_id=$result_fetch_challen['issuer_place_id'];
   ...
   $query_list="SELECT * FROM `rhc_master_phc_aphc_indent` WHERE `indent_place_raised_by`='$place_id1' and `indent_id`='$indent_id' and `status`='1'";
  ...
  $x=1;
  $query_list_item="SELECT * FROM `rhc_master_phc_aphc_item_details_challan_no` WHERE `challan_no`='$challen'";
  ...
  while ($res_item=mysqli_fetch_assoc($sql_exe_list_item)) {
    ...
    $query_batch_details="SELECT * FROM `rhc_master_phc_aphc_receive_batch_detail_item` WHERE `item_batch_id`='$item_batch_idm'";
 ...
 // print_r($batch_no);
  ...
  for ($i=0; $i <count($item_code) ; $i++) { 
    ...
    $sql_detele="DELETE FROM `rhc_master_phc_aphc_item_details_challan_no` WHERE `item_batch_id`='$item_batch_ids' AND `challan_no`='$challen'";
  ...
  $det_challan="DELETE FROM `rhc_master_phc_aphc_challan_no` WHERE `indent_id`='$indent_id' and `challen_no`='$challen'";

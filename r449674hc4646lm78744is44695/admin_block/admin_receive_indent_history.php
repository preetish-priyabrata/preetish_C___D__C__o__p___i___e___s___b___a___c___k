          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php
                      ...
                      $query_list="SELECT * FROM `rhc_master_phc_aphc_indent` WHERE `indent_place_raised_to`='$place_id' and `status`!='0' ORDER BY `slno` DESC";
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        if($result_list['place_status']=='1'){
                          $phc_id=$result_list['indent_place_raised_by'];
                          ...
                          echo strtoupper($phc_fetch_detail['phc_name']).'['.$phc_fetch_detail['place_phc_id'].']';                      
                            ...
                            $place_id_aphc=$result_list['indent_place_raised_by'];

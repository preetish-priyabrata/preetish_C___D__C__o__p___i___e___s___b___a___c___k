...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        View Stock Of <?php  echo strtoupper($block_fetch_detail['block_name']).'['.$block_fetch_detail['place_block_id'].']';?>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="demo">
          <div class="panel-body">
              ...
              <tr>
               ...
               <?php 
               $date=date('Y-m-d');
                  $get_list="SELECT * FROM `rhc_master_stock_block_items` WHERE `block_place_id`='$place_id_block' ";
                ...
                <?php if($res['status']==0){
                 ...
                 <table class="table" border="1">
                   ...
                   <?php 
                    ...
                    $get_batch="SELECT * FROM `rhc_master_stock_block_batch_details` WHERE `block_stock_batch_id`='$batch_id' and `status`='1' and `date_exp`>'$date' ORDER BY YEAR(`date_exp`) ASC, MONTH(`date_exp`) ASC, DAY(`date_exp`) ASC";

...
$result_fetch_challen =mysqli_fetch_assoc($sql_exe_challan); 
 ...
 $place_id1=$result_fetch_challen['receiver_place_id'];
  ...
  $query_list="SELECT * FROM `rhc_master_phc_aphc_indent` WHERE `indent_place_raised_by`='$place_id1' and `indent_id`='$indent_id' and `status`='2'";
  ...
  //   exit;
  // }
  $get_block="SELECT * FROM `rhc_master_place_block` WHERE `place_block_id`='$place_id'";

...
?>
    ...
    <section class="content-header">
      <h1>
        Receipt Confirmation Received List
        <small></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Receipt Confirmation Received List</a></li>
    ...
    <div class="col-sm-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>List Of  Confirmation Received</strong></div>
        <div class="demo">

...
?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">UPHC Forecasting</li>
        ...
        <div class="col-sm-10">
          ...
          <div class="box box-primary">
            <div class="box-header with-border"  style="background-color: orange">
              <h3 class="box-title">UPHC Forecast </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" class="form-horizontal" action="admin_forcasting_save.php" method="POST">
            <input type="hidden" name="place_status" value="11">
              <div class="box-body">
                

                <div class="form-group">
                  <label class="control-label col-sm-2" for="uphc_id">UPHC :</label>
                  <div class="col-sm-6">
                  <select class="form-control text-center" onchange="check_quantity()" name="uphc_id" id="uphc_id" required="">
                            
                      <?php 
                        $query_district_host="SELECT * FROM `rhc_master_place_uphc`";
...
<script type="text/javascript">
  function check_quantity() {
    ...
    var district_hospital_id=$('#uphc_id').val();

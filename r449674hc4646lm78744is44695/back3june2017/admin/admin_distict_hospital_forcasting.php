...
?>
    ...
    <section class="content-header">
      <h1>
        District Hospital Forecasting
        <!-- <small>it all starts here</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">District Hospital Forecasting</li>
        ...
        <div class="col-sm-10">
          ...
          <div class="box box-primary">
            <div class="box-header with-border"  style="background-color: orange">
              <h3 class="box-title">District Hospital Forecast </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" class="form-horizontal" action="admin_forcasting_save.php" method="POST">
            <input type="hidden" name="place_status" value="4">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                  <select class="form-control text-center" onchange="check_quantity()" name="district_hospital_id" id="district_hospital_id" required="">
                            
                      <?php 
                        $query_district_host="SELECT * FROM `rhc_master_place_dh`";
...
<script type="text/javascript">
  function check_quantity() {
    ...
    var district_hospital_id=$('#district_hospital_id').val();
    ...
    if(Quantity!=""){
      $.ajax({
        ...
        data:{place_id:district_hospital_id,item_code:item_code,item_type:item_type,Quantity:Quantity,status_places:status_place},
        success:function(html){  
          ...
          if(html==1){
              ...
              if(html==2){
                document.getElementById("myerror").innerHTML = "Item Code And Type Already Existed For This District Hospital";
               $("#save").hide();
             }
             if(html==0){

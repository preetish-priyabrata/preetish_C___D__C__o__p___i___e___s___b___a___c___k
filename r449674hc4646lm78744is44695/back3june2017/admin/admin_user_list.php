          ...
          <div class="panel-body">
              ...
              while($res=mysqli_fetch_assoc($sql_exe)){
               ...
               <tr>
                ...
                <td><?php 
                if($res['status']==1){?>
                  <a href="admin_active_inactive.php?serial=<?=$res['slno']?>&act=1"><b style='color:green'>Active</b></a>
               <?php }else{ ?>
                    <a href="admin_active_inactive.php?serial=<?=$res['slno']?>&act=2"><b style='color:red'>Inactive</b></a>
                    <?php
                }?>
                </td>

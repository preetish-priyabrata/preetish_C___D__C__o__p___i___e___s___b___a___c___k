      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="admin_distict_hospital_forcasting.php"><i class="fa fa-circle-o"></i>District Hospital / SDH Forecating</a></li>
             <li><a href="admin_uphc_forcasting.php"><i class="fa fa-circle-o"></i>UPHC Forecating</a></li>
            <li><a href="admin_phc_forcasting.php"><i class="fa fa-circle-o"></i>PHC Forecastion</a></li>
            <li><a href="admin_aphc_forcasting.php"><i class="fa fa-circle-o"></i>APHC Forecasting</a></li>
            <li><a href="admin_phc_sub1_forcasting.php"><i class="fa fa-circle-o"></i>PHC Sub-Center Forecasting</a></li>
             <li><a href="admin_aphc_sub1_forcasting.php"><i class="fa fa-circle-o"></i>APHC Sub-Center Forecasting</a></li>

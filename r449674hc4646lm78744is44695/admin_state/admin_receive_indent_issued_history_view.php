  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">View Indent Issued</a></li>
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>Challan </strong></div>
        <div class="demo">
        ...
        <div  id="printarea">
  		<div id="section-to-print">
            ...
            <a href="admin_receive_indent_issue_history.php"  class="btn btn-default">Back</a>

          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php
                      ...
                      $query_list="SELECT * FROM `rhc_master_district_indent` WHERE `indent_place_raised_to`='$place_id' AND `status`!='0'";
                    ...
                    <tr>
                      ...
                      <td><?php
                            if($result_list['status']==2){?>
                      <a href="admin_receive_indent_history_view.php?indent_id=<?=$result_list['indent_id'];?>" class="btn btn-info" role="button">More</a></td>
                      <?php  }else{ ?>

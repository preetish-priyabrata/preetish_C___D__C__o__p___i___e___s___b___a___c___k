...
?>
    ...
    <section class="content-header">
      <h1>
         Confirmation Received History
        <!-- <small>Issued History</small> -->
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Receive </a></li>
        <li><a href="#">  Confirmation Received History</a></li>
    ...
    <div class="col-sm-10">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>List Of Confirmation Received History</strong></div>
        <div class="demo">
          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php
                      ...
                      $query_list="SELECT * FROM `rhc_master_district_challan_no` WHERE `status`='1' ORDER BY `slno` DESC ";
                    ...
                    <tr>
                      ...
                      <td>
                        <?php 
                        $place_district_id=$result_list['receiver_place_id'];
                      ...
                      <td><?php
                            if($result_list['status']==0){
                              echo "<small style='color:orange'>Transit</small>";
                            }else{
                              echo "<small style='color:Green'>Received</small>";
                            }
                      ?></td>
                      <td><?php
                            if($result_list['status']==0){?>
                      <a href="admin_received_confirmation_view.php?indent_id=<?=$result_list['indent_id'];?>" class="btn btn-info" role="button">More</a></td>
                      <?php  }else{ ?>
                       <a href="admin_received_confirmation_view.php?indent_id=<?=$result_list['indent_id'];?>" class="btn btn-info" role="button">More</a></td>
                      <?php 
                    }

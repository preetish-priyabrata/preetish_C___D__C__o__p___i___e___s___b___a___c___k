...
?>
    ...
    <section class="content-header">
      <h1>
        Challan Issued History
        <small>Issued History</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Issue</a></li>
        <li><a href="#">Issued History</a></li>
    ...
    <div class="col-sm-10">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>List Of Challan Issued History</strong></div>
        <div class="demo">
          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php
                      ...
                      $query_list="SELECT * FROM `rhc_master_district_challan_no` ORDER BY `slno` DESC ";
                    ...
                    <tr>
                      ...
                      <td><?php
                            if($result_list['status']==0){?>
                      <a href="admin_receive_indent_issued_history_view.php?indent_id=<?=$result_list['indent_id'];?>" class="btn btn-info" role="button">More</a></td>
                      <?php  }else{ ?>
                       <a href="admin_receive_indent_issued_history_view.php?indent_id=<?=$result_list['indent_id'];?>" class="btn btn-info" role="button">More</a></td>
                      <?php 
                    }

...
?>
    ...
    <div class="col-sm-10">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>List Of Update History</strong></div>
        <div class="demo">
          ...
          <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php
                      ...
                      $query_list="SELECT * FROM `rhc_master_update_district_stock` ORDER BY `slno` DESC ";
                    ...
                    <tr>
                      ...
                      <td>
                        <?php 
                        $place_district_id=$result_list['updated_place_from'];
                      ...
                      <td><?php
                            if($result_list['status']==0){?>
                      <a href="admin_update_history_detail.php?serial_no=<?=$result_list['slno'];?>" class="btn btn-info" role="button">More</a></td>
                      <?php  }else{ ?>
                       <a href="admin_update_history_detail.php?serial_no=<?=$result_list['slno'];?>" class="btn btn-info" role="button">More</a></td>
                      <?php 
                    }

    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <li >
            <a href="#"><i class="fa fa-circle-o"></i>Add & View Stock
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
            </a>
            <ul class="treeview-menu " style="display: none;">                           
              <li><a href="admin_stock_entry.php"><i class="fa fa-circle-o"></i>Stock Entry</a></li>                   
              <li><a href="admin_stock_entry_view.php"><i class="fa fa-circle-o"></i>view Stock Entered</a></li>
            </ul>
          </li>
           ...
           <ul class="treeview-menu">
          <li >
            <a href="#"><i class="fa fa-circle-o"></i>QC Stock Test
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
            </a>
            <ul class="treeview-menu " style="display: none;">                           
              <li><a href="admin_stock_entry_view_list.php"><i class="fa fa-circle-o"></i>Stock Issued To Test </a></li>                   
              <li><a href="admin_stock_entry_entry_view_list1.php"><i class="fa fa-circle-o"></i>Receive Test Stock</a></li>
            </ul>
          </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="admin_class_section.php"><i class="fa fa-circle-o"></i>Issued History</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
           <?php if($_SESSION['designation']!='1'){?>
            ...
            <?php }?>
            <li><a href="admin_subject_name.php"><i class="fa fa-circle-o"></i>Confirmation History</a></li>
          </ul>
        </li>
        <!-- <li class="treeview">
          <a href="#">

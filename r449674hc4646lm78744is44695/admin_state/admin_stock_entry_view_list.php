  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">View New Stock List</a></li>
    ...
    <div class="box box-info">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>View New Stock List</strong></div>
        <div class="demo">
          <div class="panel-body">
              ...
              <tr>
               ...
               <?php 
                  $get_list="SELECT * FROM `rhc_master_chall_state` where `status`='0' ";
                  ...
                  <th><?=$res['time']?></th>
                   <th>
                    <a href="admin_stock_entry_view_detail1.php?qc_challan=<?=$res['challan_no']?>">Qc Issue Test</a>
                   </th>
                </tr>
                <?php }?>
              </table>

      ...
      <div class="panel panel-default">
        ...
        <div class="demo">
          <div class="panel-body">
            <form class="form-inline" id="stock_add" action="admin_stock_entry_save.php"  method="POST">
              <div class="col-sm-6">
              ...
              <td>
                ...
                <td>
                 <input type="text" autocomplete="off" class="form-control" onkeyup="check_batch()" name="batch_no" id="batch_no" required>
                 </td>
                 <td>
                  <input type="text" autocomplete="off" class="form-control" name="quanity" name="quanity" required>
                  </td>
                  <td>
                   <input type="text" autocomplete="off" class="form-control" name="expire" id="expire" required>
                   </td>
                   </tr>
              </table>
          ...
          <span class="pull-right" id="save">
           ...
           <button type="submit" onclick="check_batch()" class="btn btn-default">Submit</button>
           </span>
           </div>
        </div>
          </form>

  ...
  <div class="content-wrapper">
    ...
    <div class="box box-info">
      ...
      <div class="panel panel-default">
        <div class="panel-heading text-center" style="background-color: lightpink;"><strong>Qc Stock View List</strong></div>
        <div class="demo">
          <div class="panel-body">
              ...
              <tr>
               ...
               <?php 
                  $get_list="SELECT * FROM `rhc_master_chall_state` ";
                  $sql_exe_list=mysqli_query($conn,$get_list);
                  while ($res=mysqli_fetch_assoc($sql_exe_list)) {
                  ?>
                  
                  <tr>
                  <th><a href="admin_stock_entry_view_detail1.php?qc_challan=<?=$res['challan_no']?>"><?=$res['challan_no']?></a></th>
                  <th><?=$res['date']?></th>
                  <th><?=$res['time']?></th>

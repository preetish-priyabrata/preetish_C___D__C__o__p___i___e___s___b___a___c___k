...
?>
  ...
  <div class="content-wrapper">
    ...
    <li class="active"><a data-toggle="pill" href="#home">  List Of Approved Documents </a></li>
      ...
      <div class="container">
        ...
        <div class="table-responsive col-lg-11">
          <table id="" class="table table-bordered table-striped text-center">
            ...
            <?php
            $x=0;
            $query = "SELECT * FROM `user_sharing_Info` where `admin_status`='4' or `admin_status`='1'";
            ...
            ?>
              ...
              <tr>
                ...
                <td><a href="admin_approved_text_pdf_url_list_view.php?sl_no=<?php echo $rec['sl_no'] ;?>" class="label label-success">view</a></td>
              </tr> 

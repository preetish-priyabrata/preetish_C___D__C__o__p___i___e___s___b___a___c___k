  ...
  <div class="content-wrapper">
    ...
    <div class="col-lg-8">
      <div class="panel panel-default">
        <div class="panel-heading"><h4><b>Photo</b></h4></div>
...
<!-- <div id="container">
            ...
            <br>
            <form class="form-horizontal" action="alumni_photo_file_save.php" method="POST" enctype="multipart/form-data">
              ...
              <br>
              <br>
              <span style="color: red"><small>* only jpg/jpeg file</small></span>
              <br>
              <br>
              <div class="row">
                <div class="col-md-12">

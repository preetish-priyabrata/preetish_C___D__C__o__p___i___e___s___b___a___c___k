  ...
  if(!empty($_FILES['img']['name'])){
    ...
    if(move_uploaded_file($_FILES['img']['tmp_name'],"$dest".$file_name)){
      ...
      $last_id=mysqli_insert_id($conn);
       $query_student1="INSERT INTO `user_sharing_info_details`(`sl_no`, `user_id`, `title`, `sharing_info_id`, `photo`, `post_type`, `date`, `time_entry`) VALUES (NULL,'$email','$title','$last_id','$file_name','5','$date','$time')";
      ...
      exit();
         ...
         $msg->error('Please Upload Pdf Size Of 2mb File');
      header('Location:alumni_dashboard.php');
      exit();
    } 

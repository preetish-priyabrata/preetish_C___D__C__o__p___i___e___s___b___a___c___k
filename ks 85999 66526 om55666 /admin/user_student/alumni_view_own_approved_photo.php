      ...
      <div class="row">
            <div class="col-lg-12">
              <div class="panel panel-default">
                <div class="panel-heading"> 
                  <h4><b> List Of Photos Published </b></h4>
                   </div>
            ...
            ?>
                ...
                <td><?php echo $count;?></td>
                  ...
                  <td>
                <a href="alumni_view_own_approved_photo_view.php?sl_no=<?php echo $rec['sl_no'];?>" class="label label-primary" target="_blank">View</a></td> 

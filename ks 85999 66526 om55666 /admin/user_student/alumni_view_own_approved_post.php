...
<?php
  ...
  $query1 ="SELECT * FROM `user_sharing_info_details` where `status`='1' and `user_id`='$s_user_id' ORDER BY `sl_no` desc LIMIT $start_from, $results_per_page";
            ...
            case '3':
              ...
              <div class="row">
                  ...
                  <div class="col-md-10">
                    <div class="panel panel-default">
                      <div class="panel-heading text-center"><?php echo $fetch['title'];?></div>
                      <div class="panel-body"><?php echo $fetch['url'];?>
                      <p></p>
                      </div>
                    </div>
                  </div>  
...
for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
  ?>
  <li <?php if ($i==$page){ ?> class="active" <?php } ?>><a href='alumni_view_own_approved_post.php?page=<?=$i?>'><?=$i?></a></li>
 <?php           
}
?>
</ul>

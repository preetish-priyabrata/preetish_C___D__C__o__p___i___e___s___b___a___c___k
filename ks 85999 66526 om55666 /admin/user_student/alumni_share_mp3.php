  ...
  <div class="content-wrapper">
    ...
    <div class="col-lg-8">
      <div class="panel panel-default">
        <div class="panel-heading"><h4><b>Mp3 Sharing</b></h4></div>
...
<!-- <div id="container">
            ...
            <br>
            <form class="form-horizontal" action="alumni_sent_mp3.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="Photos">Audio File Only:</label>
                <div class="col-sm-10">

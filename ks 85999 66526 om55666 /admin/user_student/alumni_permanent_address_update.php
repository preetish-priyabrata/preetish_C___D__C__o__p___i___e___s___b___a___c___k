...
<div class="tab-content">
  <center><h3>Update Parmanent Address Details</h3></center>
      <form class="form-horizontal" id="myForm" action="alumni_permanent_address_update_save.php" method="POST" enctype="multipart/form-data">
         <?php
            $query = "SELECT * FROM `master_permanent_address_profile` where `user_id`='$student_id'";
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-10 col-md-8">
                <input type="text" class="form-control" name="district" id="district" value="<?php echo $rec['district'] ;?>"/>
                <br>
                <span id="myerror" style="color: red;"></span>
              </div>
            </div>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-10 col-md-8">
                <input type="text" class="form-control" name="land_ph_no" value="<?php echo $rec['land_ph_no'] ;?>"/>
                <br>
                <span id="myerror" style="color: red;"></span>
              </div>
            </div>

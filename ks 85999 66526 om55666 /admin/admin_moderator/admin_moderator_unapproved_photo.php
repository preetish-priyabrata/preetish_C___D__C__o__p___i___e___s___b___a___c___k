...
?>
  ...
  <div class="content-wrapper">
    ...
    <li class="active"><a data-toggle="pill" href="#home"> Unverified Photo Gallery List </a></li>
      ...
      <div class="container">
        ...
        <div class="table-responsive col-lg-11">
          <table id="" class="table table-bordered table-striped text-center">
            ...
            <?php
            $x=0;
            $query = "SELECT * FROM `user_gallery_upload` WHERE `operation_status`='1' and `moderator_status`='0'";

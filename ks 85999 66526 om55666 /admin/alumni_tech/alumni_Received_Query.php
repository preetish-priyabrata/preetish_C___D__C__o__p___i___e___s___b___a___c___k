      ...
      <div class="container">
        ...
        <div class="table-responsive col-lg-11">
          <table id="" class="table table-bordered table-striped text-center">
            ...
            $query = "SELECT * FROM `master_queries_student` where `status_answer`='0' and `assign_status`='0' order By `slno` desc";
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                  <?php if($status==0){?>
                    <a class="btn btn-primary btn-xs" href="view_replied_details_now.php?serial=<?=$rec['slno']?>">Assign User</a>

                    <a class="btn btn-primary btn-xs" href="admin_replied_query_details.php?serial=<?=$rec['slno']?>">Reply</a>
                    <?php 
                  }
                ?>
                </td>                      

...
$fdate = date("F", strtotime("2017-$monthPadding-01"));
 ...
 $get_hhi="SELECT * FROM `care_master_crop_diversification_crp_meo` WHERE `care_slno`='$care_hhi' ";
...
$hhi_fetch1=mysqli_fetch_assoc($sql_exe_get);
 ...
 $get_kictch_check="SELECT * FROM `care_master_crop_diversification_crp_meo` WHERE `care_type_farm`='$TYPE' and `care_form_type`='$type_insert' and `care_hhid`='$care_hhi_id' AND `care_CRP_month`='$months' AND `care_CRP_year`='$year' AND `care_crop_div_mt_id_status`='1' and `care_crop_div_CBO_comment_status`='1' and `care_crop_div_MEO_status`='1' and `care_slno`='$care_hhi'";
$sql_exe_get_check=mysqli_query($conn,$get_kictch_check);
$num_rows=mysqli_num_rows($sql_exe_get_check);
//  $num_rows;
// exit();
if($num_rows==0){
                ...
                <div class="tab-content">
                    ...
                    <table id='example11' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                           ...
                           $get_kictch1="SELECT * FROM `care_master_crop_diversification_crp_meo` WHERE `care_type_farm`='$TYPE' and `care_form_type`='$type_insert' and `care_slno`='$care_hhi' AND `care_CRP_month`='$months' AND `care_CRP_year`='$year' AND `care_crop_div_mt_id_status`='1' and `care_crop_div_CBO_comment_status`='1' and `care_crop_div_MEO_status`='1'";
                        ...
                        <tr>
                         ...
                         <?php if($res_fetch['care_new_farmer_status']==2){?>
                          ...
                          <td class="danger" style=" border: 5px solid red;">
                            ...
                            ?>
                           <?php if($res_fetch['care_demo_plot_farmer_edit']==1){echo "Yes";}?>
                           <?php if($res_fetch['care_demo_plot_farmer_edit']==2){echo "No";}?>
                          ...
                          <td class="danger" style=" border: 5px solid red;">
                            ...
                            ?>
                            <?php if($res_fetch['care_continued_farmer_edit']==1){echo "Yes";}?>
                            <?php if($res_fetch['care_continued_farmer_edit']==2){echo "No";}?>
                  ...
                  <div id="part2" class="tab-pane fade">
                   ...
                   <table id='example12' class="table table-hover" border="1">
                      ...
                      <tbody>
                         <?php
                          $get_kictch2="SELECT * FROM `care_master_crop_diversification_crp_meo` WHERE `care_type_farm`='$TYPE' and `care_form_type`='$type_insert' and `care_slno`='$care_hhi' AND `care_CRP_month`='$months' AND `care_CRP_year`='$year' AND `care_crop_div_mt_id_status`='1' and `care_crop_div_CBO_comment_status`='1' and `care_crop_div_MEO_status`='1'";
                  ...
                  <div id="part3" class="tab-pane fade">
                   ...
                   <table id='example13' class="table table-hover" border="1">
                      ...
                      <tbody>
                       <?php
                          $get_kictch3="SELECT * FROM `care_master_crop_diversification_crp_meo` WHERE `care_type_farm`='$TYPE' and `care_form_type`='$type_insert' and `care_slno`='$care_hhi' AND `care_CRP_month`='$months' AND `care_CRP_year`='$year' AND `care_crop_div_mt_id_status`='1' and `care_crop_div_CBO_comment_status`='1' and `care_crop_div_MEO_status`='1'";
                  ...
                  <div id="part4" class="tab-pane fade">
                    <div class="table-responsive">
                      <table id='example15' class="table table-hover" border="1">
                        ...
                        <tbody>
                          <?php
                            $get_kictch4="SELECT * FROM `care_master_crop_diversification_crp_meo` WHERE `care_type_farm`='$TYPE' and `care_form_type`='$type_insert' and `care_slno`='$care_hhi' AND `care_CRP_month`='$months' AND `care_CRP_year`='$year' AND `care_crop_div_mt_id_status`='1' and `care_crop_div_CBO_comment_status`='1' and `care_crop_div_MEO_status`='1'";

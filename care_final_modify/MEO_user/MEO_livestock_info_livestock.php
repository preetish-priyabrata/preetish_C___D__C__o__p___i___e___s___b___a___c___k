...
switch ($TYPE) {
 ...
 $get_detail="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE'  and `care_LS_vlg_name`='$village' AND `care_LS_month`='$months' AND `care_LS_year`='$year' and `care_LS_MEO_status`='0' and `care_LS_slno`='$care_hhi'";
  $sql_get_detail=mysqli_query($conn,$get_detail);
  $sql_get_detail_fetch=mysqli_fetch_assoc($sql_get_detail);
  $care_hhi_id_info=$sql_get_detail_fetch['care_LS_hhid'];

$get_hhi="SELECT * FROM `care_master_hhi_infomation` WHERE `care_hhi_id`='$care_hhi_id_info' ";
$sql_exe_get=mysqli_query($conn,$get_hhi);
$hhi_fetch=mysqli_fetch_assoc($sql_exe_get);
$get_life_stock1="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_slno`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year'";
?>
<style type="text/css">
            ...
            <div class="row">
             ...
             <?php }else{
                 ...
                 exit;
                  ...
                  <input type="hidden" name="care_hhi" value="<?=$care_hhi_id_info?>" id="user_browser_long2" required="true">
                ...
                <div class="tab-content">
                  <div id="part1" class="setup-content tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1" >
                      ...
                      <tbody>
                        <?php 
                        $get_life_stock1="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_slno`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year' and care_LS_mt_comment_status='1' and `care_LS_CBO_comment_status`='1' and `care_LS_MEO_status`='0' ";
                        ...
                        <tr>
                          <td>CRP Input</td>
                         <td><select disabled class="form-control " name="type_input_training" required="" style="width: 70px;">
                          ...
                          <!-- training -->
                          <td><select disabled class="form-control" name="get_id1"   required="">
                          ...
                          <td>
                            ...
                            <input disabled class="form-control input-sm" value="<?=$fetch_table1['care_LS_ES_no_of_animal']?>" type="number" placeholder="No of animals  received extension" name="get_id_no1" required="" min="0" value="0"></td>
                          <!-- no of extenston support -->
                          <td><select disabled class="form-control" name="get_id2" required=""  style="width: 70px";>
                          ...
                          <!-- medicine  -->
                          <td><input class="form-control input-sm" value="<?=$fetch_table1['care_LS_Med_no_of_animal']?>" disabled placeholder="No of animals  received medicine" type="number"  name="get_id_no2" required="" min="0" value="0"></td>
                          <!-- no of medice used -->
                          <td><select disabled class="form-control" name="get_id3"  required="">
                          ...
                          <!-- vaccination  -->
                          <td><input  class="form-control input-sm" value="<?=$fetch_table1['care_LS_VN_no_of_animal']?>" disabled placeholder="No of animals  received vaccination" type="number"  name="get_id_no3" required="" min="0" value="0"></td>
                          <td><select disabled="" class="form-control"  name="get_id4" required="">                            
                          ...
                          <input class="form-control input-sm" value="<?=$fetch_table1['care_LS_IP_others_specify']?>" disabled type="text"  placeholder="Others(specifiy)" name="get_id_no4" required="">
                          <?php }?>
                        </td>
                        <td>
                          <!-- other -->
                           <?php if($fetch_table1['care_LS_IP_others']==1){?>
                          <input class="form-control input-sm" value="<?=$fetch_table1['care_LS_other_no_of_animal']?>" disabled min="0" value="0" type="number"  name="get_id_no5" placeholder="Others(specifiy) Quanty" required="">
                          <?php }?>
                        </td>
                         ...
                         <tr>
                           <td>MEO Input</td>
                         <td><select  class="form-control " name="care_LS_IP_training[]" required="" style="width: 70px;">
                            <option value="1"  <?php if($fetch_table1['care_LS_IP_training']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table1['care_LS_IP_training']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <!-- training -->
                          <td><select  class="form-control" name="care_LS_IP_extension_support[]" onchange="get_change(1)" id="get_id1" required="">
                            <option value="1"  <?php if($fetch_table1['care_LS_IP_extension_support']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table1['care_LS_IP_extension_support']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <!-- extension support -->
                          <td>
                            ...
                            <input  class="form-control input-sm" value="<?=$fetch_table1['care_LS_ES_no_of_animal']?>" type="number" placeholder="No of animals  received extension" id="get_id_no1" name="care_LS_ES_no_of_animal[]" required="" min="0" value="0"></td>
                          <!-- no of extenston support -->
                          <td><select  class="form-control" name="care_LS_IP_medicine[]" onchange="get_change(2)" id="get_id2" required=""  style="width: 70px";>
                             <option value="1"  <?php if($fetch_table1['care_LS_IP_medicine']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table1['care_LS_IP_medicine']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <!-- medicine  -->
                          <td><input class="form-control input-sm" value="<?=$fetch_table1['care_LS_Med_no_of_animal']?>"  placeholder="No of animals  received medicine" type="number" id="get_id_no2" name="care_LS_Med_no_of_animal[]" required="" min="0" value="0"></td>
                          <!-- no of medice used -->
                          <td><select  class="form-control" name="care_LS_IP_vaccination[]"   onchange="get_change(3)" id="get_id3" required="">
                             <option value="1"  <?php if($fetch_table1['care_LS_IP_vaccination']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table1['care_LS_IP_vaccination']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <!-- vaccination  -->
                          <td><input  class="form-control input-sm" value="<?=$fetch_table1['care_LS_VN_no_of_animal']?>"  placeholder="No of animals  received vaccination" type="number" id="get_id_no3" name="care_LS_VN_no_of_animal[]" required="" min="0" value="0"></td>
                          <td><select class="form-control"  onchange="get_change(4)" id="get_id4" name="care_LS_IP_others[]" required="">                            
                             <option value="1"  <?php if($fetch_table1['care_LS_IP_others']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table1['care_LS_IP_others']==2){echo "selected";}?>>No</option>
                          </select>
                          <br>
                          <?php if($fetch_table1['care_LS_IP_others']==1){?>
                          <input class="form-control input-sm" value="<?=$fetch_table1['care_LS_IP_others_specify']?>"  type="text" id="care_LS_IP_others_specify[]" placeholder="Others(specifiy)" name="get_id_no4[]" required="">
                          <?php }else{
                            ?>
                             <input class="form-control input-sm" value="<?=$fetch_table1['care_LS_IP_others_specify']?>"  type="hidden" id="care_LS_IP_others_specify" placeholder="Others(specifiy)" name="care_LS_IP_others_specify[]" required="">
                            <?php 
                          }?>
                        </td>
                        <td>
                          <!-- other -->
                           <?php if($fetch_table1['care_LS_IP_others']==1){?>
                          <input class="form-control input-sm" value="<?=$fetch_table1['care_LS_other_no_of_animal']?>"  min="0" value="0" type="number" id="get_id_no5" name="get_id_no5[]" placeholder="Others(specifiy) Quanty" required="">
                          <?php }else{
                            ?>
                            <input class="form-control input-sm" value="<?=$fetch_table1['care_LS_other_no_of_animal']?>"  min="0" value="0" type="hidden" id="care_LS_other_no_of_animal" name="care_LS_other_no_of_animal[]" placeholder="Others(specifiy) Quanty" required="">
                            <?php }?>
                        </td>
                  ...
                  <div id="part2" class="tab-pane fade">
                     <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                           $get_life_stoc="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_slno`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year' and care_LS_mt_comment_status='1' and `care_LS_CBO_comment_status`='1' and `care_LS_MEO_status`='0'";
                        ...
                        <td>
                          <label for="Total_animal"></label>
                          <input class="form-control"  value="<?=$fetch_table2['care_LS_total_animal']?>"  type="number" name="care_LS_total_animal[]" required=""></td>
                         <td><select  class="form-control" name="care_LS_cultivating_fodder[]" required="">
                          <option value="1"  <?php if($fetch_table2['care_LS_cultivating_fodder']==1){echo "selected";}?>>Yes</option>
                          <option value="2" <?php if($fetch_table2['care_LS_cultivating_fodder']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <td><input class="form-control"  value="<?=$fetch_table2['care_LS_cultivated_area']?>"  type="text" name="care_LS_cultivated_area[]" id="cultivated_area" required=""></td>
                          <td><select  class="form-control" name="care_LS_new_farmer[]" onchange="farm_duct()" id="Farmers_new" required="">
                             <option value="1"  <?php if($fetch_table2['care_LS_new_farmer']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table2['care_LS_new_farmer']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <td><select  class="form-control" name="care_LS_continued_farmer[]" onchange="farm_duct_cont()"  id="farmers_cont" required="">
                             <option value="1"  <?php if($fetch_table2['care_LS_continued_farmer']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table2['care_LS_continued_farmer']==2){echo "selected";}?>>No</option>
                          </select></td>                  
                        </tr>
                  ...
                  <div id="part3" class="tab-pane fade">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                        $get_life_stock3="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_slno`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year' and care_LS_mt_comment_status='1' and `care_LS_CBO_comment_status`='1' and `care_LS_MEO_status`='0'";
                         $sql_phl_table3=mysqli_query($conn,$get_life_stock3);
                          $x_id=0;
                          while ($fetch_table3=mysqli_fetch_assoc($sql_phl_table3)) { ?>
                        <tr>
                          <td><input class="form-control" value="<?=$fetch_table3['care_LS_QP_extension_support']?>" disabled type="text" name="Extension_qnty" required=""></td>
                          <td>
                                  ...
                                  <?php 
                                   ...
                                   while ($fetch_med2=mysqli_fetch_assoc($sql_med_table2)) {?>
                                    <tr>
                                        ...
                                        <td class="col-sm-4">
                                            <input type="mail" name="Vaccination_qnty[]" value="<?=$fetch_med2['care_QP_quantity']?>" disabled id="Vaccination_qnty"  class="form-control"/>
                                        </td>                                        
                         ...
                         <tr>
                          <td><input class="form-control" value="<?=$fetch_table3['care_LS_QP_extension_support']?>"  type="text" name="care_LS_QP_extension_support[]" required=""></td>
                          <td>
                               <table id="myTable" class=" table order-list-Medicine">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                  ...
                                  $get_med1="SELECT * FROM `care_master_livestock_quantity_provided` WHERE `care_QP_livestock_slno`='$care_LS_slno' and`care_QP_type`='1'";
                                   ...
                                   while ($fetch_med1=mysqli_fetch_assoc($sql_med_table1)) {?>
                                    <tr>
                                      <input type="hidden" name="care_QP_slno[]" value="<?=$fetch_med1['care_QP_slno']?>">
                                       <input type="hidden" name="care_QP_type[]" value="<?=$fetch_med1['care_QP_type']?>">
                                        <td class="col-sm-4">
                                            <input  type="text" value="<?=$fetch_med1['care_QP_item_name']?>" name="care_QP_item_name[]" id="Medicine_name" class="form-control" />
                                        </td>
                                        <td class="col-sm-4">
                                            <input  type="mail" value="<?=$fetch_med1['care_QP_quantity']?>" name="care_QP_quantity[]" id="Medicine_qnty"  class="form-control"/>
                                        </td>                                        
                            ...
                            <table id="myTable" class=" table order-list-Vaccination">
                                ...
                                <tbody>
                                  <?php 
                                   ...
                                   while ($fetch_med2=mysqli_fetch_assoc($sql_med_table2)) {?>
                                    <tr>
                                      <input type="hidden" name="care_QP_slno[]" value="<?=$fetch_med2['care_QP_slno']?>">
                                       <input type="hidden" name="care_QP_type[]" value="<?=$fetch_med2['care_QP_type']?>">
                                        <td class="col-sm-4">
                                            <input type="text" name="care_QP_item_name[]" value="<?=$fetch_med2['care_QP_item_name']?>" id="Vaccination_name" class="form-control" />
                                        </td>
                                        <td class="col-sm-4">
                                            <input type="mail" name="care_QP_quantity[]" value="<?=$fetch_med2['care_QP_quantity']?>" id="Vaccination_qnty"  class="form-control"/>
                                        </td>                                        
                            ...
                            <table id="myTable" class=" table order-list-Others">
                                ...
                                <tbody>
                                  <?php 
                                   ...
                                   while ($fetch_med3=mysqli_fetch_assoc($sql_med_table3)) {?>
                                    <tr>
                                      <input type="hidden" name="care_QP_slno[]" value="<?=$fetch_med3['care_QP_slno']?>">
                                       <input type="hidden" name="care_QP_type[]" value="<?=$fetch_med3['care_QP_type']?>">
                                        <td class="col-sm-4">
                                            <input type="text" name="care_QP_item_name[]" value="<?=$fetch_med3['care_QP_item_name']?>"  id="Others_name" class="form-control" />
                                        </td>

                                        <td class="col-sm-4">
                                            <input type="mail" value="<?=$fetch_med3['care_QP_quantity']?>"   name="care_QP_quantity[]" id="Others_qnty"  class="form-control"/>
                                        </td>                                        
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    // $('#care_LS_cultivating_fodder').prop('readonly', true);       
      $('select[name^=care_LS_cultivating_fodder]').change(function(e){
        
        if ($('select[name^=care_LS_cultivating_fodder]').val() == '1'){

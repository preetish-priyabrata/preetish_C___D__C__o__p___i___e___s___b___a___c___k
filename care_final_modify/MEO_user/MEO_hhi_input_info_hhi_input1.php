...
if($_SESSION['meo_user']){
 ...
 $slno=web_decryptIt(str_replace(" ", "+",$_GET['ID']));
...
$fdate = date("F", strtotime("2017-$monthPadding-01"));
  ...
  $get_detail="SELECT * FROM `care_master_input_output_tracking_tarina_meo` WHERE
          `care_TARINA_vlg_name`='$village' AND `care_TARINA_month`='$months' AND `care_TARINA_year`='$year' and `care_IP_OP_MEO_status`='1' and `care_TARINA_slno`='$slno'";
  $sql_get_detail=mysqli_query($conn,$get_detail);
   $num=mysqli_num_rows($sql_get_detail);
        if($num==0){
 ...
 $care_hhi=$sql_get_detail_fetch['care_TARINA_hhi'];
                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    ...
                    <table id='example11' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                        $get_detail_fill1="SELECT * FROM `care_master_input_output_tracking_tarina_meo` WHERE `care_TARINA_month`='$months' and `care_TARINA_year`='$year' and `care_TARINA_vlg_name`='$village' and`care_TARINA_hhi`='$care_hhi' and `care_IP_OP_mt_status`='1' and `care_IP_OP_MEO_status`='1' and `care_IP_OP_CBO_comment_status`='1' and `care_TARINA_slno`='$slno'";
                 ...
                 <table id='example12' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                        $get_detail_fill2="SELECT * FROM `care_master_input_output_tracking_tarina_meo` WHERE `care_TARINA_month`='$months' and `care_TARINA_year`='$year' and `care_TARINA_vlg_name`='$village' and`care_TARINA_hhi`='$care_hhi' and `care_IP_OP_mt_status`='1' and `care_IP_OP_MEO_status`='1' and `care_IP_OP_CBO_comment_status`='1' and `care_TARINA_slno`='$slno'";

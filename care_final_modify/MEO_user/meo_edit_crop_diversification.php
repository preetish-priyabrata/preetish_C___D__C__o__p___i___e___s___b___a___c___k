  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Crop Diversification</a></li>
        <li class="active"><a href="#">Edit Crop Diversification</a></li>
    ...
    <section class="content">
      ...
      <?php
        ...
        if(!empty($village)){
          // 
          // 
           $get_detail="SELECT * FROM `care_master_crop_diversification_crp` WHERE `care_type_farm`='1' and `care_form_type`='1' and `care_CRP_vlg_name`='$village' AND `care_CRP_month`='$months' AND `care_CRP_year`='$Year' and `care_crop_div_MEO_status`='0'";
                    ...
                    <tfoot>
                     ...
                     <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <?php 
                            if ($sql_get_detail_fetch['care_crop_div_CBO_comment_status']==0) {
                        ...
                        <td>
                          <?php 
                          if (($sql_get_detail_fetch['care_crop_div_CBO_comment_status']==1) && ($sql_get_detail_fetch['care_crop_div_mt_id_status']==1)) {
                            ?>
                               <a class="btn btn-primary btn-xs" href="MEO_go_form_go.php?form_type=<?=web_encryptIt('ilab')?>&form_id=<?=web_encryptIt('1')?>&care_hhi=<?=web_encryptIt($sql_get_detail_fetch['care_slno'])?>&target=<?=web_encryptIt($months)?>&year=<?=web_encryptIt($Year)?>&village=<?=web_encryptIt($village)?>&form_uses=1" ><u>Edit</u></a>
                            <?php
                          }else{
                            echo "--";

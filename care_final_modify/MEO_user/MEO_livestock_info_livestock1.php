...
if($_SESSION['meo_user']){
 ...
 $get_detail="SELECT * FROM `care_master_mtf_livestock_tarina_meo` WHERE `livestock`='$TYPE' and `care_LS_vlg_name`='$village' AND `care_LS_month`='$months' AND `care_LS_year`='$year' and `care_LS_MEO_status`='1' and `care_LS_slno`='$id'  and care_LS_mt_comment_status='1' and `care_LS_CBO_comment_status`='1' and `care_LS_MEO_status`='1'";
  $sql_get_detail=mysqli_query($conn,$get_detail);
  $num_rows=mysqli_num_rows($sql_get_detail);
if($num_rows==0){
   $msg->error('No Information Is found For This Month');          
   header('Location:index.php');
    exit;

}
  $sql_get_detail_fetch=mysqli_fetch_assoc($sql_get_detail);
  $care_hhi=$sql_get_detail_fetch['care_LS_hhid'];
...
$get_life_stock1="SELECT * FROM `care_master_mtf_livestock_tarina_meo` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_slno`='$id' and`care_LS_month`='$months' and `care_LS_year`='$year'";
                ...
                <div class="tab-content">
                  <div id="part1" class="setup-content tab-pane fade in active">
                    ...
                    <table id='example11' class="table table-hover" border="1" >
                      ...
                      <tbody>
                        <?php 
                         $get_life_stock1="SELECT * FROM `care_master_mtf_livestock_tarina_meo` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_slno`='$id' and`care_LS_month`='$months' and `care_LS_year`='$year' and care_LS_mt_comment_status='1' and `care_LS_CBO_comment_status`='1' and `care_LS_MEO_status`='1'";
                  ...
                  <div id="part2" class="tab-pane fade">
                    <div class="table-responsive">
                     <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                           $get_life_stoc="SELECT * FROM `care_master_mtf_livestock_tarina_meo` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_slno`='$id' and`care_LS_month`='$months' and `care_LS_year`='$year' and care_LS_mt_comment_status='1' and `care_LS_CBO_comment_status`='1' and `care_LS_MEO_status`='1'";
                  ...
                  <div id="part3" class="tab-pane fade">
                    ...
                    <table id='example13' class="table table-hover" border="1">
                      ...
                      <tbody>
                        ...
                        $get_life_stock3="SELECT * FROM `care_master_mtf_livestock_tarina_meo` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_slno`='$id' and`care_LS_month`='$months' and `care_LS_year`='$year' and care_LS_mt_comment_status='1' and `care_LS_CBO_comment_status`='1' and `care_LS_MEO_status`='1'";
                        ...
                        <tr>
                            ...
                            <table id="myTable" class=" table order-list-Medicine">
                              <thead>
                                ...
                                <tbody>                                  
                                  ...
                                  $get_med1="SELECT * FROM `care_master_livestock_quantity_provided_meo` WHERE `care_QP_livestock_slno`='$care_LS_slno' and`care_QP_type`='1' and `care_QP_status`='1'";
                          ...
                          <td>
                            <table id="myTable" class=" table order-list-Vaccination">
                                ...
                                <tbody>
                                  <?php 
                                   $get_med2="SELECT * FROM `care_master_livestock_quantity_provided_meo` WHERE `care_QP_livestock_slno`='$care_LS_slno' and`care_QP_type`='2' and `care_QP_status`='1'";
                          ...
                          <td>
                            <table id="myTable" class=" table order-list-Others">
                                ...
                                <tbody>
                                  <?php 
                                   $get_med3="SELECT * FROM `care_master_livestock_quantity_provided_meo` WHERE `care_QP_livestock_slno`='$care_LS_slno' and`care_QP_type`='3' and `care_QP_status`='1'";
                         ...
                         <tr>
                          ...
                          <td>
                               <table id="myTable" class=" table order-list-Medicine">
                                ...
                                <tbody>
                                  ...
                                  $get_med12="SELECT * FROM `care_master_livestock_quantity_provided_meo` WHERE `care_QP_livestock_slno`='$care_LS_slno' and`care_QP_type`='1'  and `care_QP_status`='1'";
                          ...
                          <td>
                            <table id="myTable" class=" table order-list-Vaccination">
                                ...
                                <tbody>
                                  <?php 
                                   $get_med21="SELECT * FROM `care_master_livestock_quantity_provided_meo` WHERE `care_QP_livestock_slno`='$care_LS_slno' and`care_QP_type`='2' and `care_QP_status`='1'";
                          ...
                          <td>
                            <table id="myTable" class=" table order-list-Others">
                                ...
                                <tbody>
                                  <?php 
                                   $get_med31="SELECT * FROM `care_master_livestock_quantity_provided_meo` WHERE `care_QP_livestock_slno`='$care_LS_slno' and`care_QP_type`='3' and `care_QP_status`='1' ";

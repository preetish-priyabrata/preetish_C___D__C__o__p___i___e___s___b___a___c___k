...
$get_kictch_check="SELECT * FROM `care_master_crop_diversification_crp_meo` WHERE `care_type_farm`='$TYPE' and `care_form_type`='$type_insert' and `care_hhid`='$care_hhi' AND `care_CRP_month`='$months' AND `care_CRP_year`='$year' AND `care_crop_div_mt_id_status`='1' and `care_crop_div_CBO_comment_status`='1' and `care_crop_div_MEO_status`='1'";
$sql_exe_get_check=mysqli_query($conn,$get_hhi);
                        ...
                        <tr>
                         ...
                         <td> <?=$res_fetch['care_CRP_date']?></td>
                          ...
                          <td>
                            ...
                            ?>
                            <?php 
                              $care_pulses_type_edit=json_decode($res_fetch['care_pulses_type_edit']);
                              for ($i=0; $i <count($care_pulses_type_edit) ; $i++) { 
                                echo $care_pulses_type_edit[$i]."<br>";
                              }

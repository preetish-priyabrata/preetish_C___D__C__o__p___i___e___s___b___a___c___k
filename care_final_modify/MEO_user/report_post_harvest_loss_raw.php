  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php
        ...
        if(!empty($village)){
           $get_detail="SELECT * FROM `care_master_hhi_month_year` WHERE `care_crp_id`='$employee_id' and`care_village_name`='$village' and `care_month`='$months' and `care_year`='$Year' and `care_form2`!=''";

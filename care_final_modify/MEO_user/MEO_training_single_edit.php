                  ...
                  <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?=$res1['care_EV_date']?></td>
                          <td><select class="form-control" name="care_EV_them_intervention[]" readonly required="">
                          ...
                          <td><input class="form-control" type="text" readonly value="<?=$res1['care_EV_topics_covered']?>" name="care_EV_topics_covered[]" required=""></td>
                        ...
                        <td>
                         ...
                         <tr>
                          ...
                          <td>
                           ...
                           <td>
                            <input type="text" readonly="" class="form-control"  value="<?=$res3['care_EV_remarks']?>" name="care_EV_remarks[]" required="">
                          </td>
                           <td>
                           <?php 
                            if($res3['care_EV_mt_comment_status']=='0'){
                              ...
                              <textarea readonly="" name="care_EV_mt_comment_empty[]"  type="text" class="form-control" ><?=$res3['care_EV_mt_comment_empty']?></textarea>

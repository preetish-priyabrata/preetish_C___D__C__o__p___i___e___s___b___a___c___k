      ...
      <?php
       if(isset($_POST['form_type'])){
        ...
        if(!empty($village)){
          ...
          $form1_query="SELECT * FROM `care_master_input_output_tracking_tarina` WHERE `care_TARINA_year`='$Year' and `care_TARINA_month`='$months'and`care_TARINA_vlg_name`='$village' and`care_TARINA_employee_id`='$employee_id' ";
           $sql_form1_query=mysqli_query($conn,$form1_query);
          $form1=mysqli_num_rows($sql_form1_query);

           $form2_query="SELECT * FROM `care_master_post_harvest_loss` WHERE `care_PHL_year`='$Year' and `care_PHL_month`='$months' and `care_PHL_villege_name`='$village' and`care_PHL_employee_id`='$employee_id' ";
          $sql_form2_query=mysqli_query($conn,$form2_query);
          $form2=mysqli_num_rows($sql_form2_query);

          echo $form3_query="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `care_LS_vlg_name`='$village' and `care_LS_employee_id`='$employee_id'and`care_LS_month`='$months' and `care_LS_year`='$Year' and `livestock`='2'";
          $sql_form3_query=mysqli_query($conn,$form3_query);
          $form3=mysqli_num_rows($sql_form3_query);

          $form4_query="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `care_LS_vlg_name`='$village' and `care_LS_employee_id`=''and`care_LS_month`='' and `care_LS_year`='$Year' and `livestock`='2'";
          $sql_form4_query=mysqli_query($conn,$form4_query);
          $form4=mysqli_num_rows($sql_form4_query);

          $form5_query="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `care_LS_vlg_name`='$village' and `care_LS_employee_id`='$employee_id'and`care_LS_month`='$months' and `care_LS_year`='$Year' and `livestock`='3'";
          $sql_form5_query=mysqli_query($conn,$form5_query);
          $form5=mysqli_num_rows($sql_form5_query);
          

           $form6_query="SELECT * FROM `care_master_mtf_labour_saving_tech_tarina` WHERE `care_MTF_employee_id`='$employee_id' and `care_MTF_month`='$months' and `care_MTF_year`='$Year' and `care_MTF_vlg_name`='$village'";
          $sql_form6_query=mysqli_query($conn,$form6_query);
          $form6=mysqli_num_rows($sql_form6_query);

          $form7_query="SELECT * FROM `care_master_crop_diversification_crp` WHERE `care_CRP_vlg_name`='$village' and `care_CRP_month`='$months' and `care_CRP_year`='$Year' and`care_CRP_employee_id`='$employee_id' and `care_form_type`='1'";
          $sql_form7_query=mysqli_query($conn,$form7_query);
          $form7=mysqli_num_rows($sql_form7_query);

          $form8_query="SELECT * FROM `care_master_crop_diversification_crp` WHERE `care_CRP_vlg_name`='$village' and `care_CRP_month`='$months' and `care_CRP_year`='$Year' and`care_CRP_employee_id`='$employee_id' and `care_form_type`='2'";
          $sql_form8_query=mysqli_query($conn,$form8_query);
          $form8=mysqli_num_rows($sql_form8_query);

       
          
          $form9_query="SELECT * FROM `care_master_mrf_exposure_visit_tarina` WHERE `care_EV_vlg_name`='$village' and`care_EV_month`='$months' and `care_EV_year`='$Year'and`care_EV_employee_id`='$employee_id' ";
          $sql_form9_query=mysqli_query($conn,$form9_query);
          $form9=mysqli_num_rows($sql_form1_query);


          $form10_query="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village'and`care_SHG_month`='$months' and`care_SHG_year`='$Year' and`care_SHG_employee_id`='$employee_id' ";

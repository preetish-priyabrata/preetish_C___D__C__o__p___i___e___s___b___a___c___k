...
if($_POST['form_type']){
  ...
  if($form_type=='get_hhi_infomation'){
    ...
    $get_training_check="SELECT * FROM `care_master_mrf_exposure_visit_tarina` WHERE `care_EV_vlg_name`='$village' and `care_EV_month`='$months' and `care_EV_year` ='$Year' and `care_EV_employee_id`='$employee_id' AND `care_EV_mt_comment_status`='1' ";
    $sql_exe_get_detail_query_no=mysqli_query($conn,$get_training_check);
        $num=mysqli_num_rows($sql_exe_get_detail_query_no);
       
        if($num==0){
          $msg->error('No Comment Information Is found For This Month');
          header('Location:index.php');
          exit;
        }
         $get_training_check="SELECT * FROM `care_master_mrf_exposure_visit_tarina` WHERE `care_EV_vlg_name`='$village' and `care_EV_month`='$months' and `care_EV_year` ='$Year' and `care_EV_employee_id`='$employee_id' and `care_EV_mt_comment_status`='1' and `care_EV_CBO_comment_status`='0' ";
        $check_exe=mysqli_query($conn,$get_training_check);
        $num_check=mysqli_num_rows($check_exe);
                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php 
                         $get_training="SELECT * FROM `care_master_mrf_exposure_visit_tarina` WHERE `care_EV_vlg_name`='$village' and `care_EV_month`='$months' and `care_EV_year` ='$Year' and `care_EV_employee_id`='$employee_id' and `care_EV_mt_comment_status`='1'";
                  ...
                  <div id="part2" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                         <?php $get_training1="SELECT * FROM `care_master_mrf_exposure_visit_tarina` WHERE `care_EV_vlg_name`='$village' and `care_EV_month`='$months' and `care_EV_year` ='$Year' and `care_EV_employee_id`='$employee_id' AND `care_EV_mt_comment_status`='1' ";
                  ...
                  <div id="part3" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                         <?php $get_training2="SELECT * FROM `care_master_mrf_exposure_visit_tarina` WHERE `care_EV_vlg_name`='$village' and `care_EV_month`='$months' and `care_EV_year` ='$Year' and `care_EV_employee_id`='$employee_id' AND `care_EV_mt_comment_status`='1' ";
                        ...
                        <td>
                           <?php 
                            if($res3['care_EV_CBO_comment_status']==0){?>
                             <input  value="<?=web_encryptIt($res3['care_EV_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea  value="" type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required="true"><?=$res3['care_EV_CBO_comment_empty']?></textarea>
                              <span id="error<?=$x_id?>" style="color: red"></span>
                            <?php }else{?>
                              <input  value="<?=web_encryptIt($res3['care_EV_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea  type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" readonly="" required=""><?=$res3['care_EV_CBO_comment_empty']?></textarea>

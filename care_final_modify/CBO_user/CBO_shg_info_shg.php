...
if(isset($_POST['form_type'])){
  ...
  if($form_type=='get_hhi_infomation'){
    ...
    $employee_id=$_POST['employee_id'];
      ...
      $get_detail_query_no="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' ";
        $sql_exe_get_detail_query_no=mysqli_query($conn,$get_detail_query_no);
        $num=mysqli_num_rows($sql_exe_get_detail_query_no);
        if($num==0){
          $msg->error('No Information Found For This Month');
          header('Location:index.php');
          exit;
        }
        
        $get_detail_query_no_check="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1' and `care_SHG_CBO_comment_status`='0' ";
        $sql_exe_get_detail_query_no_check=mysqli_query($conn,$get_detail_query_no_check);
        $num_check=mysqli_num_rows($sql_exe_get_detail_query_no_check);
                ...
                <div class="tab-content">
                  <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php 
                         $get_detail_query="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='1'";

...
if($_SESSION['employee_id']){
 ...
 // $care_hhi=web_decryptIt(str_replace(" ", "+",$_GET['ID']));
  $care_LS_slno=web_decryptIt(str_replace(" ", "+",$_GET['care_LS_slno']));
...
$get_life_stock3="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_slno`='$care_LS_slno'";
                      ...
                      <tbody>
                        ...
                        <tr>
                         <td><select disabled class="form-control " name="type_input_training" required="" style="width: 70px;">
                            <option value="1"  <?php if($fetch_table3['care_LS_IP_training']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table3['care_LS_IP_training']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <!-- training -->
                          <td><select disabled class="form-control" name="get_id1" onchange="get_change(1)" id="get_id1" required="">
                            <option value="1"  <?php if($fetch_table3['care_LS_IP_extension_support']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table3['care_LS_IP_extension_support']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <!-- extension support -->
                          <td>

                            <input disabled class="form-control input-sm" value="<?=$fetch_table3['care_LS_ES_no_of_animal']?>" type="number" placeholder="No of animals  received extension" id="get_id_no1" name="get_id_no1" required="" min="0" value="0"></td>
                          <!-- no of extenston support -->
                          <td><select disabled class="form-control" name="get_id2" onchange="get_change(2)" id="get_id2" required=""  style="width: 70px";>
                             <option value="1"  <?php if($fetch_table3['care_LS_IP_medicine']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table3['care_LS_IP_medicine']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <!-- medicine  -->
                          <td><input class="form-control input-sm" value="<?=$fetch_table3['care_LS_Med_no_of_animal']?>" disabled placeholder="No of animals  received medicine" type="number" id="get_id_no2" name="get_id_no2" required="" min="0" value="0"></td>
                          <!-- no of medice used -->
                          <td><select disabled class="form-control" name="get_id3"   onchange="get_change(3)" id="get_id3" required="">
                             <option value="1"  <?php if($fetch_table3['care_LS_IP_vaccination']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table3['care_LS_IP_vaccination']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <!-- vaccination  -->
                          <td><input  class="form-control input-sm" value="<?=$fetch_table3['care_LS_VN_no_of_animal']?>" disabled placeholder="No of animals  received vaccination" type="number" id="get_id_no3" name="get_id_no3" required="" min="0" value="0"></td>
                          <td><select class="form-control"  onchange="get_change(4)" id="get_id4" name="get_id4" required="">                            
                             <option value="1"  <?php if($fetch_table3['care_LS_IP_others']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table3['care_LS_IP_others']==2){echo "selected";}?>>No</option>
                          </select>
                          <br>
                          <?php if($fetch_table3['care_LS_IP_others']==1){?>
                          <input class="form-control input-sm" value="<?=$fetch_table3['care_LS_IP_others_specify']?>" disabled type="text" id="get_id_no4" placeholder="Others(specifiy)" name="get_id_no4" required="">
                          <?php }?>
                        </td>
                        <td>
                          <!-- other -->
                           <?php if($fetch_table3['care_LS_IP_others']==1){?>
                          <input class="form-control input-sm" value="<?=$fetch_table3['care_LS_other_no_of_animal']?>" disabled min="0" value="0" type="number" id="get_id_no5" name="get_id_no5" placeholder="Others(specifiy) Quanty" required="">
                          <?php }?>
                        </td>
                  ...
                  <div id="part2" class="tab-pane fade">
                     <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                          ...
                          <input class="form-control"  value="<?=$fetch_table3['care_LS_total_animal']?>" disabled type="number" name="Total_animal" required=""></td>
                         <td><select disabled class="form-control" name="Cultivating_fodder_status" required="">
                          <option value="1"  <?php if($fetch_table3['care_LS_cultivating_fodder']==1){echo "selected";}?>>Yes</option>
                          <option value="2" <?php if($fetch_table3['care_LS_cultivating_fodder']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <td><input class="form-control"  value="<?=$fetch_table3['care_LS_cultivated_area']?>" disabled type="text" name="cultivated_area" required=""></td>
                          <td><select disabled class="form-control" name="Farmers_new" required="">
                             <option value="1"  <?php if($fetch_table3['care_LS_new_farmer']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table3['care_LS_new_farmer']==2){echo "selected";}?>>No</option>
                          </select></td>
                          <td><select disabled class="form-control" name="farmers_cont" required="">
                             <option value="1"  <?php if($fetch_table3['care_LS_continued_farmer']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($fetch_table3['care_LS_continued_farmer']==2){echo "selected";}?>>No</option>
                          </select></td>                  
                        </tr>

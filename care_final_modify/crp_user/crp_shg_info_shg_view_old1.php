                        ...
                        <tr>
                           <td>
                            <select disabled class="form-control" name="Seed_qnty" required="">
                             <option value="1"  <?php if($res1['care_SHG_ML_linkage_external_credit']==1){echo "selected";}?>>Yes</option>
                            <option value="2" <?php if($res1['care_SHG_ML_linkage_external_credit']==2){echo "selected";}?>>No</option>
                          </select>
                          </td>
                          <td>

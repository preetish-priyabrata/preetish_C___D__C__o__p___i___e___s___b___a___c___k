          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="admin_view_userid.php"><i class="fa fa-circle-o"></i>Add & View Admin List</a></li>
              </ul>
            </li>
             <li class="treeview">
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-circle-o"></i> HHI User Info
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
               <ul class="treeview-menu">
                <li><a href="admin_user_hhi_village.php"><i class="fa fa-circle-o"></i>Add & View User Village List</a></li>
                <li><a href="admin_user_hhi.php"><i class="fa fa-circle-o"></i>Add & View User List</a></li>               
              </ul>
            </li>   
          </ul>
        </li>

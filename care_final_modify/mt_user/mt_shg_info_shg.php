...
if($_POST['form_type']){
  ...
  if($form_type=='get_hhi_infomation'){
    ...
    $employee_id=$_POST['employee_id'];
      ...
      $get_detail_query_check="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year' and `care_SHG_mt_comment_status`='0'";
      $sql_exe_deatils_check=mysqli_query($conn,$get_detail_query_check);
      $num_check=mysqli_num_rows($sql_exe_deatils_check);
                ...
                <div class="tab-content">
                  ...
                  <div id="part2" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                         <?php 
                        $get_detail_query1="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year'";
                  ...
                  <div id="part3" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                           <?php 
                        $get_detail_query3="SELECT * FROM `care_master_mrf_shg_tracking_under_tarina` WHERE `care_SHG_vlg_name`='$village' and `care_SHG_employee_id`='$employee_id' and `care_SHG_month`='$months' and `care_SHG_year`='$year'";
                ...
                <div id="part5" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>
                            <input disabled type="number" value="<?=$res4['care_SHG_no_of_mem_link_any_committee']?>" min="1" class="form-control" name="Consumption" required="">
                          </td>
                          <td>
                            <input disabled type="text" value="<?=$res4['care_SHG_committee_name']?>" class="form-control" name="Sale" required="">
                          </td>                          
                           <td>
                           ...
                           <td>
                            <textarea disabled class="form-control" name="shg_field_new2" required=""><?=$res4['shg_field_new2']?></textarea>
                          </td>
                          <td>
                           <?php 
                            if($res4['care_SHG_mt_comment_status']=='0'){?>
                             <input  value="<?=web_encryptIt($res4['care_SHG_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea  value="" type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required="true"><?=$res4['care_SHG_mt_comment_empty']?></textarea>
                              <span id="error<?=$x_id?>" style="color: red"></span>
                            <?php }else{?>
                              <input  value="<?=web_encryptIt($res4['care_SHG_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea readonly=""  type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required=""><?=$res4['care_SHG_mt_comment_empty']?></textarea>

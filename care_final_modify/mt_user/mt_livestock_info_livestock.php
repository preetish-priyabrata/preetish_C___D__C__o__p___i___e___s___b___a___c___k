...
$get_life_stock1="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year'";
?>
<style type="text/css">
                ...
                <div class="tab-content">
                      ...
                      <tbody>
                        ...
                        <tr>
                         <td><select disabled class="form-control " name="type_input_training" required="" style="width: 70px;">
                          ...
                          <!-- medicine  -->
                          <td><input class="form-control input-sm" value="<?=$fetch_table1['care_LS_Med_no_of_animal']?>" disabled placeholder="No of animals  received medicine" type="number" id="get_id_no2" name="get_id_no2" required="" min="0" value="0"></td>
                          <!-- no of medice used -->
                          ...
                          <td><select class="form-control" disabled="" onchange="get_change(4)" id="get_id4" name="get_id4" required="">                            
                  ...
                  <div id="part2" class="tab-pane fade">
                     <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                           $get_life_stoc="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year'";
                  ...
                  <div id="part3" class="tab-pane fade">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        <?php
                        $get_life_stock3="SELECT * FROM `care_master_mtf_livestock_tarina` WHERE `livestock`='$TYPE' and `care_LS_hhid`='$care_hhi' and `care_LS_month`='$months' and `care_LS_year`='$year'";
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            if($fetch_table3['care_LS_mt_comment_status']=='0'){?>
                             <input  value="<?=web_encryptIt($fetch_table3['care_LS_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea  value="" type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required="true"><?=$fetch_table3['care_LS_mt_comment_empty']?></textarea>
                              <span id="error<?=$x_id?>" style="color: red"></span>
                            <?php }else{?>
                              <input  value="<?=web_encryptIt($fetch_table3['care_LS_slno'])?>" type="hidden" class="form-control" name="form_type_id_div[]" required="">
                              <textarea readonly=""  type="text" class="form-control" name="comments_mt[<?=$x_id?>]" id="comments_mt<?=$x_id?>" required=""><?=$fetch_table3['care_LS_mt_comment_empty']?></textarea>

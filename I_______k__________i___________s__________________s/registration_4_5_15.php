          ...
          <div class="row">
    		<div class="col-lg-12">
              <div class="navbar navbar-default navbar-fixed-top">
        		<div class="container">
                  <div class="col-lg-4 text-center"> <a class="" href="studentStatus.html" target= "_blank"><img class="img-responsive img-thumbnail logo" src="Images/left.png"></a> 
                  </div>
...
<tr>
          ...
          <td>Class </td>
          <td>
          	<select class="form-control" name="standard" id = "standard" onchange="showTextBoxClass(this.id);showYear(this.value);">
              <option value="">-- Select One --</option>
              <option value="I">I</option>
              <option value="II">II</option>
              <option value="III">III</option>
...
<div role="tabpanel" class="well modal-content form-horizontal tab-pane fade" id="house">
    ...
    <tr>
              <td><b>118.</b></td>
              <td colspan="2"> Details of yourbrother / sister/ relatives studying in KISS</td>
            </tr>
    <tr>
              <td>&nbsp;</td>
              <td><b>Education</b></td>
...
<div role="tabpanel" class="well modal-content form-horizontal tab-pane fade" id="income">
    ...
    <table class="table">
        ...
        <td colspan="2" class="label240"><div class="col-lg-8">
            <label class="checkbox-inline" style="width:204px;margin-left: 10px;">
              <input type="checkbox" name="scheme[]" value="BPL"  class="form-control">
              BPL </label>
            <label class="checkbox-inline">
              <input type="checkbox" name="scheme[]" value="Antodaya Annapurna Yojana"  class="form-control">
              Antodaya Annapurna Yojana </label>
            <label class="checkbox-inline" style="width:204px">
              <input type="checkbox" name="scheme[]" value="IAY"  class="form-control">
              IAY </label>
            <label class="checkbox-inline">
              <input type="checkbox" name="scheme[]" value="KISSAN Credit Card"  class="form-control">
              KISSAN Credit Card </label>
            <label class="checkbox-inline" style="width:204px">
              <input type="checkbox" name="scheme[]" value="Health Card"  class="form-control">
              Health Card </label>
            <label class="checkbox-inline">
              <input type="checkbox" name="scheme[]" value="Green Card"  class="form-control">
              Green Card </label>
            <label class="checkbox-inline" style="width:204px">
              <input type="checkbox" name="scheme[]" value="Lal Card"  class="form-control">
              Lal Card </label>
            <label class="checkbox-inline">
        ...
        <td colspan="2" class="label240"><div class="col-lg-8">
            <label class="checkbox-inline" style="width:204px; margin-left:10px">
              <input type="checkbox" name="account[]" value="Bank Account"  class="form-control">
              Bank Account </label>
            <label class="checkbox-inline">
              <input type="checkbox" name="account[]" value="Debit/Credit Card"  class="form-control">
              Debit/Credit Card </label>
            <label class="checkbox-inline" style="width:204px">
              <input type="checkbox" name="account[]" value="Postal Savings"  class="form-control">
        ...
        <td colspan="2" class="label240"><div class="col-lg-8">
            <label class="checkbox-inline" style="width:204px; margin-left:10px">
              <input type="checkbox" name="identification[]" value="Voter Card"  class="form-control">
              Voter Card </label>
            <label class="checkbox-inline">
              <input type="checkbox" name="identification[]" value="Addhar Card"  class="form-control">
              Addhar Card </label>
            <label class="checkbox-inline" style="width:204px">
              <input type="checkbox" name="identification[]" value="Passport"  class="form-control">
              Passport </label>
            <label class="checkbox-inline">
        ...
        <td colspan="2" class="label240"><div class="col-lg-12">
            <label class="checkbox-inline" style="width:204px; margin-left:10px">
        ...
        <td colspan="2"><label class="checkbox-inline">
            ...
            Others </label></td>
        <td>
        <td><input type="text" class="form-control" name="" id="textarea_roadComm" style="display: none;margin-left: -1200%;width: 860%;">
                  </textarea></td>
          </td>
      </tr>
                </td>
        ...
        <td><textarea class="form-control" name=""></textarea></td>
              ...
              <tr>
        <td colspan="2" ><b>154.</b> <span>What are other facilities available in your village?</span></td>
      </tr>
              <tr>
        <td colspan="3"><table class="table table-bordered">
            <tr>
...
<div role="tabpanel" class="well modal-content form-horizontal tab-pane fade" id="sanitation">
    ...
    <table class="table">
        ...
        <td><label class="checkbox-inline" style="width:204px;margin-left:10px">
...
<tr>
          <td colspan="2"><table class="table">
              ...
              <td><input type="text" class="form-control" name="edu_infra" id="edu_infra"></td>
              <td class="col-lg-3"><input type="text" class="form-control" name="" id="textarea_edu" style="display: none;height:29px;width:190px;"></td>
            </tr>
              <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td><label class="checkbox-inline" style="margin-left:10px">
                  <input type="checkbox" name="education[]" value="Government"  class="form-control" onchange="showCheckedValue(this.value);">
                  Government </label>
                  <label class="checkbox-inline">
                  <input type="checkbox" name="education[]" value="Private"  class="form-control" onchange="showCheckedValue(this.value);">
                  Private </label>
                  <label class="checkbox-inline">
                  <input type="checkbox" name="education[]" value="NGO-run"  class="form-control" onchange="showCheckedValue(this.value);">
                  NGO-run </label>
                  ...
                  <input type="checkbox" name="other_education" value="others"  class="form-control"  id="edu" onchange="showTextarea(this.id);
                                                                            showTextBox(this.id);">
                  Other(Specify) </label></td>
              <td class="col-lg-3"><input type="text" class="form-control" name="" id="textarea_edu" style="display: none;height:32px;width:190px;"></td>
            </tr>
              <tr>
              <td><b>158.</b></td>
              <td><span> If drop-outs,ask the causes of drop-outs ( Record the multiple responses ) </span></td>
              <td><select name="dropouts" class="form-control" onchange="showDropouts(this.value);">
                  <option value="">--Select--</option>
                  <option value="Yes">Yes</option>
                  <option value="No">No</option>
                </select></td>
            </tr>
              <tr id="dropout_tr" style="display: none">
              <td>&nbsp;</td>
              <td colspan="2"><span name="dropout_row" id="dropout_row" style="display: none;margin-left: 102%;width: 150%;">
                <label class="checkbox-inline" style="margin-left:10px">
                <input type="checkbox" name="drop-out[]" value="1"  class="form-control">
                Children needed to work in order to sustain their livelihood </label>
                <label class="checkbox-inline">
                <input type="checkbox" name="drop-out[]" value="2"  class="form-control">
                Children had to look after siblings </label>
                <label class="checkbox-inline">
                <input type="checkbox" name="drop-out[]" value="3"  class="form-control">
                No job opportunities after education </label>
                <label class="checkbox-inline">
                <input type="checkbox" name="drop-out[]" value="4"  class="form-control">
                Primary school far away from the home </label>
                <label class="checkbox-inline">
                <input type="checkbox" name="drop-out[]" value="5"  class="form-control">
                Secondary school far away from the home </label>
                <label class="checkbox-inline">
                <input type="checkbox" name="drop-out[]" value="6"  class="form-control">
                Security problems for girls </label>
                <label class="checkbox-inline" style="width:300px">
              ...
              <tr>
              <td><b>161.</b></td>
              <td><span> What was doing before joining KISS: </span></td>
              <td><textarea class="form-control" name=""></textarea></td>
            </tr>
              <tr>
              <td><b>162.</b></td>
              <td><span> What are the areas in which you have improved after joining KISS: </span></td>
              <td><table style="width: 100%" class="table table-bordered">
                  <tr>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="improved_areas[]" value="Behaviour"  class="form-control" checked="true">
                      Behaviour </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="improved_areas[]" value="Discipline"  class="form-control" checked="true">
                      Discipline </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="improved_areas[]" value="Smartness"  class="form-control" checked="true">
                      Smartness </label></td>
                </tr>
                  <tr>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="improved_areas[]" value="Education"  class="form-control" checked="true">
                      Education </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="improved_areas[]" value="General Knowledge"  class="form-control" checked="true">
                      General Knowledge </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="improved_areas[]" value="Vocational Education"  class="form-control" checked="true">
                      Vocational Education </label></td>
                </tr>
                  <tr>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="improved_areas[]" value="Sports"  class="form-control" checked="true">
                      Sports </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="improved_areas[]" value="Games"  class="form-control" checked="true">
                      Games </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="improved_area" id="improved_area" value="others"  class="form-control" onchange="showTextarea(this.id);">
                      Others </label></td>
                </tr>
                </table></td>
              <td><input type="text" class="form-control" name="" id="textarea_improved_area" style="display: none;height: 32px;width: 190px;"></td>
            </tr>
              <tr>
              <td><b>163.</b></td>
              <td colspan="2"><span> Activities you have involved and enjoyed in KISS:(Specify) </span></td>
            </tr>
              <tr>
              <td><b>163.1</b></td>
              ...
              <td><table style="width: 100%;" class="table table-bordered">
                  <tr>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="activities[]" value="Debate"  class="form-control">
                      Debate </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="activities[]" value="Essay"  class="form-control">
                      Essay </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="activities[]" value="GK"  class="form-control">
                      GK </label></td>
                </tr>
                  <tr>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="activities[]" value="NSS"  class="form-control">
                      NSS </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="activities[]" value="Scout&Guide"  class="form-control">
                      Scout &amp; Guide </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="activities[]" value="Cub Bul-Bul"  class="form-control">
                      Cub Bul-Bul </label></td>
                </tr>
                  <tr>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="activities[]" value="Rovers Rangers"  class="form-control">
                      Rovers Rangers </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="activities[]" value="NCC"  class="form-control">
                      NCC </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="activities[]" value="Red Cross"  class="form-control">
                      Red Cross </label></td>
                </tr>
                  <tr>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="activities[]" value="KYS"  class="form-control">
                      KYS </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="activities[]" value="Peer Educator"  class="form-control">
                      Peer Educator </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="activity_other" id="activity_other" value="others"  class="form-control" onchange="showTextarea(this.id);">
                      Others </label></td>
                </tr>
                </table></td>
              <td><input type="text" class="form-control" name="" id="textarea_activity_other" style="display: none;height: 32px;width: 190px;"></td>
            </tr>
              <tr>
              <td><b>163.2</b></td>
              <td><span> Sports and Games: </span></td>
              <td><table style="max-width: none;" class="table table-bordered">
                  <tr>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="1"  class="form-control">
                      Sprint </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="6"  class="form-control">
                      Kho-Kho </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="11"  class="form-control">
                      Archery </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="sports[]" value="16"  class="form-control">
                      Tennis </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="21"  class="form-control">
                      Table Tennis </label></td>
                </tr>
                  <tr>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="2"  class="form-control">
                      Rugby </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="7"  class="form-control">
                      Net ball </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="12"  class="form-control">
                      Cricket </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="17"  class="form-control">
                      Weight lifting </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="sports[]" value="22"  class="form-control">
                      Lodu </label></td>
                </tr>
                  <tr>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="3"  class="form-control">
                      Football </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="8"  class="form-control">
                      Soft ball </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="13"  class="form-control">
                      Hand ball </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="18"  class="form-control">
                      Base ball </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="23"  class="form-control">
                      Carom </label></td>
                </tr>
                  <tr>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="4"  class="form-control">
                      Hockey </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="9"  class="form-control">
                      Chess </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="sports[]" value="14"  class="form-control">
                      Kabadi </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="19"  class="form-control">
                      Kick boxing </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="others"  class="form-control"  id="sports" onchange="showTextarea(this.id);">
                      Other(Specify) </label>
                      <input type="text" class="form-control" name="textarea_sports" id="textarea_sports" style="display: none;height: 32px;width:190px;"></td>
                </tr>
                  <tr>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="5"  class="form-control">
                      Judo </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="10"  class="form-control">
                      Volley ball </label></td>
                  <td><label class="checkbox-inline" style="">
                      <input type="checkbox" name="sports[]" value="15"  class="form-control">
                      Athletics </label></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="sports[]" value="20"  class="form-control">
                      Yoga </label></td>
                </tr>
                </table></td>
            </tr>
              ...
              <td><table class="table table-bordered">
                  <tr>
                  <td><label class="checkbox-inline" style="width:204px;margin-left:10px">
                      <input type="checkbox" name="music[]" value="Light vocal"  class="form-control">
                      Light vocal </label></td>
                  <td><label class="checkbox-inline" style="width:204px">
                      <input type="checkbox" name="music[]" value="Odissi vocal"  class="form-control">
                      Odissi vocal </label></td>
                  <td><label class="checkbox-inline" style="width:204px">
                      <input type="checkbox" name="music[]" value="others"  class="form-control"  id="music" onchange="showTextarea(this.id);">
                      Other(Specify) </label></td>
                  <td><textarea class="form-control" name="textarea_music" id="textarea_music" style="display: none;"></textarea></td>
                </tr>
                </table></td>
            </tr>
              <tr>
              ...
              <td><table class="table table-bordered">
                  <tr>
                  <td><label class="checkbox-inline" style="width:204px;margin-left:10px">
                      <input type="checkbox" name="dance[]" value="Odissi"  class="form-control">
                      Odissi </label></td>
                  <td><label class="checkbox-inline" style="width:204px">
                      <input type="checkbox" name="dance[]" value="Modern"  class="form-control">
                      Modern </label></td>
                  <td><label class="checkbox-inline" style="width:204px">
                      <input type="checkbox" name="dance[]" value="Semi Classical"  class="form-control">
                      Semi Classical </label></td>
                  <td><label class="checkbox-inline" style="width:204px">
                      <input type="checkbox" name="dance[]" value="others"  class="form-control"  id="dance" onchange="showTextarea(this.id);">
                      Other(Specify) </label></td>
                </tr>
                  <tr>
                  <td><textarea class="form-control" name="textarea_dance" id="textarea_dance" style="display: none;"></textarea></td>
                </tr>
                  <tr>
                  <td>&nbsp;</td>
                  <td><span> Instrumental </span></td>
                  <td><label class="checkbox-inline" style="width:204px;margin-left:10px">
                      <input type="checkbox" name="instrumental[]" value="Guitar"  class="form-control">
                      Guitar </label>
                      <label class="checkbox-inline" style="width:204px">
                      <input type="checkbox" name="instrumental[]" value="Drums"  class="form-control">
                      Drums (Pad) </label>
                      <label class="checkbox-inline" style="width:204px">
                      <input type="checkbox" name="instrumental[]" value="Keyboard"  class="form-control">
                      Keyboard </label>
                      <label class="checkbox-inline" style="width:204px">
                      <input type="checkbox" name="instrumental[]" value="Tabla"  class="form-control">
                      Tabla </label>
                      <label class="checkbox-inline" style="width:204px">
                      <input type="checkbox" name="instrumental[]" value="others"  class="form-control"  id="instrumental" onchange="showTextarea(this.id);">
                      Other(Specify) </label>
                      <textarea class="form-control" name="textarea_instrumental" id="textarea_instrumental" style="display: none;" onchange="showValue(this.value);"></textarea></td>
                </tr>
                  <tr>
                  <td><b>163.4</b></td>
                  <td><span> Yoga and Meditation: </span></td>
                  <td><label class="checkbox-inline">
                      <input type="checkbox" name="yoga[]" value="Yoga"  class="form-control">
                      Yoga </label>
                      <label class="checkbox-inline">
                      <input type="checkbox" name="yoga[]" value="Meditation"  class="form-control">
                      Meditation </label>
                      <label class="checkbox-inline">
                      <input type="checkbox" name="yoga[]" value="others"  class="form-control"  id="yoga" onchange="showTextarea(this.id);">
                      Other(Specify) </label>
                      <textarea class="form-control" name="textarea_yoga" id="textarea_yoga" style="display: none;" onchange="showValue(this.value);"></textarea></td>
                  <!--                                                        <td>
                  ...
                  <td><select class="form-control" name="vocational" id="vocational" onchange="showValue(this.value);
                  ...
                  <td style="padding-left: 5%;width: 25%;"><select class="form-control" name="tailoring" id="tailoring" onchange="showTextarea(this.id);" style="display: none;">
                      ...
                      <input type="text" class="form-control" name="textarea_vocational" id="textarea_vocational" style="display: none;height:32px;width:190px;">
                      </textarea></td>
                </tr>
                  <tr>
                  <td><b>163.7</b></td>
                  <td><span> English Access: </span></td>
                  <td><select class="form-control" name="english_access">
                      <option value="">--Select--</option>
                  ...
                  <td><select name="ambition" id="ambition" class="form-control" onchange="showTextarea(this.id);">
                      <option value="">--Select--</option>
                  ...
                  <td><input type="text" class="form-control" name="textarea_ambition" id="textarea_ambition" style="display: none;height: 32px;width: 190px;"></td>
                </tr>
                  <tr>
                  <td><b>166.</b></td>
                  ...
                  <tr>
                  <td><b>167.</b></td>
                  <td><span> Importance/Role of KISS in achieving your ambition: </span></td>
                  <td><textarea class="form-control" name=""></textarea></td>
                </tr>
                  <tr>
                  <td><b>168.</b></td>
                  <td><span> How you will involve yourself for achieving the objectives of KISS: </span></td>
                  <td><textarea class="form-control" name=""></textarea></td>
                </tr>
                  <tr>
                  <td><b>169.</b></td>

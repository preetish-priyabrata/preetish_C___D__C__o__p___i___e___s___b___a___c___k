            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="navbar navbar-default navbar-fixed-top">
                        <div class="container">
                            <div class="col-lg-4 text-center"> <a class="" href="studentStatus.html"><img class="img-responsive img-thumbnail logo" src="Images/left.png"></a> </div>
...
<tr>
    ...
    <td>
        ...
        <option value="">--Select Scheduled Tribe--</option>
            ...
            echo '<option>'.$scheduledTribes[$i].'</option>';
            }
            ?>
        </select>
        ...
        <option value="">--Select Primitive Tribe--</option>
            ...
            echo '<option>'.$primitiveTribes[$i].'</option>';
            }
            ?>
    </td>
</tr>
                                        <tr>
                                            ...
                                            <td>
                                                <select name="dialect" class="form-control">
                                                    ...
                                                    <option value="Dialect1">Dialect1</option>
                                                    <option value="Dialect2">Dialect2</option>
                                                    <option value="Dialect3">Dialect3</option>
                                                </select>
                                            </td>
                                            <td>

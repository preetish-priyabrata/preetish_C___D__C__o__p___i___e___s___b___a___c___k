...
<!--                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><span>Tailoring</span></td>
                                                        <td>
                                                            <select class="form-control" name="" id="tailoring" onchange="showTextarea(this.id);">
                                                                <option value="">Select</option>
                                                    ...
                                                    <tr>
                                                        <td><span>Chemical</span></td>
                                                        <td>
                                                            <select class="form-control" name="" id="chemical" onchange="showTextarea(this.id);">
                                                                <option value="">Select</option>
                                                    ...
                                                    <tr>
                                                        <td><span>Knitting</span></td>
                                                        <td>
                                                            <select class="form-control" name="" id="knitting" onchange="showTextarea(this.id);">
                                                                <option value="">Select</option>
                                                    ...
                                                    <tr>
                                                        <td><span>Applique</span></td>
                                                        <td>
                                                            <select class="form-control" name="" id="applique" onchange="showTextarea(this.id);">
                                                                <option value="">Select</option>
                                                    ...
                                                    <tr>
                                                        <td><span>Art &amp; Craft</span></td>
                                                        <td>
                                                            <select class="form-control" name="" id="art_craft" onchange="showTextarea(this.id);">
                                                                <option value="">Select</option>

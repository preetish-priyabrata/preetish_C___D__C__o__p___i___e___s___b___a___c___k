...
//            total1male2female2total2male3female3total3male_totalfemale_totaltotal_membercalculteTotalMember(this.id)
                function calculteTotalMember(memberId) {
                    var grand_male, grand_female, grand_total;
                    if (memberId == 'male1' || memberId == 'female1') {
                        if (memberId == 'male1') {
                            male_value1 = document.getElementById(memberId).value;
                        }
                        if (memberId == 'female1') {
                            female_value1 = document.getElementById(memberId).value;
                        }
                        total_vlaue1 = parseInt(male_value1) + parseInt(female_value1);
                        document.getElementById('total1').value = total_vlaue1;
                    }
                    if (memberId == 'male2' || memberId == 'female2') {
                        if (memberId == 'male2') {
                            male_value2 = document.getElementById(memberId).value;
                        }
                        if (memberId == 'female2') {
                            female_value2 = document.getElementById(memberId).value;
                        }
                        total_vlaue2 = parseInt(male_value2) + parseInt(female_value2);
                        document.getElementById('total2').value = total_vlaue2;
                    }
                    if (memberId == 'male3' || memberId == 'female3') {
                        if (memberId == 'male3') {
                            male_value3 = document.getElementById(memberId).value;
                        }
                        if (memberId == 'female3') {
                            female_value3 = document.getElementById(memberId).value;
                        }
                        total_vlaue3 = parseInt(male_value3) + parseInt(female_value3);
                        document.getElementById('total3').value = total_vlaue3;
                    }
//                    memberId+('_value')=document.getElementById(memberId).value;
//                    memberId=document.getElementById(memberId).value;alert(memberId);
////                    alert(value1);
//                    total=total+value1;alert(total);
//                    document.getElementById('total1').value=value1;
                    grand_male = parseInt(male_value1) + parseInt(male_value2) + parseInt(male_value3);
                    grand_female = parseInt(female_value1) + parseInt(female_value2) + parseInt(female_value3);
                    grand_total = parseInt(total_vlaue1) + parseInt(total_vlaue2) + parseInt(total_vlaue3);
                    document.getElementById('male_total').value = grand_male;
                    document.getElementById('female_total').value = grand_female;
...
//                        document.getElementById('class_year').style.display = "block";
                        document.getElementById('+2year').style.display = "block";
                    }
                    else {
//                        document.getElementById('class_year').style.display = "none";
                        document.getElementById('+2year').style.display = "none";
                    }
                    if (yearValue == '+3 Science' || yearValue == '+3 Commerce' || yearValue == '+3 Arts') {
//                        document.getElementById('class_year1').style.display = "block";
                        document.getElementById('+3year').style.display = "block";
                    }
                    else {
//                        document.getElementById('class_year1').style.display = "none";
...
<!--                                            <td name="class_year" id="class_year" style="display: none;">Year
                                                <select name="+2year" id="+2year" class="form-control" style="display: none;">
                                                    <option>+2 1st Year</option>
                                                    <option>+2 2nd Year</option>
                                                </select>
                                            </td>
                                            <td name="class_year1" id="class_year1" style="display: none;">Year
                                                <select name="+3year" id="+3year" class="form-control" style="display: none;">
                                                    <option>+3 1st Year</option>
                                                    <option>+3 2nd Year</option>
                                                    <option>+3 3rd Year</option>
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td colspan="3" class="col-lg-8"><table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="form-control" id="male1" name="male1" type="text" onkeyup="calculteTotalMember(this.id)"></td>
                                                    <td><input class="form-control" id="female1" name="female1" type="text"  onkeyup="calculteTotalMember(this.id)"></td>
                                                    <td><input class="form-control" id="total1" name="total1" type="text" ></td>
                                                </tr>
                                                <tr>
                                                    <td>116 B</td>
                                                    <td>7-17 years Members</td>
                                                    <td><input class="form-control" id="male2" name="male2" type="text"  onkeyup="calculteTotalMember(this.id)"></td>
                                                    <td><input class="form-control" id="female2" name="female2" type="text"  onkeyup="calculteTotalMember(this.id)"></td>
                                                    <td><input class="form-control" id="total2" name="total2" type="text" ></td>
                                                </tr>
                                                <tr>
                                                    <td>116 C</td>
                                                    <td>Adults</td>
                                                    <td><input class="form-control" id="male3" name="male3" type="text"  onkeyup="calculteTotalMember(this.id)"></td>
                                                    <td><input class="form-control" id="female3" name="female3" type="text"  onkeyup="calculteTotalMember(this.id)"></td>
                                                    <td><input class="form-control" id="total3" name="total3" type="text" ></td>
                                                </tr>
                                                <tr>
                                                    <td>117</td>
                                                    <td>Total members in the family</td>
                                                    <td><input class="form-control" id="male_total" name="male_total" type="text" ></td>
                                                    <td><input class="form-control" id="female_total" name="female_total" type="text" ></td>
                                                    <td><input class="form-control" type="text" name="total_member" id="total_member"></td>
                                                </tr>
                                            </table></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="3"><table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="form-control" type="text"></td>
                                                    <td>
                                                        <select class="form-control" name="relationship1">
                                                            <option value="">--Select--</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="form-control" type="text"></td>
                                                    <td>
                                                        <select class="form-control" name="relationship2">
                                                            <option value="">--Select--</option>
                                                            <option>Brother</option>
                                                            <option>Sister</option>
                                                            <option>Cousin Brother</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="form-control" type="text"></td>
                                                    <td>
                                                        <select class="form-control" name="relationship3">
                                                            <option value="">--Select--</option>
                                                            <option>Brother</option>
                                                            <option>Sister</option>
                                                            <option>Cousin Brother</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="form-control" type="text"></td>
                                                    <td>
                                                        <select class="form-control" name="relationship4">
                                                            <option value="">--Select--</option>
                                                            <option>Brother</option>
                                                            <option>Sister</option>
                                                            <option>Cousin Brother</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="form-control" type="text"></td>
                                                    <td>
                                                        <select class="form-control" name="relationship5">
                                                            <option value="">--Select--</option>
                                                            <option>Brother</option>
                                                            <option>Sister</option>
                                                            <option>Cousin Brother</option>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="house_type[]" value="Thatched house"  class="form-control">Thatched house
                                            </label>
                                            <label class="checkbox-inline">
                                    ...
                                    <tr>
                                        <td><b>144.</b>&nbsp;&nbsp;What types of festivals observed in your village ?</td>

                                        <td><input class="form-control" type="text" name="festivalstype"></td>
                                    </tr>
                                    <tr>
                                        <td><b>145.</b>&nbsp;&nbsp;Types of dances and songs you perform in your festivals ?</td>

                                        <td><input class="form-control" type="text" name="ferformtype"></td>
                                    </tr>
                                    <tr>
                                        <td><b>146.</b>&nbsp;&nbsp;Availability of food (on daily basis) in your family?</td>
                                ...
                                <fieldset>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="" id="textarea_road" style="display: none;height: 32px;width: 190px;">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="road_comm[]" value="Walking"  class="form-control">Walking
                                                </label>
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="road_comm[]" value="Auto"  class="form-control">Auto
                                                </label>
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="road_comm[]" value="Tractor"  class="form-control">Tractor
                                                </label>
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="road_comm[]" value="Jeep"  class="form-control">Jeep
                                                </label>
                                                <!--                                            <label class="checkbox-inline">
                                                                                                <input type="checkbox" name="house_type[]" value="Any Other"  class="form-control">Any Other
                                                                                            </label>-->
                                            ...
                                            <td colspan="2">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" name="" id="textarea_activities" style="display: none;height: 32px;width: 190px;">
                                                        </td>
                                                    </tr>
                                                    <tr>
...
<!--                                                        <td style="padding-left: 5%;width: 25%;">
                                                    ...
                                                    <tr>
                                                        <td><b>163.6</b> <span> Multilingual: </span></td>
                                                        <td>
                                                            <select class="form-control" name="multi_lingual">
                                                                <option value="">--Select--</option>
                                                    ...
                                                    <tr>
                                                        <td><b>163.7</b> <span> English Access: </span></td>
                                                        <td>

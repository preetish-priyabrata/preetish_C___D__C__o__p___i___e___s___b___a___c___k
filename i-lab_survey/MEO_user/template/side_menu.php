...
<link rel="stylesheet" href="https://use.fontawesome.com/6667a26d4c.css">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>I-lab </b>Survey</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview menu-open">
          <a href="#">
            <i class="fa fa-plus-square text-red"></i> <span>View Data Report</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li class="treeview menu-open">
              <a href="#" style="color:green"><i class="fa fa-circle-o"></i> Crop Diversification 
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="meo_edit_crop_diversification.php"><i class="fa fa-circle-o"></i> Edit Crop Diversification </a></li>
                
                <li><a href="meo_view_crop_diversification.php"><i class="fa fa-circle-o"></i> View Crop Diversification </a></li>
                
              </ul>
            </li>
            <li class="treeview menu-open">
              <a href="#" style="color:yellow"><i class="fa fa-circle-o"></i> Kitchen Garden 
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="meo_edit_Kitchen_Garden.php"><i class="fa fa-circle-o"></i> Edit Kitchen Garden </a></li>
                
                <li><a href="meo_view_Kitchen_garden.php"><i class="fa fa-circle-o"></i> View Kitchen Garden </a></li>
                
              </ul>
            </li>
            <li class="treeview menu-open">
              <a href="#" style="color:red"><i class="fa fa-circle-o"></i> Goatary 
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="meo_edit_goatary.php"><i class="fa fa-circle-o"></i> Edit Goatary </a></li>
                
                <li><a href="meo_view_Goatary.php"><i class="fa fa-circle-o"></i> View Goatary </a></li>
                
              </ul>
            </li>
            <li class="treeview menu-open">
              <a href="#" style="color:#ff6d00"><i class="fa fa-circle-o"></i> Dairy 
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="meo_edit_Dairy.php"><i class="fa fa-circle-o"></i> Edit Dairy </a></li>
                
                <li><a href="meo_view_Dairy.php"><i class="fa fa-circle-o"></i> View Dairy </a></li>
                
              </ul>
            </li>
            <li class="treeview menu-open">
              <a href="#" style="color:#f6ffff"><i class="fa fa-circle-o"></i> Poultry 
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="meo_edit_Poultry.php"><i class="fa fa-circle-o"></i> Edit Poultry </a></li>
                
                <li><a href="meo_View_Poultry.php"><i class="fa fa-circle-o"></i> View Poultry </a></li>
                
              </ul>
            </li>
            <li class="treeview menu-open">
              <a href="#" style="color:#f601ff"><i class="fa fa-circle-o"></i> Labour Saving Technologies 
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="meo_edit_LST.php"><i class="fa fa-circle-o"></i> Edit LST </a></li>
                
                <li><a href="meo_View_LST.php"><i class="fa fa-circle-o"></i> View LST </a></li>
                
              </ul>
            </li>
            <li class="treeview menu-open">
              <a href="#" style="color:#9dd6ff"><i class="fa fa-circle-o"></i> Post Harvest Loss
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="meo_edit_phl.php"><i class="fa fa-circle-o"></i> Edit PHL </a></li>
                
                <li><a href="meo_View_phl.php"><i class="fa fa-circle-o"></i> View PHL </a></li>
                
              </ul>
            </li>
            <li class="treeview menu-open">
              <a href="#" style="color:#ae004f"><i class="fa fa-circle-o"></i> Input and output tracking
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="meo_edit_i_o.php"><i class="fa fa-circle-o"></i> Edit I/O </a></li>
                
                <li><a href="meo_View_i_o.php"><i class="fa fa-circle-o"></i> View I/O </a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu" style="display: none;">
            <li><a href="MEO_training_info_training.php"><i class="fa fa-circle-o"></i> Training Report Edit</a></li>
            <li><a href="MEO_training_info_training_view.php"><i class="fa fa-circle-o"></i> Training Report View</a></li>
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span>SHG Report</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu" style="display: none;">
            <li><a href="MEO_shglist_info_shglist_edit.php"><i class="fa fa-circle-o"></i>SHG Report Edit</a></li>
            <li><a href="MEO_shglist_info_shglist_view.php"><i class="fa fa-circle-o"></i>SHG Report View</a></li>
       ...
       <li class="treeview">
          <a href="#">
            ...
            <span>MT(NGTK) Report</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu" style="display: none;">
            <li><a href="MEO_NGTKO_instruction_search.php"><i class="fa fa-circle-o"></i>NGTK Report Edit</a></li>
            <li><a href="MEO_NGTKO_instruction_search_view.php"><i class="fa fa-circle-o"></i>NGTK Report View</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu" style="display: none;">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu" style="display: none;">
                <li><a href="MEO_report_int_1_comp_c.php"><i class="fa fa-circle-o"></i> Components C : </a></li>
                <li><a href="MEO_report_int_1_comp_d.php"><i class="fa fa-circle-o"></i> Components D : </a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu" style="display: none;">
                <li><a href="MEO_report_int_2_comp_d.php"><i class="fa fa-circle-o"></i> Components D : </a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu" style="display: none;">
                <li><a href="MEO_report_int_3_comp_b.php"><i class="fa fa-circle-o"></i> Components B : </a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu" style="display: none;">
                <li><a href="MEO_report_int_4_comp_d.php"><i class="fa fa-circle-o"></i> Components D : </a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu" style="display: none;">
                <li><a href="MEO_report_int_6_comp_d.php"><i class="fa fa-circle-o"></i> Components D : </a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu" style="display: none;">
                <li><a href="MEO_report_int_7_comp_a.php"><i class="fa fa-circle-o"></i> Components A : </a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu" style="display: none;">
                <li><a href="MEO_report_int_8_comp_a.php"><i class="fa fa-circle-o"></i> Components A : </a></li>
                <li><a href="MEO_report_int_8_comp_b.php"><i class="fa fa-circle-o"></i> Components B : </a></li>
                <li><a href="MEO_report_int_8_comp_c.php"><i class="fa fa-circle-o"></i> Components C : </a></li>

              </ul>
            </li>
            <li><a href="MEO_report_crp.php"><i class="fa fa-plus-square text-red"></i> <span>Basic Info</span></a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <!-- <li><a href="MEO_training_info_training.php"><i class="fa fa-plus-square text-green"></i> <span> View Training Report</span></a></li> -->
       <!--  <li><a href="MEO_shglist_info_shglist.php"><i class="fa fa-plus-square text-blue"></i> <span> View SHG Report</span></a></li> -->

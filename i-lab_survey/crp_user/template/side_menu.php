  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="crp_hhi_get_hhi.php"><i class="fa fa-plus-square text-red"></i> <span>Add New Data Report</span></a></li>
        <li><a href="crp_training_info_training.php"><i class="fa fa-plus-square text-green"></i> <span>Training Report</span></a></li>
        <li><a href="crp_shglist_info_shglist.php"><i class="fa fa-plus-square text-blue"></i> <span>SHG Report</span></a></li>

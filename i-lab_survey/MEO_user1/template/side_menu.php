  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview menu-open">
              ...
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i> Edit Crop Diversification </a></li>
                
                <li><a href="#"><i class="fa fa-circle-o"></i> View Crop Diversification </a></li>
                <!-- <li class="treeview">
        ...
        <li><a href="MEO_hhi_get_hhi.php"><i class="fa fa-plus-square text-red"></i> <span>View Data Report</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu" style="display: none;">
            ...
            <li><a href="MEO_training_info_training1.php"><i class="fa fa-circle-o"></i> Training Report View</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu" style="display: none;">
            <li><a href="MEO_shglist_info_shglist.php"><i class="fa fa-circle-o"></i>SHG Report Edit</a></li>
            <li><a href="MEO_shglist_info_shglist1.php"><i class="fa fa-circle-o"></i>SHG Report View</a></li>

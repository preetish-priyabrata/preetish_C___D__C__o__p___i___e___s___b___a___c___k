                   ...
                   <div id="part1" class="tab-pane fade in active">
                    <table id='example' class="table table-hover" border="1">
                      ...
                      <tbody>
                        ...
                        <!--    <td><?php echo $res1['care_farmer_field_group'] ?></td> -->
                           <td><?php
                               $care_shg_id=$res1['care_shg_name'];
                  ...
                  <div id="part3" class="tab-pane fade">
                   <table id='example' class="table table-hover" border="1">
                      ...
                      <tr>
                           ...
                           <?php 
                            $care_NGTK_name=json_decode($res1['care_NGTK_name']);
                      ...
                      <tbody>
                        ...
                        <td>
                           <select disabled="" class="form-control" name="care_observation_tool" required="">
                            ...
                            <option value="3" <?php if($res1['care_observation_tool']==3){echo "selected";}?>>Non-Informative</option> 
                          </select>
                       </td>

...
<div id="section-to-print">
	<div class="container-fluid">
		...
		<div class="row">
		<div class="col-md-12">
			<table class="table table-bordered" border="1"  cellspacing="0" cellpadding="1" frame="box" align="center">
			<thead>
            <tr>
...
<div class="col-md-2">
<a class="btn-block" style="background-color:#39F; text-align:center;color:#000;"" href="pe_generate_attendance.php" >Back</a>
</div>
<div class="col-md-4">
	...
	<?php
	$code="x";
$qry_status="UPDATE `assign_exam_center` SET `generated_sheet_status`='1' WHERE `exam_name`='$exam' And `center_name`='$center'";

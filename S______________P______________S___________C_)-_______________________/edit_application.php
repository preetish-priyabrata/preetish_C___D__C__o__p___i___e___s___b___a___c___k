              ...
              <div class="tab-content">
                <div id="Personal" class="tab-pane fade in active">
                 <div class="row"></div>
                  <?php  
                      ...
                      $res_personal=mysqli_fetch_array($sql_personal);                   
                      if($res_personal['personal_verif_status']==1 OR $res_personal['personal_verif_status']==3 OR $res_personal['personal_verif_status']==5){
                  ...
                  <?php }else{
                          if($res_personal['personal_verif_status']==3 OR $res_personal['personal_verif_status']==5){
                    ?>
                      <div class="col-md-12">
                ...
                <div id="Educational" class="tab-pane fade">
                  ...
                  <?php  
                      ...
                      if($res_education['educational_verif_status']==1 OR $res_education['educational_verif_status']==3 OR $res_education['educational_verif_status']==5){
                  ...
                  <?php }else{
                      if($res_personal['educational_verif_status']==3 OR $res_personal['educational_verif_status']==5){
                    ?>
                      <div class="col-md-12">
                          <div class="alert alert-danger text-center">
                            <strong > Appliaction Is Rejected .</strong>
                  ...
                  <form action="update_educational_info.php" id="academic_info" enctype="multipart/form-data" method="post" role="form" novalidate>
                    ...
                    ?> 
                        <tr>
                          <td><?php echo $i+1;?>.</td>
                          <td><input type="text" value="<?php echo $res_edu_qen[$i];?>" id="qlfy_exam<?php echo $i+1;?>" name="qlfy_exam[]" class="form-control"></td>
                          <td>
                          <input id="" name="mark_upload[]" type="file" class="file-loading"  ><br>
                      ...
                      <?php }?>
                          ...
                          <td>
                            <input id="" name="cer_upload[]" type="file" class="file-loading" ><br>
                          ...
                          <?php }else{?>
                            <?php } ?>
                          <input type="hidden" value="<?php echo $upload_cert[$i];?>" id="upload_cert<?php echo $i+1;?>" name="upload_certs[]" class="form-control"></td>
                          
                          <td><input type="text" value="<?php echo $res_edu_po[$i];?>" id="perc_obt<?php echo $i+1;?>" name="perc_obt[]" class="form-control"></td>
                ...
                <div id="Employment" class="tab-pane fade">
                  ...
                  <?php  
                      ...
                      if($res_employment['employment_verif_status']==1 OR $res_employment['employment_verif_status']==3 OR $res_employment['employment_verif_status']==5){
                  ...
                  <?php }else{
                           if($res_personal['employment_verif_status']==3 OR $res_personal['employment_verif_status']==5){
                    ?>
                      <div class="col-md-12">
                          <div class="alert alert-danger text-center">
                            <strong > Appliaction Is Rejected .</strong>
                ...
                <div id="Upload" class="tab-pane fade">
                  <div class="row"></div>
                   <?php  
                      ...
                      if($res_certificate['certificate_verif_status']==1 OR $res_certificate['certificate_verif_status']==3 OR $res_certificate['certificate_verif_status']==5){
                  ...
                  <?php }}?>
                   <form action="update_upload_info.php" id="upload_info" enctype="multipart/form-data" method="post" role="form" novalidate>
                      ...
                      <input type="hidden" name="upd_cert_name3" value="<?php  echo $res_upld["candidates_coi_name"]; ?>" />
                     
                      <input type="hidden" name="upd_cert_name4" value="<?php echo $res_upld["esm/spea/pwd_name"]; ?>"/>
                      <input type="hidden" name="upd_cert_name5" value="<?php echo $res_upld["mrg_certificate_name"]; ?>"/>
                         <table class="table">
                           <tr>
                              <th>Sl. No.</th>
                          ...
                          <tr>
                            ...
                            <td><input type="text" value="<?php echo $res_upld["candidates_coi_sl_no"]; ?>" id="cert_sl_no3" name="cert_sl_no3" class="form-control"></td>
                            <td><input type="text" value="<?php echo $res_upld["candidates_coi_issuing_authority"]; ?>" id="cert_iss_aut3" name="cert_iss_aut3" class="form-control"></td>
                          ...
                          <tr>
                            ...
                            <td><input type="text" value="<?php echo $res_upld["esm/spea/pwd_sl_no"]; ?>" id="cert_sl_no4" name="cert_sl_no4" class="form-control"></td>
                            <td><input type="text" value="<?php echo $res_upld["esm/spea/pwd_issuing_authority"]; ?>" id="cert_iss_aut4" name="cert_iss_aut4" class="form-control"></td>
                          ...
                          <tr>
                            ...
                            <td><input type="text" value="<?php echo $res_upld["mrg_certificate_sl_no"]; ?>" id="cert_sl_no5" name="cert_sl_no5" class="form-control"></td>
                            <td><input type="text" value="<?php echo $res_upld["mrg_certificate_issuing_authority"]; ?>" id="cert_iss_aut5" name="cert_iss_aut5" class="form-control"></td>
                ...
                <div id="Payment" class="tab-pane fade">
                 <div class="row"></div>
                  <?php  
                      ...
                      if($res_payment['payment_verif_status']==1 OR $res_payment['payment_verif_status']==3 OR $res_payment['payment_verif_status']==5){
                ...
                <div id="Declaration" class="tab-pane fade">
                  ...
                  <?php  
                      ...
                      if($res_declaration['declaration_verif_status']==1 OR $res_declaration['declaration_verif_status']==3 OR $res_declaration['declaration_verif_status']==5){

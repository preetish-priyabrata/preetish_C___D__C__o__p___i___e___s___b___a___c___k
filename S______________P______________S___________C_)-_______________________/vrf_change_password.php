...
$qry="SELECT * FROM `user_master_data` WHERE `username`='$admin_name' AND `usertype`='final verification'";	
...
<form action="final_save_verification_password.php" id="chng_password" name="chng_password" enctype="multipart/form-data" method="post" role="form"  onSubmit="return validatePassword();">

...
<head>
        ...
        <title>Easy Post || Login Admin</title>
...
<link rel="stylesheet" type="text/css" href="<?=base_url()?>theme_asserts/css/style.css" />
    ...
    <div id="page-wrap">
        ...
        <div class="wrapper-page">
            ...
            <div class="panel-heading"> 
                <h3 class="text-center"> Sign In to <strong class="text-custom">Admin Page</strong> </h3>
            </div> 

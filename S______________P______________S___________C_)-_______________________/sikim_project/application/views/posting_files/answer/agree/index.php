          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php 
                      $x=0;
                      $datas=array('del_status'=>0,'answer_id'=>$id,'like_value'=>$agree);
                 ...
                 echo $user_name1=$key_value12->first_name." ".$key_value12->last_name;
                      ...
                      <td>
                                            <?php
                                               if ($key->status == 1) {
                                            ?>
                                                            <a href="<?php echo site_url('update-agree-status/2/' . $key->id.'/'.$id.'/'.$agree) ?>" name='active' class='badge bg-blue' style='cursor:pointer;'>Active</a>
                                                    <?php
                                                  } else {
                                                   ?>
                                                            <a href='<?php echo site_url('update-agree-status/1/' . $key->id.'/'.$id.'/'.$agree) ?>' name='inactive' class='badge bg-red' style='cursor:pointer;'>Inactive</a>
                                                    <?php
}
  ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form class="form-horizontal form-label-left" action="<?=base_url()?>deletes-agree" method="POST" role="form">

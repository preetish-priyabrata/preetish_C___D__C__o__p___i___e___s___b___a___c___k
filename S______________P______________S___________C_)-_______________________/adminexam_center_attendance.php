...
<legend><h4>View Center wise Attendance</h4></legend>
<table class="table">
<tr>
                  <td>Exam</td>
...
<center><input type="button" class="btn-primary" id="show" name="show" value="Show" onClick="show_center_report();"></center>

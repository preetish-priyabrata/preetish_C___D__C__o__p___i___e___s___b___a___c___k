...
<legend><h4>Update Attendance</h4></legend>
<table class="table">
...
<center><input type="button" class="btn-primary" id="show" name="show" value="Show" onClick="show_candidate_rollno();"></center>

 </div>
                               </div>
                               </div>
                               <div class="col-lg-3" id="show_report">
                               </div>
<?php
}

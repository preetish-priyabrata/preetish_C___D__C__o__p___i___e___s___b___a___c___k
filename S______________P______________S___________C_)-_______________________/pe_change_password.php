...
$qry="SELECT * FROM `user_master_data` WHERE `username`='$_SESSION[preexam_user]' AND `usertype`='pre exam'";	
...
<form action="save_preexam_password.php" id="chng_password" name="chng_password" enctype="multipart/form-data" method="post" role="form"  onSubmit="return validatePassword();">

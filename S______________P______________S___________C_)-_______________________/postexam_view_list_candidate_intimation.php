 	...
 	<div class="container-fluid">
    	<div class="row">
		  	...
		  	<div class="col-lg-6 col-lg-offset-4">
		  		<form class="form-inline" method="POST" action"postexam_view_publish.php">
...
if(isset($_POST['search'])){
        ...
        $qry_rejected="SELECT * FROM `candidate_application_info` INNER JOIN `candidate_personal_details` on candidate_personal_details.application_no = candidate_application_info.application_no WHERE candidate_application_info.exam_name='$exam' AND candidate_application_info.application_submitted='yes' AND candidate_application_info.application_verification_officer!='1' or candidate_application_info.application_verification_officer='5' ";
...
<div class="col-lg-9">
		<div class="panel panel-default">
		    <div class="panel-heading">
		    	<h5>Qualified Candidate List <?=$exam?> Exam Qualified To Be Send Intimation</h5>
		    </div>
		    ...
		    <br>
		    	<table width="99%" border="2" cellspacing="10" cellpadding="10">
			 	...
			 	<div style="height:300px; overflow:scroll; ">
				  ...
				  <?php
				  $qry_no_app="SELECT * FROM `postexam_intimation_list` Where `exam_name`='$exam' And `category_name`='$res_cut[category_name]'";
...
<?php 
	...
	<div class="col-md-12">
        <div class="alert alert-success text-center">
          <strong > Please Update The Publish Report For The Exam :- <?=$exam?> </strong>
        </div>
      </div>
<?php }
}

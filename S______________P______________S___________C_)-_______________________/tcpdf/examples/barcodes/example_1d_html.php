...
$barcodeobj = new TCPDFBarcode($i, 'C128');

// output the barcode as HTML object
 $x=$barcodeobj->getBarcodeHTML(2, 30, 'black');
echo $x;
echo "<br>";
echo "<pre>";
print_r($x);
...
//============================================================+
####################################################################################### 
// require_once(dirname(__FILE__).'/tcpdf/examples/barcodes/tcpdf_barcodes_1d_include.php');
// $i=mt_rand(0,32767);
// // set the barcode content and type
// $barcodeobj = new TCPDFBarcode($i, 'C128');

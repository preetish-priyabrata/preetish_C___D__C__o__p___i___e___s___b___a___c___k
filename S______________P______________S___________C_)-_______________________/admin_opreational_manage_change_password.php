...
date_default_timezone_set('Asia/Calcutta');
       ...
       $admin_name=$_SESSION['admin_operational_exam'];

    
$qry="SELECT * FROM `user_master_data` WHERE `userid`='$admin_name' AND `usertype`='admin operational'"; 
...
<form action="admin_opreational_save_change_password.php" id="chng_password" name="chng_password" enctype="multipart/form-data" method="post" role="form"  onSubmit="return validatePassword();">

...
<?php 		
				...
				$qry_centres_gen="SELECT * FROM `assign_exam_center` where `exam_name`='$exam' AND `generated_sheet_status`='1'" ;
...
?>
					<div class="col-md-12">
		        		<div class="alert alert-success text-center">
		          			<strong >Attendance Sheet For Exam   :-  <?=$exam?> Is Not Generated </strong>
		        		</div>
		      		</div>
<?php  			}else{
?>
					...
					<form class="form-horizontal" action="view_attendance_sheet.php" method="POST" role="form">
...
<?php
									...
									//$qry_centre="SELECT * FROM `center_master_data`  ";
										$qry_centre="SELECT * FROM assign_exam_center where  `exam_name`='$exam' And `generated_sheet_status`='1' ";
						...
						<!--<div class="form-group">
					  	...
					  	<div class="form-group">
					    	<div class="col-sm-offset-6 col-sm-6">
					      		<button type="submit" class="btn btn-default">View Attendance Sheet</button>
					    	</div>
					  	</div>

...
?>
<script>
function show_mark(str)
{
	var sec=document.getElementById("s"+str)
	var tot=document.getElementById("t"+str)
	var cut=document.getElementById("c"+str)
...
<center><input type="button" class="btn-primary" id="search" name="search" value="Search" onClick="show_result_info();"></center>

</div>
                               </div>
                               </div>
                               <div class="col-lg-9" id="show_result"> 

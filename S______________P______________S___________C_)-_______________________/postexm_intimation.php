...
<form action="send_intimation.php" method="post" id="intimation" name="intimation" enctype="multipart/form-data">
<div class="col-lg-3"> 
                <div class="tab-content">
<div role="tabpanel" class="well modal-content form-horizontal tab-pane active fade in" id="general">
<legend><h4>Intimation</h4></legend>
<table class="table">
<tr>
                  <td>Exam</td>
				 ...
				 while($res_exam=mysqli_fetch_array($sql_exam))
                  ...
                  <tr>
                  <td style="text-align:center" colspan="2"><input type="button" id="search" class="btn-primary" name="search" value="Search" onClick="show_intimation_table();"></td>
                  </tr>
                               ...
                               <div class="col-lg-6" id="show_intimation_table">
                               </div>
                               <div class="col-lg-3">
                               </div>
                               </form>

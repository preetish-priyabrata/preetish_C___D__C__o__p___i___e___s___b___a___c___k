...
$qry="SELECT * FROM `user_master_data` WHERE `username`='$_SESSION[adminexam_user]' AND `usertype`='admin exam'";	
...
<form action="save_adminexam_password.php" id="chng_password" name="chng_password" enctype="multipart/form-data" method="post" role="form"  onSubmit="return validatePassword();">

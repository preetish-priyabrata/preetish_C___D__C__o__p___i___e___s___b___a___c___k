...
<legend><h3>Not Qualified</h3></legend>
<table class="table">
<tr>
<th>Roll No</th>
<th>Profile</th>
...
<?php
$i=1;
while($res_notqualified=mysqli_fetch_array($sql_notqualified))
{
$qry_appno="SELECT `application_no`, `category` FROM `candidate_application_info` WHERE `exam_name`='$exam_name' AND `roll_no`='$res_notqualified[roll_no]'";
...
?>
<tr>
<td><?php echo $res_notqualified["roll_no"]; ?></td>
<td><a target="_blank" href="view_application.php?appno=<?php echo $res_appno["application_no"];?>">View</a></td>
<td><a onclick="show_nq_mark('<?php echo $i; ?>')">Mark</a></td>
<td id="s<?php echo $i; ?>" style="display:none">Secured:- <?php echo $res_notqualified["secured_mark"]; ?></td>

...
<h4 style="text-align:center">Total Number Of Candidates</h4>
                     ...
                     <?php if($num_row!='0') { ?><h6 align="center"><input type="button" id="view_details" value="View Details" onclick="view_enrolled_cand_list('<?php echo $exam_name; ?>', '<?php echo $centre; ?>');" class="btn-primary"></h6><?php } ?>       
                  </div>

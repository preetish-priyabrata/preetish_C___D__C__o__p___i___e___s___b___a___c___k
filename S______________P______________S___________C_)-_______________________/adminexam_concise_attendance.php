...
<legend><h4>View Concise Attendance Report</h4></legend>
<table class="table">
<tr>
                  <td>Exam</td>
...
<center><input type="button" class="btn-primary" id="show" name="show" value="Show" onClick="show_concise_report();"></center>

 </div>
                               </div>
                               </div>
                               <div class="col-lg-8" id="show_report">
                               </div>
<?php
}

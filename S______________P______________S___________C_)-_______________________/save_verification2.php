 ...
 */
	if(isset($_POST['conforms'])){
        ...
        if($res_check_status['application_status']=="1"){
        	$msg->success('Application Is Verified Application No :- '.$_REQUEST['application_no']);
        	...
        	$qry_check="SELECT * FROM `candidate_application_info`  WHERE `application_no`='$_REQUEST[application_no]' AND `application_submitted`='yes'";
	        	...
	        	if($row_no_check!=0){
					...
					if($res){
						...
						$qry_submit_status="UPDATE `candidate_application_info` SET `application_verification_officer`='1',`date_of_verification`='$date',`application_verified_officer`='$admin_name' WHERE `application_no`='$_REQUEST[application_no]'";	
						$res_status=mysqli_query($conn, $qry_submit_status);
						if($res_status){
							$msg->success('Application Is Verified Application No :- '.$_REQUEST['application_no'].'Success-Fully');
							//view_application.php?appno=<?php echo $res["application_no"];
							header('Location:vrf_verify_application.php');
						exit;
 ...
 */
 // [application_no] => 576423 [reason]
	if(isset($_POST['rejected'])){
		...
		$res_status=mysqli_query($conn, $qry_submit_status);
		if($res_status){
			$msg->success('Application Is Rejected Application No :- '.$_REQUEST['application_no'].'Success-Fully');
			header("Location:vrf_verify_application.php");
			exit;
...
if(isset($_POST['inadequte'])){
	...
	$qry_check_status="SELECT * FROM `candidate_application_info` WHERE `application_no`='$_REQUEST[application_no]'";
		...
		$qry_submit_status="UPDATE `candidate_application_info` t1, `candidate_certificate_uploads` t2, `candidate_declaration` t3, `candidate_educational_details` t4, `candidate_employment_details` t5, `candidate_payment_details` t6, `candidate_personal_details` t7 SET t1.application_verification_officer='2',t1.dead_line_date='$dead_line_date', t1.application_verified_officer='$admin_name', t1.reason_inadequte='$reason_inadequte' , t1.section='$section' , t1.days='$days' , t2.certificate_verif_status='2', t3.declaration_verif_status='2', t4.educational_verif_status='2', t5.employment_verif_status='2', t6.payment_verif_status='2', t7.personal_verif_status='2' WHERE t1.application_no='$_POST[application_no]' AND t2.application_no='$_POST[application_no]' AND t3.application_no='$_POST[application_no]' AND t4.application_no='$_POST[application_no]' AND t5.application_no='$_POST[application_no]' AND t6.application_no='$_POST[application_no]' AND t7.application_no='$_POST[application_no]'";

...
<body>
    ...
    <div class="container-fluid" id="container-fluids">
        <div class="col" id="demo">
             <div class="row">
                <div class="col">
              <!-- <div class="col-3"> <img src="assert/img/logo4.png" class="rounded" alt="Innovadors Lab"> </div> -->
              <!-- <div class="col-4">  -->
                <div class="text-center">
                <h3 class="gray2"> Innovadors Lab </h3>
            </div>
              <!-- <div class="col-4">col-4</div> -->
            </div> 
        </div>
            <h3 class="newspaper2 text-center">Examination Management System</h3>
        </div>
       
    </div>
    <div class="container-fluid" id="container-fluids">
        <nav class="navbar navbar-expand-sm bg-faded navbar-dark " style="background: coral;">
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#nav-content" aria-controls="nav-content" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
            </button>

            <!-- Brand -->
            <!-- <a class="navbar-brand" href="#"><img src="assert/img/logo4.png"  alt="Innovadors Lab" width="200" height="30" class="d-inline-block align-top"></a> -->
    ...
    <div class="container-fluid" style="height: 1000px; background: white;">
                ...
                <div class="col-lg-3 col-md-3"><!-- widgets column center -->
                        ...
                        <ul class="list-unstyled clear-margins"><!-- widgets -->
                            ...
                            <li class="widget-container widget_recent_news"><!-- widgets list -->
                                ...
                                <h2 class="title-median">Innovadors Lab Pvt. Ltd.</h2>
                                <p><b>Email id:</b> <a href="mailto:info@innovadorslab.com">info@innovadorslab.com</a></p>
                                <p><b>Helpline Numbers </b>

                                <b style="color:#ffc106;">(8AM to 10PM):</b>  +91-97768069881, +91-9437072128  </p>
    
                                <p><b>Corp Office / Postal Address</b></p>
                                <p><b>Phone Numbers : </b>97768069881, </p>
                                <p> 011-27568832, 9437072128</p>
                                </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="design">
                     ...
                     <a href="#">Franchisee </a> |  <a target="_blank" href="http://www.innovadorslab.com">Web Design & Development by Innovadors Lab</a>

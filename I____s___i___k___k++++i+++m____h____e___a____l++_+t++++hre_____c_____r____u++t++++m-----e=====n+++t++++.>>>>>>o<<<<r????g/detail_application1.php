        ...
        <div class="card-body">
          <div class="row row-eq-height">
            ...
            <fieldset style="border: 1px solid lightgreen; padding: 6px; margin-bottom: 11px;"><legend>Education Information</legend>
              <div class="form-group row">
                <label for="candidate_qualification" class="col-sm-4 col-form-label">Education Qulification * </label>
                <div class="col-sm-6">
          ...
          <fieldset style="border: 1px solid lightblue; padding: 6px; margin-bottom: 11px;"><legend>Candidate Details</legend>
            ...
            <div class="col-sm-4 pull-right">
               ...
               <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label for="staticEmail" class="col-sm-4 col-form-label">signature Scan*</label>
                    <div class="col-sm-6">

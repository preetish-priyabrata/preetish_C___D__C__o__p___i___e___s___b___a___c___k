...
<head>
    <meta charset="utf-8">
    <title>Sikkim Health Recruitment</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                     ...
                     <li class="menu__item">
                        <a href="index" class="menu__link">
                            <span class="menu__title">
                                <span class="menu__first-word fa fa-home fa-xs" style="font-size: 30px" data-hover="">
                                  <i class="fa fa-home fa-xs" style="font-size: 30px"></i>
                                </span>

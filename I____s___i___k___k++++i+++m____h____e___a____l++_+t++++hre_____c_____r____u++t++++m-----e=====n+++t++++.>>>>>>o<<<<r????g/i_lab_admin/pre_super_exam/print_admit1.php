...
$get_candidate="SELECT * FROM `ilab_pre_exam_roll_no` WHERE `group_exam_slno`='$exam' and `assign_roll_center`='1' and `slno_roll_id`='$slno_roll_id'";
                            ...
                            <table class="table table-bordered" align="center"  cellspacing="0" cellpadding="1" >
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td></td>         
                                  <td rowspan="10" ><img src="../../images/photo/<?=$res_cand_info['candidate_photo']?>" alt="" width="220"  height="180" id="photopreview" name="photopreview">

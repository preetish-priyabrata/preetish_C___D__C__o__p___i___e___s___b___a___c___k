  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i> Roll Sheet</div>
			<ul class="breadcrumb">
				<li><a href="#">Manage Roll Sheet </a></li>
				<li class="active">View Roll Sheet</li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
		...
		<div class="col-md-12 col-sm-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="panel-title">View Roll Sheet</div>
					</div>
					<div class="panel-body">
						...
						if($_SERVER["REQUEST_METHOD"] == "POST"){
							...
							<input type="submit" class="btn btn-info"  value="View Roll No Sheet"  >
							</div>
							<?php }?>
						</form>
						<br>
        											...
        											<?php 
						        						...
						        						<tr style="text-align: center;">
						        							...
						        							<td>
						        								...
						        								<a target="_blank" href="print_attendance_roll?exam=<?=$result_id['slno_exam']?>&list=<?=$exam?>&session=1">GET Details</a> || <a target="_blank" href="print_attendance_roll?exam=<?=$result_id['slno_exam']?>&list=<?=$exam?>&session=2">Get Details</a>
						        								<?php }else if($result_id['no_session']=='1'){?>
						        								<a target="_blank" href="print_attendance_roll?exam=<?=$result_id['slno_exam']?>&list=<?=$exam?>&session=1">Get Details</a>
						        								<?php }?>
						        							</td>
						        						</tr>
						        					<?php }?>

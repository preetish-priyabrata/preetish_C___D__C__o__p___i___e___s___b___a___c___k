               ...
               <ul class="sidebar-accordion">
                ...
                <!-- admin_Pre_tech_s -->
                 ...
                 ?>
                    ...
                    <!-- <li><a href="#"><i class="icon-stack2"></i> <span>Class Management</span></a>
                        <ul> 
                            
                            <li><a href="admin_class_view.php">View Class <span style="color: red">New</span>  </a></li>
                        </ul>
                    </li>  -->
                     <?php 
                    ...
                    <!-- <li><a href="#"><i class="icon-stack2"></i> <span>View Center Status</span></a></li> -->
                     <li><a href="#"><i class="icon-stack2"></i> <span>Manage Attendance Sheet</span></a>
                        <ul> 
                            <li><a href="admin_GENERATE_attendance">Generate Attendance Sheet <span style="color: red">New</span></a></li>

...
<div class="header">
  <div class="header-content">
    <div class="page-title"><i class="icon-display4"></i>Candidate Application  List For Group D Post</div>
    <ul class="breadcrumb">
      <li><a href="admin_dashboard.php"></a></li>
      <li><a href="#"></a>Candidate Application Form System</li>
      <li class="active">Application Form List for Group D</li>
    </ul>
  </div>
</div>
<div class="container-fluid page-content">
  ...
  <div class="container-fluid page-content">
    <div class="row">
      <div class="col-md-12 col-sm-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <div class="panel-title">Candidate Application  List For Group D Post </div>
          </div>
     ...
     // WHERE condition
                     $paids="SELECT * FROM `ilab_group_candidate_info` left JOIN `ilab_payment_info` on ilab_payment_info.slno_group_pay=ilab_group_candidate_info.paid_id_slno  WHERE ilab_group_candidate_info.candidate_mobile='$result[candidate_mobile]' AND ilab_group_candidate_info.paid_status='1'and ilab_group_candidate_info.group_id_slno='2'";

...
$domain=$_POST['domain'];
    if(move_uploaded_file($file_tmp,"upload/job/".$filename)){
		...
		$mail->addAttachment("upload/job/".$filename); //Filename is optional

		$mail->isHTML(true);

		$mail->Subject = "This Mail Is For Resume Submission";
		$mail->Body = "<b>This is a Computer Generated mail. Don't Reply !!</b><br>"."<br><b>Name: </b>".$user_name."<br>"."<br><b>Contact No: </b>".$mobile."<br>"."<br><b>Email Id: </b>".$email."<br><b>Postion : ".strtoupper($posting)."<br><b>Domain Applying For: ".$domain." ";

		   ...
		   <div class="panel-heading">
			 <div class="panel-title">Add Banner</div>
			     ...
			     <div class="panel-body">
				   <form name="myFunction" class="form-horizontal" action="banner_add_save.php" method="POST" enctype="multipart/form-data">
               
					  	<div class="form-group">
							<label class="control-label col-lg-4 text-right">Short Description</label>
						  	<div class="col-lg-8">
						  		<textarea rows="3" cols="6" name="short_desc" class="form-control" id="short_desc" required=""></textarea>

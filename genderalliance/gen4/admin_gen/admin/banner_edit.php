		   ...
		   <div class="panel-heading">
			 <div class="panel-title">Edit Banner</div>
			     ...
			     <div class="panel-body">
				   <form name="myFunction" class="form-horizontal" action="banner_edit_save.php" method="POST" enctype="multipart/form-data">


				    <?php
           	   		    $query ="SELECT * FROM `gen_banner` where `sl_no`='$sl_no'";   
                   ...
                   <input type="hidden" value="<?php echo $viewBanner['sl_no']; ?>" name="sl_no">
					  	...
					  	<div class="form-group">
							<label class="control-label col-lg-4 text-right">Short Description</label>
						  	<div class="col-lg-8">
						  		<textarea rows="3" cols="6" name="short_desc" class="form-control" id="short_desc" required=""   ><?php echo $viewBanner['short_desc']; ?></textarea>
						...
						<div class="form-group">
		   				...
		   				<a href="banner_view.php" class="btn btn-info">Back</a>

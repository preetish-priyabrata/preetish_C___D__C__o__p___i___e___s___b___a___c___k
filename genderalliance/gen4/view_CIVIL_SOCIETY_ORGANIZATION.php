...
@media only screen and (max-width: 990px) {
  ...
  ?>
    ...
    <br>
<?php
$CSVfp = fopen("files/genderalliance_civil.csv", "r");
if($CSVfp !== FALSE) {
 while(! feof($CSVfp)) {
...
<div class="container">
    <div class="row">
	    <div class="panel panel-default">
	    	<div class="panel-heading text-center"> CIVIL SOCIETY ORGANIZATION</div>
	    	<div class="panel-body">
				<table id="example" class="display" width="100%" cellspacing="0">
					...
					<thead>
						<tr>
							<th>S. NO.</th>
							<th> NAME OF CIVIL SOCIETY ORGANIZATION</th>
							<th>PLACE</th>
						</tr>
					</thead>
					<tbody>

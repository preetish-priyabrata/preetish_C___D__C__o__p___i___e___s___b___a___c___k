...
<?php
  ...
  $data = array("UNFPA","UNICEF","ICRW","Save The Children","Landesa","The Hunger Project","Oxfam"," Action Aid");
  $data1 = array("UNFPA.jpeg","UNICEF.png","ICRW.jpeg","Save The Children.jpeg","Landesa.jpeg","The Hunger Project.png","Oxfam.png","Action Aid.jpeg");
...
<div class="container">
    <div class="row">
	    <div class="panel panel-default">
	    	<div class="panel-heading text-center"> International Agencies</div>
					...
					<tbody>
						...
						for ($i=0; $i < count($data); $i++) { ?>
							<tr>
								<td><?=$i+1?></td>
								<td><?=$data[$i]?></td>
								<td><img src="img/international/<?=$data1[$i]?>" class="img-thumbnail" alt="Cinque Terre" width="150" height="150"></td>
						<?php }?>
					</tbody>	
				</table>
			</div>

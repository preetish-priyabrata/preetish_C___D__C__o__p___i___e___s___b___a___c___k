...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/javascript"></script>
   ...
   <!--  <link rel="stylesheet" href="css/bootsnav.css">
    ...
    <link rel="stylesheet" type="text/css" href="css/banner_bellow.css">
     <link rel="stylesheet" type="text/css" href="css/footer.css"> -->
     ...
     <div  class="col-lg-3 box foo">
      ...
      <!-- <hr> -->
       ...
       <ul class="list_style">
        <li><a class="cool-link" href="#">A cool link</a></li>
        <li><a class="cool-link" href="#">A cool link</a></li>
        <li><a class="cool-link" href="#">A cool link A cool link A cool link A cool link A cool link A cool link
        </a></li>
       </ul>
                ...
                <div class="col-lg-3 col-md-3"><!-- widgets column center -->
                        ...
                        <ul class="list-unstyled clear-margins"><!-- widgets -->
                          ...
                          <li class="widget-container widget_recent_news"><!-- widgets list -->
                                ...
                                <h2 class="title-median">Gender Alliance </h2>
                                <p><b>Email id:</b> <a href="mailto:info@webenlance.com">info@GenderAlliance.com</a></p>
                                <p>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        ...
        <div class="copyright">
          ...
          © 2015, Innovadors Lab , All rights reserved
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        ...
        <div class="design">
           ...
           <a href="#">India </a> |  <a target="_blank" href="http://www.webenlance.com">Web Design & Development by Innovadors Lab </a>

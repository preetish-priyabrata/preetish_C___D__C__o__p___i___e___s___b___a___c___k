...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/javascript"></script>
    ...
    <link rel="stylesheet" type="text/css" href="css/header.css">
     <link rel="stylesheet" type="text/css" href="css/service_box1.css">
 ...
 <!-- slider -->
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
      <div class="col-sm-6">
        <img class="img-responsive" src="http://placehold.it/1000x400" alt="..." style="height: 357px;">
      </div>
 ...
 <!-- <div class="container-fluid"> -->
   <div class="container">
    <div class="row flexbox">
        <div class="col-md-3 col-sm-6 ids">

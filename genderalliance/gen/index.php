        ...
        <div class="top-bar">
          <div class="container">
            ...
            <div class="col-lg-12 col-xs-12 text-center" style="margin-top: 0px">
              ...
              <!-- <div class="col-lg-12 text-center" style="margin-top: 0px">
                <div class="sandbox sandbox-correct-pronounciation">
                  <h1 class="heading heading-correct-pronounciation">
                    <em>Gender Alliance , Bihar</em>                 
                  </h1>
    ...
    <div class="container-fluid">
      <div class="row">
        <section  class="section_menu">
          ...
          <a class="menu_id" href=""><b>Elimainate Under Age Marriage</b></a>
        </section>

        <section  class="section_menu">
        <!--   <code>&#60;section&#62; <br> float: left;</code> -->
        <a class="menu_id" href=""><b>Elimainate Of Dowry</b></a>
        </section>

        <section  class="section_menu">
          <!-- <code>&#60;section&#62; <br> float: left;</code> -->
          <a class="menu_id" href=""><b>Higher Education For Girls</b></a>
        </section>

         <section  class="section_menu">
          <a class="menu_id" href=""><b>Adolescent and Youth Policy</b></a>
        </section>

        <section  class="section_menu">
          <a class="menu_id" href=""><b>Leadership Opportunity</b></a>
        </section>
      </div>
    </div>
 <!-- slider -->

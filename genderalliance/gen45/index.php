    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <div class="col-sm-8">
            <img class="img-responsive" src="img/1.png" alt="..." width="725" style="height: 357px; max-width: 100%;">
          </div>
        ...
        <div class="item">
          <div class="col-sm-8">
            <img class="img-responsive" src="img/1.jpg" alt="..." width="725"  style="height: 357px; max-width: 100%;">
          </div>

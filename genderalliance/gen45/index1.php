  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <ul class="nav nav-pills nav-stacked text-center menu" id="menu">
            <li class="change_section" style="background-color: rgba(241, 75, 202, 0.98); margin-bottom: 2px; height: 4pc"><a href="#section1"><b id="change_section" style="font-size: 1em;color:white;">Eliminate Under Age Marriage</b></a></li>
            <li style="background-color: #fb1331; margin-bottom: 2px; height: 4pc"><a href="#section2"><b id="change_section" style="font-size: 1em;color: white">Elimination Of Dowry</b></a></li>
            <li style="background-color: #10f10f; margin-bottom: 2px; height: 4pc"><a href="#section3"><b sid="change_section" style="font-size: 1em;color: white">Higher Education For Girls</b></a></li>
            <li style="background-color: #28a2ec; margin-bottom: 2px; height: 4pc"><a href="#section4" ><b id="change_section" style="font-size: 1em;color:white;">Adolescent and Youth Policy</b></a></li>
            <li style="background-color: #40E0D0; height: 4pc"><a href="#section5"><b id="change_section" style="font-size: 1em;color:white;">Leadership Opportunity</b></a></li>
          </ul><br>
    </div>
    <div class="col-sm-10">

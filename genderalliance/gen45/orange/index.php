...
<html lang="en">
  ...
  <body style="padding: 0;margin: 0;">
    <div class="container-fluid" style="padding: 0;margin: 0; border-bottom: 4px solid orange;">
      <div class="row">
        <header>
        ...
        <div class="container">            
           ...
           <!--  <div class="attr-nav">
            ...
            <div class="navbar-header">
                ...
                <!-- <a class="navbar-brand" href="#brand"><img src="images/brand/logo-white.png" class="logo" alt=""></a> -->
            </div>
  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <ul class="nav nav-pills nav-stacked text-center menu" id="menu">
            <li class="change_section" style="background-color: white; border: 1px solid black; margin-bottom: 2px; height: 4pc"><a href="#section1"><b id="change_section" style="font-size: 1em;color:orange;">Eliminate Under Age Marriage</b></a></li>
            <li style="background-color: orange; margin-bottom: 2px; height: 4pc"><a href="#section2"><b id="change_section" style="font-size: 1em;color: white">Elimination Of Dowry</b></a></li>
            <li style="background-color:white; border: 1px solid black; margin-bottom: 2px; height: 4pc"><a href="#section3"><b sid="change_section" style="font-size: 1em;color: orange">Higher Education For Girls</b></a></li>
            <li style="background-color: orange; margin-bottom: 2px; height: 4pc"><a href="#section4" ><b id="change_section" style="font-size: 1em;color:white;">Adolescent and Youth Policy</b></a></li>
            <li style="background-color: white; border: 1px solid black; height: 4pc"><a href="#section5"><b id="change_section" style="font-size: 1em;color:orange;">Leadership Opportunity</b></a></li>
          </ul><br>
    </div>
    <div class="col-sm-10">
...
<div class="container" >    
  <div class="row">
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary3">
        <div class="panel-heading"><b>View That Matter</b></div>
        <div class="panel-body">
          <ul class="list_style">

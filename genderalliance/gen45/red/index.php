...
<html lang="en">
  ...
  <body style="padding: 0;margin: 0;">
    <div class="container-fluid" style="padding: 0;margin: 0; border-bottom: 4px solid red;">
      <div class="row">
        <header>
  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <ul class="nav nav-pills nav-stacked text-center menu" id="menu">
            <li class="change_section" style="background-color: black; margin-bottom: 2px; height: 4pc"><a href="#section1"><b id="change_section" style="font-size: 1em;color:red;">Eliminate Under Age Marriage</b></a></li>
            <li style="background-color: red; margin-bottom: 2px; height: 4pc"><a href="#section2"><b id="change_section" style="font-size: 1em;color: black">Elimination Of Dowry</b></a></li>
            <li style="background-color:black; margin-bottom: 2px; height: 4pc"><a href="#section3"><b sid="change_section" style="font-size: 1em;color: red">Higher Education For Girls</b></a></li>
            <li style="background-color: red; margin-bottom: 2px; height: 4pc"><a href="#section4" ><b id="change_section" style="font-size: 1em;color:black;">Adolescent and Youth Policy</b></a></li>
            <li style="background-color: black; height: 4pc"><a href="#section5"><b id="change_section" style="font-size: 1em;color:red;">Leadership Opportunity</b></a></li>
          </ul><br>
    </div>
    <div class="col-sm-10">

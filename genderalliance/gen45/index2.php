...
<html lang="en">
  ...
  <body style="padding: 0;margin: 0;">
    <div class="container-fluid" style="padding: 0;margin: 0; border-bottom: 4px solid yellow;">
      <div class="row">
        <header>
          <div  style="background-color: black">
            <img src="img/Logo.jpg" class="logo"  height="70" style="margin-left: 18px;">
          </div>
        </header>
      </div>
    </div>
           ...
           <!--  <div class="attr-nav">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" >Support Us</a>
                        <ul class="dropdown-menu">
                            <li><a href="#">Custom Menu</a></li>
                            <li><a href="#">Custom Menu</a></li>
                            <li class="dropdown">
  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <ul class="nav nav-pills nav-stacked text-center menu" id="menu">
            <li class="change_section" style="background-color: black; margin-bottom: 2px; height: 4pc"><a href="#section1"><b id="change_section" style="font-size: 1em;color:yellow;">Eliminate Under Age Marriage</b></a></li>
            <li style="background-color: yellow; margin-bottom: 2px; height: 4pc"><a href="#section2"><b id="change_section" style="font-size: 1em;color: black">Elimination Of Dowry</b></a></li>
            <li style="background-color:black; margin-bottom: 2px; height: 4pc"><a href="#section3"><b sid="change_section" style="font-size: 1em;color: yellow">Higher Education For Girls</b></a></li>
            <li style="background-color: yellow; margin-bottom: 2px; height: 4pc"><a href="#section4" ><b id="change_section" style="font-size: 1em;color:black;">Adolescent and Youth Policy</b></a></li>
            <li style="background-color: black; height: 4pc"><a href="#section5"><b id="change_section" style="font-size: 1em;color:yellow;">Leadership Opportunity</b></a></li>
          </ul><br>
    </div>
    <div class="col-sm-10">
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="item active">
              <div class="col-sm-8">
                <img class="img-responsive" src="img/1.png" alt="..." width="725" style="height: 340px; max-width: 100%;">
              </div>
            ...
            <div class="item">
              <div class="col-sm-8">
                <img class="img-responsive" src="img/1.jpg" alt="..." width="725"  style="height: 340px; max-width: 100%;">
              </div>
...
<div style="background-color: whitesmoke; margin-top: 0px; padding-top: 20px; padding-bottom: 20px; border: ">
<div class="container" >    
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">News Update</div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-success">
        <div class="panel-heading">Case Studies</div>
        <div class="panel-body">
           <ul class="list_style">
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-warning">
        <div class="panel-heading">Documents And Booklets</div>
        <div class="panel-body">
          <ul class="list_style">
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary2">
        <div class="panel-heading">View That Matter</div>
        <div class="panel-body">
          <ul class="list_style">

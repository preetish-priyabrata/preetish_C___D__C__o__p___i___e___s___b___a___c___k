    ...
    <div class="col-lg-12 ">
       <div class="table-responsive">
          <table id="example1" class="table table-bordered table-striped text-center">
            ...
            $query = "SELECT * FROM `kiit_stud_queries` WHERE `s_user_id`='$s_user_id' order By `sl_no` desc";
            ...
            <tr>
              ...
              <td>
                ...
                <!-- if status 1 then view pages should be displayed -->
                  ...
                  <?php if($status==2){?>
                    <a class="btn btn-primary btn-xs" href="admin_replied_queries_details_view.php?serial=<?=$rec['sl_no']?>">View</a>
                    <?php 
                  }
                ?>
                </td>                      
    ...
    <div class="col-lg-12 ">
       <div class="table-responsive">
          <table id="example1" class="table table-bordered table-striped text-center">
            ...
            $s_user_id=$_SESSION['admin_user'];
            $query = "SELECT * FROM `kiit_stud_queries` WHERE `s_user_id`='$s_user_id' order By `slno` desc";
            $query_exe = mysqli_query($conn,$query);
            if(mysqli_num_rows($query_exe)){
            while($rec=mysqli_fetch_array($query_exe)){    
            $x++  ;

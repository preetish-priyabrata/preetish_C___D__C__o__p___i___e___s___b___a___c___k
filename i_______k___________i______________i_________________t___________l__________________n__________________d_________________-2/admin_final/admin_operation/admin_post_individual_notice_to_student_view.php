       ...
       <div class="table-responsive">
          <table id="example1" class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              $query_friend="SELECT * FROM `kitt_admin_send_individual_notice` order by `sl_no` desc";
              ...
              <tr class="success">
                ...
                <td>  <a class="btn btn-primary btn-xs" href="admin_post_individual_notice_to_student_view_details.php?serial=<?=$rec2['sl_no']?>">View Notice</a> </td>
              </tr>

    ...
    <!-- success or error message alert -->
       ...
       <div id="container">
          <?php 
              ...
              $query = "SELECT * FROM `kitt_admin_send_group_notice` WHERE  `sl_no`='$serial'";
          ...
          <div class="row">
            <div class="col-md-12">
              <a href="admin_post_group_notice_to_student_view.php" class="btn btn-info" role="button">Back</a>
            </div>
          </div>
        </div>

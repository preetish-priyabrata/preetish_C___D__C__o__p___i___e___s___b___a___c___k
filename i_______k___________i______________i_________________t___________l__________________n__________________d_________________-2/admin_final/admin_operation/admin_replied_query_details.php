        ...
        <div class="panel-body">
          ...
          $serial=$_REQUEST['serial'];
           $s_user_id=$_SESSION['admin_user'];
            $query = "SELECT * FROM `kiit_stud_queries` WHERE `status_answer`='1' and  `sl_no`='$serial'";

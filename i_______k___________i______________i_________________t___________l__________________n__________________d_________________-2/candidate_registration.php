...
<section style="padding-top: 8pc; padding-bottom: 5pc;">
    ...
    <div class="container" >
        <div class="row">
            ...
            <form class="form-horizontal" method="POST" action="candidate_registration_save.php" enctype="multipart/form-data" autocomplete="off">
                <div class="row">
                    <div class="panel-group">
                            ...
                            <div class="panel-body" style="border: 1px solid red">
                                ...
                                <div class="col-md-4" style="border: 1px solid red; padding: 1pc !important;background-color: ghostwhite;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">    
                                                         <div class="input-group clockpicker">
                                                            <input type="text" class="form-control"  data-language='en' placeholder="Morning Calling Hour" name="Morning_TO" required="">
                                                            <span class="input-group-addon">
                                                            <span class="glyphicon glyphicon-time"></span>
                                                        </span>
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">    
                                                         <div class="input-group clockpicker">
                                                            <input type="text" name="Evenging_FROM"  class="form-control"  data-language='en' placeholder="Evenging Calling Hour" required="">
                                                            <span class="input-group-addon">
                                                            <span class="glyphicon glyphicon-time"></span>
                                                        </span>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">    
                                                         <div class="input-group clockpicker">
                                                            <input type="text" class="form-control" name="Evenging_TO"  data-language='en' placeholder="Evenging Calling Hour" required="">
                                                            <span class="input-group-addon">
                                                            <span class="glyphicon glyphicon-time"></span>
                                                        </span>
                                                        </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="email">Photo :<span style="color: red"> *</span></label>
                                            <div class="col-sm-8">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="Academic" onchange="get_info_batch()" id="academic_id" class="form-control" required="">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" name="Board_10" class="form-control"  id="Board" placeholder="Enter Your Board"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    <select name="ITI_specializaton" class="form-control" >
                                                    <option value="">--Please Select--</option>
                                                    <?php 
                                            ...
                                            <tr>
                                                ...
                                                <td><select name="Diploma_Specialization" class="form-control" >
                                                    <option value="">--Please Select--</option>
                                                    <?php 
                                                   // include 'admin_final/config.php';
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">    
                             ...
                             <input type="hidden" name="secure_hash_p" id="secure_hash_p" value="<?=web_encryptIt('Preetih_kitu')?>">

				 ...
				 <div class="panel-heading">
				    <div class="panel-title">View Course List</div>
					 	 ...
					 	 <div class="panel-body">
							...
							<tbody>
										<?php 
										 $queryActiveCourse = "SELECT * FROM `tbl_course` WHERE `status` = '3' ORDER BY `sl_no` DESC  Limit 1500";
										...
										<tr>
				                            ...
				                            <td><?php if($rowActiveCourse['course_type']==1){
						                            	echo "In-House";
						                            }else{
						                            	echo "Vendor";
						                            	} ?></td>
				                            ...
				                            <td><?php if($rowActiveCourse['status']=='3'){
				                            	echo "On-Going";
				                            ...
				                            <td>
				                            	 <div class="btn-group">
				                                    ...
				                                    <ul class="dropdown-menu">
				                                    	<li><a href="course_details_view_details.php?course=<?php echo encryptIt_webs($rowActiveCourse['sl_no']); ?>"&status=<?php echo encryptIt_webs(2); ?>">View</a></li>
				                                        
				                                        <li class="divider"></li>
				                                        <li><a href="course_details_delete.php?course=<?php echo encryptIt_webs($rowActiveCourse['sl_no']); ?>&status=<?php echo encryptIt_webs(2); ?>" onclick="return confirm('Are you sure want to completed this program .');">Completed</a></li>

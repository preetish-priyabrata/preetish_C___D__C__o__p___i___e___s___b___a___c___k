...
if (($_SESSION['userId']!="")) {
	...
	require 'FlashMessages.php';
 	...
 	$title="View In-house Ongoing Program List";
...
<style type="text/css">
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>View In-house Ongoing Program</div>
			<ul class="breadcrumb">
				<li><a href="admin_dashboard.php"></a></li>
				<li><a href="#"></a>Report</li>
				<li><a href="#"></a>On-Going Program</li>
				<li class="active">View In-house Ongoing Program</li>
			</ul>
		</div>
	</div>
		    ...
		    <!-- Basic inputs -->
			   <div class="panel panel-default">
				 <div class="panel-heading">
				    <div class="panel-title">View In-house Ongoing Program List</div>
				 	  </div>
					 	 <div class="panel-body">
					 	 	<div class="col-md-12 col-sm-12 col-lg-12">
									...
									<tbody>
												<?php 
												 $queryActiveCourse = "SELECT * FROM `tbl_course` WHERE `status` = '3' and `course_type`='1' ORDER BY `sl_no` DESC  Limit 1500";
												...
												<tr>
												    <td><?=$i?></td>
						                            <td><a href="course_details_view_details.php?course=<?php echo encryptIt_webs($rowActiveCourse['sl_no']); ?>&status=<?php echo encryptIt_webs(6); ?>"><?php echo $rowActiveCourse['course_name']; 
						                            ...
						                            <td>
						                            	...
						                            	<?php 
															...
															<div class="col-md-6">
																<label>
																		<a href="add_batch_view_details.php?course=<?php echo encryptIt_webs($res['sl_no']); ?>&status=<?php echo encryptIt_webs(4); ?>"><?php echo $res['batch_name'];?></a>
																</label>
															</div>
															<div class="col-md-6">
																<label>

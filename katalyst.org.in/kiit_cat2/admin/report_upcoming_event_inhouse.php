...
if (($_SESSION['userId']!="")) {
	...
	require 'FlashMessages.php';
 	...
 	$title="View In-house Upcomming Event List";
...
?>
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>View In-house Upcomming Event</div>
			<ul class="breadcrumb">
				<li><a href="admin_dashboard.php"></a></li>
				<li><a href="#"></a>Report</li>
				<li><a href="#"></a>Upcoming Events</li>
				<li class="active">View In-house Upcomming Event</li>
			</ul>
		</div>
	</div>
		    ...
		    <!-- Basic inputs -->
			   <div class="panel panel-default">
				 <div class="panel-heading">
				    <div class="panel-title">View In-house Upcomming Event List</div>
				 	  </div>
					 	 <div class="panel-body">
					 	 	<div class="col-md-12 col-sm-12 col-lg-12">
									...
									<tbody>
												<?php 
												 $queryActiveCourse = "SELECT * FROM `tbl_course` WHERE `status` = '1' and `course_type`='1' ORDER BY `sl_no` DESC  Limit 1500";
												...
												<tr>
						                            ...
						                            <?php echo $rowActiveCourse['ending_date']; ?></td>				   <td>
						                            	<?php
						                            ...
						                            <td>
						                            	 <div class="btn-group">
						                                    ...
						                                    <ul class="dropdown-menu">
						                                    	<li><a href="course_details_view_details.php?course=<?php echo encryptIt_webs($rowActiveCourse['sl_no']); ?>&status=<?php echo encryptIt_webs(4); ?>">View</a></li>

...
<!--Page Header-->
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>Add Certificate</div>
			<ul class="breadcrumb">
				<li><a href="admin_dashboard.php"></a></li>
				<li><a href="#"></a>Certificate</li>
				<li class="active">Add New Certificate </li>
			</ul>
		</div>
	</div>
	  ...
	  <div class="col-md-12 col-sm-12">
		 ...
		 <div class="panel panel-default">
		   <div class="panel-heading">
			 <div class="panel-title">Add a new certificate</div>
			   </div>
			     <div class="panel-body">
				   <form name="myFunction" class="form-horizontal" action="certificate_add_save.php" method="POST" autocomplete="off">
					 ...
					 <input type="submit" class="btn btn-info"  value="Generate Certificate" onclick="myFunction()">
				   </div>
				 </form>
			   </div>
			 </div>						
		...
		var batch_names=$('#batch_name').val();
		        if(course_names!="" ){	
		        	if(batch_names!="")	 {       	
				        $.ajax({
				            type:'POST',
							url:'./certificate_get_student.php',
	...
	function get_batch_completed(argument) {
		var course_names=$('#course_name').val();
		        if(course_names!=""){		        	
			        $.ajax({
			            type:'POST',
						url:'./add_batch_get_batch_detail.php',

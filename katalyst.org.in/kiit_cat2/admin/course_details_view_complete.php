				 ...
				 <div class="panel-heading">
				    <div class="panel-title">View Course List</div>
					 	 ...
					 	 <div class="panel-body">
							...
							<tbody>
										<?php 
										 $queryActiveCourse = "SELECT * FROM `tbl_course` WHERE `status` = '2' ORDER BY `sl_no` DESC  Limit 1500";
										...
										<tr>
				                            ...
				                            <td><?php if($rowActiveCourse['status']=='2'){
				                            	echo "Completed";
				                            ...
				                            <td>
				                            	 <div class="btn-group">
				                                    ...
				                                    <ul class="dropdown-menu">
				                                    	<li><a href="course_details_view_details.php?course=<?php echo encryptIt_webs($rowActiveCourse['sl_no']); ?>&status=<?php echo encryptIt_webs(3); ?>">View</a></li>

				 ...
				 <div class="panel-heading">
				    <div class="panel-title">View Batch List</div>
					 	 ...
					 	 <div class="panel-body">
							...
							<tbody>
										<?php 
										 $queryActiveCourse = "SELECT * FROM `tbl_batch` WHERE `status` = '3' ORDER BY `sl_no` DESC  Limit 1500";
				                            ...
				                            <td>
				                            	 <div class="btn-group">
				                                    ...
				                                    <ul class="dropdown-menu">
				                                    	<li><a href="add_batch_view_details.php?course=<?php echo encryptIt_webs($rowActiveCourse['sl_no']); ?>&status=<?php echo encryptIt_webs(3); ?>">View</a></li>				                                        
				                                        <li class="divider"></li>
				                                        <li><a href="add_batch_completed.php?program_batch=<?php echo encryptIt_webs($rowActiveCourse['sl_no']); ?>&status=<?php echo encryptIt_webs(2); ?>" onclick="return confirm('Are you sure want to completed this program batch.');">Completed</a></li>
				                                   </ul
				                            </td>
										</tr>
										<?php }?>

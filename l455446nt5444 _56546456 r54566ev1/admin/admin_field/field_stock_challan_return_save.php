...
if($_SESSION['admin_field']){
	...
	$Remarks_return=$_POST['Remarks_return'];
	$field_hsn_code=$_POST['field_hsn_code'];
    ...
    $price_charge_unit_single=$price_charge_unit[$i];
	$Remarks_return_single=$Remarks_return[$i];
	$fsindi_hsn_code=$field_hsn_code[$i];
    $fsindi_status=1;
   
    $insert_damage="INSERT INTO `lt_master_field_internal_damage_info`(`fsindi_sno`, `fsindi_challan_no`, `fsindi_primary_code`, `fsindi_secondary_code`, `fsindi_component_name`, `fsindi_component_type_id`, `fsindi_component_type_name`, `fsindi_unit`, `fsindi_qnt`, `fsindi_status`, `fsindi_date`, `fsindi_time`, `fsindi_hqlocation_id`, `fsindi_return_challan_id`, `fsindi_return_slno`, `fsindi_return_location_id`,`fsindi_hsn_code`,`price_rate_return`,`remark_return`) VALUES (NULL,'$fsindi_challan_no','$fsindi_primary_code','$fsindi_secondary_code','$fsindi_component_name','$fsindi_component_type_id','$fsindi_component_type_name','$fsindi_unit','$fsindi_qnt','$fsindi_status','$fsindi_date','$fsindi_time','$fsindi_hqlocation_id','$fsindi_return_challan_id','$fsindi_return_slno','$fsindi_return_location_id','$fsindi_hsn_code','$price_charge_unit_single','$Remarks_return_single')";
	...
	if(($sql_insert) && ($sql_update_challan)){
		$msg->success('Successfully Return of Stock To Zonal From Field');

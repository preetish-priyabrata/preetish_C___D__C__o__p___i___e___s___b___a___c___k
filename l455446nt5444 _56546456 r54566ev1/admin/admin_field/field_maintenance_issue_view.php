				 ...
				 <div class="panel-title">Create Job Card Form</div>
				                            ...
				                            <table class="table table-bordered table-hover">
												...
												while ($res=mysqli_fetch_assoc($sql_material)) {?>
													...
													<tr>
														...
														<td widtd="15%"><?=strtoupper($res['fmgd_quantity_id'])?> <?=strtoupper($res['fmgd_unit_id'])?></td>
														<td widtd="15%"><?=strtoupper($res['fmgd_issue_quantity_id'])?> <?=strtoupper($res['fmgd_unit_id'])?></td>
													</tr>
													<?php }?>
												</tbody>
											</table>
					...
					<div class="row">
					   	<div class="form-group text-center">
					 		<a href="field_mr_create_job_view.php" class="btn btn-info"  value="back">Back</a>
				   		</div>
				   	</div>
				 </form>
			</div>

...
if($_SESSION['admin_field']){
	...
	$update="UPDATE `lt_master_field_stock_info` SET `damage_loss`='$damage_loss_s',`field_qnty`='$closed',`damage_loss_status`='0',`total_price`='$update_total_price' WHERE  `field_slno`='$field_slno'";

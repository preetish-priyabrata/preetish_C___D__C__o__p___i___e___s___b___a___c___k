			...
			<div class="col-md-12 col-sm-12">
				<div class="panel panel-default">
			   		<div class="panel-heading">
						<div class="panel-title">List Of Confirmation Received From Sites Against Transfer Request Item  </div>
				    </div>
				    <div class="panel-body">
				    	<form action="hq_transfer_raise_t_gen_view_issue_save.php" method="POST"> 
			        		...
			        		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
				        		...
				        		<tbody>
				        			...
				        			<tr>
				        				...
				        				<td><?=strtoupper($result['primary_id'])?><input type="hidden" name="primary_id" value="<?=$result['primary_id']?>"></td>
				        				...
				        				<td>
				        					...
				        					<?php
				        					$get_site_info="SELECT * FROM `lt_master_hq_request_site` WHERE `requested_id`='$request_id' and `approve_status`='1' and `allowed_status`='0'";
			        							...
			        							$result2q=mysqli_fetch_assoc($sql_exe2q);
											        ...
											        <tr>
												       ...
												       <!--  <label class="checkbox-inline checkbox-right"> -->
												        	<div class="radio">
														  <label>
														  	<input required="" type="radio" name="site_slno" value="<?=$res_info['slno']?>"><?=strtoupper($result2q['zonal_name'])?></label>
															</div>
														...
														<td>
															<label><?=$res_info['allow_days']?></label>
														
														</td>
														<td>
															<label><?=$res_info['allow_quantity']?></label>
														</td>
													</tr>
											        <?php

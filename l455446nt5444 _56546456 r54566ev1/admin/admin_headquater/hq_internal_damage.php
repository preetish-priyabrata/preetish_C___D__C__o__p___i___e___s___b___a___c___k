...
?>
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i> Head Quarter Damage Update Form</div>
			<ul class="breadcrumb">
			...
			<div class="col-md-12 col-sm-12">
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">
						<form name="myFunction" class="form-horizontal" action="hq_internal_damage_save.php" method="POST">
							<div class='row'>
						      		...
						      		<table class="table table-bordered table-hover">
				        				...
				        				while ($result=mysqli_fetch_assoc($sql_Requsition_exe)) { 
											...
											<tr>
												...
												<td><input type="number" name="damage_qnty" min="1" max="<?=$result['hq_qnty']?>" required></td>
											</tr>
											<?php }?>
										</tbody>
									</table>

			        		...
			        		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
				        		...
				        		<tbody>
				        			...
				        			if($location!=""){
				        				 ...
				        				 $GET_INFO="SELECT * FROM `lt_master_zonal_material_requsition` WHERE `zmr_site_to_location_id`='$hq_id' AND `date`BETWEEN '$date_one' AND '$date_two'";
				        			}
		        				...
		        				while ($res=mysqli_fetch_assoc($sql_exe)) {
		        					...
		        					<tr>
		        						...
		        						$query_LOACTION="SELECT * FROM `lt_master_zonal_place` WHERE `hq_code`='$hq_id' and `status`='1' AND `zonal_code`='$zmr_site_from_location_id'";
			 						    ...
			 						    <td>
				        					<div class="btn-group">
			                                    ...
			                                    <ul class="dropdown-menu">
			                                        ...
			                                        <li class="divider"></li>
			                                        <li><a href="hq_requisition_challan_receive_list_view.php?token_name=<?=$lid?>&Token_id=<?=$site_list?>&access=<?php echo web_encryptIt('2')?>" target="_blank" >Material Received</a></li>
			                                    </ul>
			                                </div>
				        			   	 </td>
		        					</tr>

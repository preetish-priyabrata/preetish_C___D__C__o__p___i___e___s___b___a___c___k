					   ...
					   <form name="myFunction" class="form-horizontal" action="approver_mr_raised_detail_issued_quantity_save.php" method="POST">
					   	 <fieldset>
						   	<div class="col-lg-6 col-md-6">
						   		<div class="form-group">
								    <label class="control-label col-lg-4 col-md-4 text-right">Field Location Name :</label>
						...
						<div class="col-lg-6 col-md-6">
						   ...
						   <div class="form-group">
							    ...
							    <div class="col-lg-8 col-md-8">
										<p><?=strtoupper($fetch_check['zqcg_time'])?></p>
							   </div>
							</div>
					   </div>
					</fieldset>
					        					...
					        					<!-- <tfoot>
					        						...
					        						<?php 
					        						   ...
					        						   <tr>
						                 				...
						                 				<!-- serial no -->
				 									    <!-- <td>Primary Code</td> -->
										                <td><?=$fetch_item['zqzis_secondary_id']?></td>
					                				<?php 
										                ...
										                <!-- Machine No -->
										                <td><?=$fmrd_request_qnt=strtoupper($fetch_details['fmrd_request_qnt'])?>
										                	<?=$fmrd_request_qnt=strtoupper($fetch_details['fmrd_units_required'])?>
										                </td>
										                <!-- Request Quantity -->
										                <td><?=$zqzis_issue_qnt=strtoupper($fetch_item['zqzis_issue_qnt'])?>
										                	<?=$fmrd_request_qnt=strtoupper($fetch_details['fmrd_units_required'])?>
										                </td>
										                 <td>INR <?=$rate_unit=strtoupper($fetch_item['rate_unit'])?>
										                </td>
										                 <td>INR <?=$total_price=strtoupper($fetch_item['total_price'])?>
										                </td>
							...
							<div class="row">
								...
								<div class="col-md-5 col-sm-12">
									...
									<div class="text-center">
										...
										<p class="text-muted">Issuer Site Store</p>
									</div>
								</div>
							</div>
							<div class="row">

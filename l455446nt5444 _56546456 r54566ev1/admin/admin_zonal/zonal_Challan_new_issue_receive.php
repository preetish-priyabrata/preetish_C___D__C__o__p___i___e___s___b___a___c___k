										         ...
										         <thead>
					        						...
					        						<?php 
					        						   ...
					        						   <tr>
										                ...
										                <td>INR <?=$price_rate=strtoupper($fetch_item['price_rate'])?><input type="hidden" name="price_rate[]" id="price_rate<?=$x?>" value="<?=$fetch_item['price_rate']?>" required=""> 
										                <!--Rate-->
										                <td>INR <?=$price_total=strtoupper($fetch_item['price_total'])?><input type="hidden" name="price_total[]" value="<?=$fetch_item['price_total']?>" required="">
										                </td>
										                <!--Total price-->
										                ...
										                <td>INR <input type="number" name="cal_price[]" id="cal_price<?=$x?>" value="<?=$fetch_item['price_total']?>" min="0" max="<?=($fetch_item['price_total'])?>" readonly required="">
										                </td>

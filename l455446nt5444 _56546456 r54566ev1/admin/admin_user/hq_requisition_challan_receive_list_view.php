	...
	<div class="header">
		<div class="header-content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">View Challan Received To Issued </li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
		        				...
		        				while ($res=mysqli_fetch_assoc($sql_exe)) {
		        					...
		        					<tr>
									    ...
									    <td><?=strtoupper($res['hqcg_challan_no'])?></td>
			 						    ...
			 						    <td>
			 						    	<a class="btn btn-default btn-xs" style="background: lightgreen" href="hq_requisition_challan_receive_view.php?token_name=<?=$lid?>&Token_id=<?=$site_list?>&access=<?php echo web_encryptIt('3')?>" target="_blank" >View Detail Challan</a>

          ...
          <div class="panel-title">Edit Material Details </div>
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                <label class="control-label col-lg-4 text-right">Primary Code</label>
                 <div class="col-lg-8">
                  <input type="text" class="form-control" name="item_primary_code" value="<?php echo strtoupper($rec['item_primary_code']);?>" >
                </div>
             </div>
              <div class="form-group">
                <label class="control-label col-lg-4 text-right">Secondary Code</label>
                 <div class="col-lg-8">
                  <input type="text" class="form-control" name="item_second_code" value="<?php echo strtoupper($rec['item_second_code']);?>" >
                </div>
             </div>
             ...
             <div class="form-group">
                <label class="control-label col-lg-4 text-right">Material Name</label>
                 <div class="col-lg-8">
                   <input type="text" class="form-control" name="item_name" value="<?php echo strtoupper($rec['item_name']);?>">
               </div>
             </div>
               <div class="form-group">
                <label class="control-label col-lg-4 text-right">Material Category</label>
                 <div class="col-lg-8">
                  <input type="text" class="form-control" name="item_category_id" value="<?php echo strtoupper($rec['item_category_id']);?>" >
                </div>
             </div>
               <div class="form-group">
               <label class="control-label col-lg-4 text-right">Manufacture Name</label>
                 <div class="col-lg-8">
                  <input type="text" class="form-control" name="manufacture_name" value="<?php echo strtoupper($rec['manufacture_name']);?>" >
                </div>
             </div>
               <div class="form-group">
                <label class="control-label col-lg-4 text-right">Brand Name</label>
                 <div class="col-lg-8">
                  <input type="text" class="form-control" name="brand_name" value="<?php echo strtoupper($rec['brand_name']);?>" >
                </div>
             </div>

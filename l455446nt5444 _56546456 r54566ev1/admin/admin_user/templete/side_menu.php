        ...
        <div class="clearfix">
            <ul class="pull-right top-icons">
                ...
                <li class="dropdown user-dropdown">
                    <a class="user-name hidden-xs" data-toggle="dropdown">HeadQuater <i class="icon-more2"></i><small>Administrator</small></a>
                    ...
                    <div class="dropdown-menu no-padding">
                        <div class="user-icon text-center p-t-15">
                            ...
                            <h5 class="text-center p-b-15 text-semibold">Hi! HeadQuater</h5>
                        </div>
                        <!-- <ul class="user-links">
                 ...
                 <li class="list-title">General Setting</li>
                    ...
                    <li><a href="#"><i class="icon-stack2"></i> <span>Requsition Management</span></a>
                       <ul> 
                        ...
                        $check_mr="SELECT * FROM `lt_master_zonal_material_requsition` WHERE `status`='1' and `sent_status`='1' and `forward_status`='0'";

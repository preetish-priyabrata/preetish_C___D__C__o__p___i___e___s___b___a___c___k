...
?>
  ...
  <div class="tab-content">
      ...
      <div class="container">
        ...
        <div class="table-responsive col-lg-11">
          <table id="" class="table table-bordered table-striped text-center">
            ...
            <?php
            $query = "SELECT * FROM `master_grade_type_1_to_50`";
    ...
    <div id="menu1" class="tab-pane fade">
      <div class="container">
        <h3>Add Grade</h3>
          <form class="form-horizontal" id="reli" action="admin_grade_1_to_50_save.php" method="POST" enctype="multipart/form-data">

...
if(isset($_POST['submit']))
{
   ...
   $time=date('h:i:s');
 	 ...
 	 echo $insert_query="INSERT INTO `master_grade_type_1_to_50`(`from_point`,`to_point`,`grade`,`date`,`time`)VALUES('$from_point','$to_point','$grade','$date','$time')";
 	...
 	echo mysqli_error($conn);
		 ...
		 if($sql_exe){
						$msg->success('Success-Full Add Grade Category');
 						header("location:admin_grade_1_to_50.php");
						exit;
		    		}else{

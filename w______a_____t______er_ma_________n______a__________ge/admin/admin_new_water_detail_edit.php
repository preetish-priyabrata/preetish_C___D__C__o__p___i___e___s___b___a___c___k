...
if($_SESSION['email_id']){
 ...
 $title="Welcome To Dashboard Of Admin";
  $slno=web_decryptIt(str_replace(" ", "+", $_GET['slno']));
   $get_submenu="SELECT * FROM `ilab_water_water_details` WHERE `sl_num`='$slno'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Update Agriculture Water Details</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <form action="admin_new_water_detail_edit_save.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="box">
            ...
            <div class="form-group">
             ...
             <!--<option value="">--Select Land Type--</option> -->
                <?php 
                    ...
                    <option value="<?=$get_fetch_type['land_id']?>" <?php if($fetch_details['water_land_id']==$get_fetch_type['land_id']){ echo "Selected"; } ?> ><?=strtoupper($get_fetch_type['land_type_name'])?></option>
             <?php  }?>
                </select>
              </div>
            </div>
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input class="form-control" id="sub_menu_water" name="sub_menu_water" value="<?=($fetch_details['water_name'])?>" placeholder="Agriculture Water Menu" type="text" required="">
              </div>
            </div>
            </div>

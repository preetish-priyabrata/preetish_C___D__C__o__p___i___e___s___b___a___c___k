...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Add New Method Seasion Details
     </br>
        <small>Here It store seasion details </small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
         <li><a href="#">General Setting</a></li>
        <li><a href="#">Agriculture Seasion Details</a></li>
        <li class="active">Add New Seasion Details</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <form action="admin_new_session_detail_save.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">METHOD of SEASION</h3>
          </div>
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input class="form-control" id="session_name" name="session_name" placeholder="Method of SESSION" type="text" required="">
              </div>
            </div>

...
?>
    ...
    <!-- Content Header (Page header) -->
    	<section class="content-header">
	      <h1>
	       View Agriculture Sub Menu List
	      ...
	      <ol class="breadcrumb">
        	...
        	<li class="active">View Agriculture Sub Type</li>
	      </ol>
    	</section>
	    ...
	    <section class="content">
			...
			<div class="box">
		        <div class="box-header with-border">
		        	<h3 class="box-title">View Agriculture Sub Menu List</h3>
		        </div>
		        <div class="box-body">
					<div class="col-xs-12">
						<table id="" class="display" style="width:100%">
		        			...
		        			<tbody>
		        				<?php
		        				$x=0;
		        				 $view_query="SELECT * FROM `detail_php` where `status`!='3' ";

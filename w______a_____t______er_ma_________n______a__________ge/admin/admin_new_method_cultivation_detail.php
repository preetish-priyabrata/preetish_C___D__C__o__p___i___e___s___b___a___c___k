...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Add New Method Cultivation Type
     </br>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add New Agriculture Method Cultivation</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <form action="admin_new_method_cultivation_save.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input class="form-control" id="cultivation_name" name="cultivation_name" placeholder="Method of Cultivation" type="text" required="">
              </div>
            </div>

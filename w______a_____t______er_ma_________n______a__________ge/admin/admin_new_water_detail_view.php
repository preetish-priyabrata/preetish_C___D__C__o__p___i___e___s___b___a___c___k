					...
					<div class="col-xs-12">
						<table id="" class="display" style="width:100%">
		        			...
		        			<tbody>
		        				<?php
		        				$x=0;
		        				 $view_query="SELECT * FROM `ilab_water_water_details` where `status`!='0' ";
		        				...
		        				<tr>
		        					<td><?=$x?></td>
		        					<td><?php 
		        						$water_land_id=($view_fetch['water_land_id']);
		        						$get_land_query="SELECT * FROM `ilab_water_land_type` WHERE `land_id`='$water_land_id'";
		        					...
		        					?></td>
		        					<td><?=strtoupper($view_fetch['water_name'])?></td>
		        					<td>
		        					<?php 
		        					...
		        					<td>
		        						<a href="admin_new_water_detail_edit.php?slno=<?=web_encryptIt($view_fetch['sl_num'])?>" class="btn btn-success"> click To Edit</a>
		        					</td>
		        				</tr>
		        				<?php }?>

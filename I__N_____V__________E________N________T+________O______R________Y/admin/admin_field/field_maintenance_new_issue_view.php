				 ...
				 <div class="panel-title">Create Job Card Form</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
										<select name="maintenance_id" class="form-control">
        						    		...
        						    		<option value="predictive"  <?php if($res_get_information['maintenace_type']=='predictive'){echo "selected";}?> >PREDICTIVE
        						    		</option>
										 ...
										 <div class="table-responsive">
				                            <table class="table table-bordered table-hover">
												...
												while ($res=mysqli_fetch_assoc($sql_material)) {?>
													...
													<tr>
														<td widtd="15%"><?=strtoupper($res['fmgd_secondary_id'])?></td>
														<td widtd="15%"><?=strtoupper($res['fmgd_item_name'])?></td>
														<td widtd="15%"><?=strtoupper($res['fmgd_category_name'])?></td>
														<td widtd="15%"><?=strtoupper($res['fmgd_unit_id'])?></td>
														<td widtd="15%"><?=strtoupper($res['fmgd_available_id'])?></td>
														<td widtd="15%"><?=strtoupper($res['fmgd_quantity_id'])?></td>
														<td widtd="15%"><?=strtoupper($res['fmgd_issue_quantity_id'])?></td>
					...
					<div class="row">
					   	<div class="form-group text-center">
					 		<a href="index.php" class="btn btn-info"  value="back">Back</a>
				   		</div>
				   	</div>
				 </form>
			</div>

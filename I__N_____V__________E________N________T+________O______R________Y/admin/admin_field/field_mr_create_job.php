...
.panel-body p {
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>Maintenance Job Form</div>
			<ul class="breadcrumb">
				<li><a href="zonal_dashboard.php"></a></li>
				<li class="">Dashboards</li>
				<li class="">Maintenance job Management</li>
			   ...
			   <div class="panel-heading">
				 <div class="panel-title">Create Job Card Form</div>
				     ...
				     <div class="panel-body">
					   	<form name="myFunction" class="form-horizontal" action="field_mr_create_job_machine.php" method="GET">
							...
							<div class="form-group">
							    ...
							    <div class="col-lg-8">
									<select name="machine_no"  class="form-control" required="">
										...
										<option value="<?=$machine_no_fetch['t_unique_id_machine']?>"><?=strtoupper($machine_no_fetch['t_unique_id_machine'])?></option>
										<?php
											}
											?>
									</select>

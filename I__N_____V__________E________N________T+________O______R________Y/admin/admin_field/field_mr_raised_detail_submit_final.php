...
$title="Field User Submit Material Requsition form ";
...
.form-control[disabled], .form-control[readonly] {
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i> Submit Material Requsition Form </div>
			<ul class="breadcrumb">
				<li><a href="zonal_dashboard.php"></a></li>
				<li class="">Dashboard</li>
				<li class="">Requisition Management </li>
				<li class="">Your Site M.R Request</li>
				<li class="active">Submit Material Requisition Form </li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
				 ...
				 <div class="panel-title">Requisition Form</div>
				     ...
				     <div class="panel-body">
					   	<form name="myFunction" class="form-horizontal" action="field_mr_raised_machine_save.php" method="POST">
					   		<input type="hidden" name="form_type" value="<?=web_encryptIt('field_mr4')?>">
						   	<div class="col-lg-6">
					        					...
					        					<tbody>
					        						<?php 
										               ...
										               <td><?=strtoupper($fetch_item['fmrd_category_name'])?></td>
										                <td><?=$field_qnty?>
										                <input type="hidden" name="quantity_aval[]" value="0" required="" value="<?=$field_qnty?>">  <?=strtoupper($fetch_item['fmrd_units_required'])?></td>
										                <td>

				                              ...
				                              <table class="table table-bordered table-hover">
												...
												<tbody>
													<tr>
														...
														<!-- secondary_1 -->
														<td>
															<input type="text" data-type="productName" name="itemname[]" id="itemname_1" class="form-control autocomplete_txt" autocomplete="off" required><input type="hidden" name="itemname_id[]" id="itemname_id_1" class="form-control changesNo" autocomplete="off"  ondrop="return false;" onpaste="return false;" required>
														</td>
														<td>
...
$(".addmore").on('click',function(){
	...
	html += '<td><input type="text" data-type="productName" name="itemname[]" id="itemname_'+i+'" class="form-control autocomplete_txt" autocomplete="off"  required><input type="hidden"  name="itemname_id[]" id="itemname_id_'+i+'" class="form-control autocomplete_txt" autocomplete="off" readonly required></td>';
...
$(document).on('focus','.autocomplete_txt',function(){
	...
	if(type =='productName' )autoTypeNo=3; 	

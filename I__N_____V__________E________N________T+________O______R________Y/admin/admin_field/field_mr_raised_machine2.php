											...
											<div class="table-responsive">
				                            	<table id="example77" class="display nowrap" width="100%" cellspacing="0">
					        						...
					        						<tbody>
						        						<?php
						        							$x=0;
						        							$query_sql1="SELECT * FROM lt_master_model_item_detail c left JOIN lt_master_item_category a on a.category_name=c.item_category_id where a.status='1' and c.i_model_id='$model_id'";

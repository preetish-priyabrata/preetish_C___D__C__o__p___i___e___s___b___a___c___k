					        					...
					        					<tbody>
					        						<?php 
										               ...
										               <td><?=strtoupper($fetch_item['fmrd_category_name'])?></td>
										                ...
										                <td><a class="btn btn-success" href="field_mr_raised_remove.php?slno=<?=$slno_en?>&list=<?=$list_en?>&fmrd_slno=<?=web_encryptIt($fetch_item[fmrd_slno])?>&re=1&machine_no=<?=$machine_no?>">Remove</a></td>
						            				</tr>
					        						  <?php
					        							}
					        							?>

					        						...
					        						<?php 
					        						   ...
					        						   <tr>
									                    ...
									                    <td><input type="number" onkeyup="calculate(<?=$x?>)" min="0" max="<?=$hqzis_approve_qnt_single?>" name="zqzis_issue_qnt[]" id="issue_qnty<?=$x?>" required placeholder=" Enter Quantity"> <?=strtoupper($fetch_item['zqzis_unit'])?>
									                     ...
									                     <td>
																<input type="number" name="price[]" onkeyup="calculate(<?=$x?>)" value="<?=round($fetch_item1['price_charge_unit'],2)?>" step=".01"  id="price<?=$x?>" readonly>
															</td>
															<td>
																<input type="number" step=".01" name="totalprice[]" value="0"  id="totalprice<?=$x?>" readonly>

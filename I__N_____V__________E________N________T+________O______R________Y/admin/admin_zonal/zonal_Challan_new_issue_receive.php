						...
						<div class="col-lg-6">
							<div class="form-group">
							    ...
							    <div class="col-lg-8">
									...
									<input type="text" name="dc_no" class="form-control" placeholder="Enter DC No" value="<?=strtoupper($fetch_check['dc_no'])?>" required="">
							   </div>
							</div>
							<div class="form-group">
							    ...
							    <div class="col-lg-8">
									...
									<input type="text" name="date_enter" class="form-control" data-toggle="datepicker" placeholder="Enter Date" value="<?=strtoupper($fetch_check['date_enter'])?>" required="">
							   </div>
							</div>
							<div class="form-group">
							    ...
							    <div class="col-lg-8">
									...
									<input type="text" name="Indent_no" class="form-control" placeholder="Enter Indent No " value="<?=strtoupper($fetch_check['Indent_no'])?>" required="">
							   </div>
							</div>
							<div class="form-group">
							    ...
							    <div class="col-lg-8">
									...
									<input type="text" name="Vehicle_no" class="form-control" placeholder="Enter Vehicle No" value="<?=strtoupper($fetch_check['Vehicle_no'])?>" required="">
							   </div>
							</div>
							<div class="form-group">
							    ...
							    <div class="col-lg-8">
									...
									<input type="text" name="LR_no" class="form-control" placeholder="Enter LR No" value="<?=strtoupper($fetch_check['LR_no'])?>" required="">
							   </div>
							</div>
							<div class="form-group">
							    ...
							    <div class="col-lg-8">
									...
									<input type="text" name="LR_date" class="form-control" data-toggle="datepicker" value="<?=strtoupper($fetch_check['LR_date'])?>" placeholder="Enter LR Date" required="">
							   </div>
							</div>
							<div class="form-group">
										         ...
										         <thead>
					        						...
					        						<?php 
					        						   ...
					        						   <tr>
				 									    ...
				 									    <!-- <td>Primary Code</td> -->
										                <td><?=strtoupper($fetch_item['hqzis_secondary_id'])?>
										                ...
										                <!--item name-->
										                <td><?=$hqzis_request_qnt=strtoupper($fetch_item['hqzis_request_qnt'])?><input type="hidden" name="hqzis_request_qnt[]" value="<?=$fetch_item['hqzis_request_qnt']?>" required=""> <?=strtoupper($fetch_item['hqzis_unit'])?>
											                </td>
										                <!-- request Quantity -->
										                
										                <td><?=$hqzis_issue_qnt=strtoupper($fetch_item['hqzis_issue_qnt'])?><input type="hidden" name="hqzis_issue_qnt[]" id="hqzis_issue_qnt<?=$x?>" value="<?=$fetch_item['hqzis_issue_qnt']?>" required=""> <?=strtoupper($fetch_item['hqzis_unit'])?>
										                </td>
										                 <!-- Issued Quantity -->
											   
										                <?php $price_rate=strtoupper($fetch_item['price_rate'])?><input type="hidden" name="price_rate[]" id="price_rate<?=$x?>" value="<?=$fetch_item['price_rate']?>" required=""> 
										                <!--Rate-->
										                <?php $price_total=strtoupper($fetch_item['price_total'])?><input type="hidden" name="price_total[]" value="<?=$fetch_item['price_total']?>" required="">
										                
										                <!--Total price-->
										                
										                <td><input type="number" min="0" onkeyup="check_quntity(<?=$x?>)" id="damage<?=$x?>" name="damage[]" value="0" required="">  <?=strtoupper($fetch_item['hqzis_unit'])?>
										                </td>
										                <td><input type="number"  onkeyup="check_quntity(<?=$x?>)" min="0" id= "transit<?=$x?>" name="transit[]" value="0" required="">  <?=strtoupper($fetch_item['hqzis_unit'])?>
										                </td>
										                <td><input type="number" name="receive[]" id="receive<?=$x?>" value="<?=$fetch_item['hqzis_issue_qnt']?>" min="0" max="<?=($fetch_item['hqzis_issue_qnt'])?>" readonly required="">  <?=strtoupper($fetch_item['hqzis_unit'])?>
										                </td>
										                <input type="hidden" name="cal_price[]" id="cal_price<?=$x?>" value="<?=$fetch_item['price_total']?>" min="0" max="<?=($fetch_item['price_total'])?>" readonly required="">

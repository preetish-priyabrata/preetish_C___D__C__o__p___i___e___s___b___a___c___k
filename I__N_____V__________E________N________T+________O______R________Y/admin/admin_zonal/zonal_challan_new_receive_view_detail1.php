			...
			<div class="col-md-12 col-sm-12">
			 ...
			 <div class="panel panel-default">
			   <div class="panel-heading">
				 <div class="panel-title">Received Challan Detail</div>
				   </div>
						...
						<form name="myFunction" class="form-horizontal" action="#">
							...
							<div class="form-group">
							    ...
							    <div class="col-lg-8">
									...
									<p><?=strtoupper($fetch_check['hqcg_date'])?></p>
							   </div>
							</div>
							<div class="form-group">
										         ...
										         <thead>
					        						...
					        						<?php 
					        						   ...
					        						   <tr>
					                					...
					                					<!-- item code -->
					                					<td><?=$zmrd_name_item=strtoupper($fetch_details['zmrd_name_item'])?><input type="hidden" name="zmrd_name_item[]" value="<?=$fetch_details['zmrd_name_item']?>" required="">
										                </td>
										                <!-- Item Name -->
										                <td><?=$zmrd_machine_no=strtoupper($fetch_details['zmrd_machine_no'])?><input type="hidden" name="zmrd_machine_no[]" value="<?=$fetch_details['zmrd_machine_no']?>" required="">
										                </td>
										                <!-- Machine No -->
										                <td><?=$zmrd_request_qnt=strtoupper($fetch_details['zmrd_request_qnt'])?><input type="hidden" name="zmrd_request_qnt[]" value="<?=$fetch_details['zmrd_request_qnt']?>" required="">
										                </td>
										                <!-- Request Quantity -->
										                <td><?=$hqzis_issue_qnt=strtoupper($fetch_item['hqzis_issue_qnt'])?><input type="hidden" name="hqzis_issue_qnt[]" value="<?=$fetch_item['hqzis_issue_qnt']?>" required="">
										                </td>
										                <!-- Issued Quantity -->
										                
										                <td><?=$hqzis_received_qnty=strtoupper($fetch_item['hqzis_received_qnty'])?><input type="hidden" name="hqzis_received_qnty[]" value="<?=$fetch_item['hqzis_received_qnty']?>" required=""></td>

										                <!-- received Quantity -->

                                                         <td><?=$damage_loss=strtoupper($fetch_item['damage_loss'])?><input type="hidden" name="damage_loss[]" value="<?=$fetch_item['damage_loss']?>" required=""></td>
										               	
										                <!-- Damage Quantity -->

										                <td><?=$receive_qnty=strtoupper($fetch_item['receive_qnty'])?><input type="hidden" name="receive_qnty[]" value="<?=$fetch_item['receive_qnty']?>" required=""></td>
										                <!--Good Quantity-->

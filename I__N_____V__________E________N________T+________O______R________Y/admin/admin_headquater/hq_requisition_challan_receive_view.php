	...
	<div class="header">
		<div class="header-content">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Material Received Details</li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
			...
			<div class="col-md-12 col-sm-12">
			 ...
			 <div class="panel panel-default">
			   <div class="panel-heading">
				 <div class="panel-title">Material Received Details</div>
				   </div>
				        	...
				        	<tbody>
		        				...
		        				while ($res=mysqli_fetch_assoc($sql_exe)) {
		        					...
		        					<tr>
									    ...
									    <td>INR <?=round(($res['price_rate']*$res['hqzis_issue_qnt']),2)?></td>
									     ...
									     $total=($res['hqzis_request_qnt'])-($res['hqzis_approve_qnt']);
										     if ($total < 0){
										     	...
										     	echo "<br> Approved Quantity More Than Requsitioned Quantity";
										     }else if ($total == 0){
										     	echo abs(($res['hqzis_request_qnt'])-($res['hqzis_approve_qnt']))." ".strtoupper($res['hqzis_unit']);
										     	echo "<br> Approved Quantity Is Equal To  Requsitioned Quantity";

										     }else{
										     	echo abs(($res['hqzis_request_qnt'])-($res['hqzis_approve_qnt']))." ".strtoupper($res['hqzis_unit']);
										     	echo "<br> Approved Quantity Less Than Requsitioned Quantity";
										     }
									     ...
									     $total_issued=($res['hqzis_request_qnt'])-($res['hqzis_issue_qnt']);
										     if ($total_issued < 0){
										     	...
										     	echo "<br> Issued Quantity More Than Requsitioned Quantity";
										     }else if ($total_issued == 0){
										     	echo abs(($res['hqzis_request_qnt'])-($res['hqzis_issue_qnt']))." ".strtoupper($res['hqzis_unit']);
										     	echo "<br> Issued Quantity Is Equal To  Requsitioned Quantity";

										     }else{
										     	echo abs(($res['hqzis_request_qnt'])-($res['hqzis_issue_qnt']))." ".strtoupper($res['hqzis_unit']);
										     	echo "<br> Issued Quantity Less Than Requsitioned Quantity";
										     }
									    ...
									    <td>INR <?php echo round(($price_rate*$res['damage_loss']),2)?>
										                </td>
									    <td>
										    <?php 
						                	...
						                	?>
						                	<!-- <?=strtoupper($item_quantity=$fetch_item['item_quantity'])?> -->
										 </td>
										  <td>INR <?php echo round(($price_rate*=$fetch_transit['item_quantity']),2)?>
										                </td>

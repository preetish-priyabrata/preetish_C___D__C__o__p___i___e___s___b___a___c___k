...
?>
  ...
  <html>
    <head>
      <title>Duplicate Copy of Challan No <?=$dc_no=strtoupper($fetch_check['dc_no'])?></title>
                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td><small style='line-height:1.5; font-size:10px; margin-bottom: 0px;'><?=strtoupper($fetch_item['hqzis_item_name'])?>
                             <!-- <?=strtoupper($fetch_item['hqzis_item_category_name'])?></small> -->
                           </td>
...
<!-- <footer id="footer_is" >
    <div class="col-xs-12" style="position: fixed; bottom: 0;-webkit-transform: translateZ(0);    ">
  ...
  <div class="row" style="border: 1px solid black">
    <div class="col-xs-11 col-xs-11">
      ...
      <div id="lastDataTable"></div>
        ...
        <div class="col-xs-12" style="bottom: 0;-webkit-transform: translateZ(0);page-break-inside: auto;">
    <div class="row" style="border: 1px solid black;">
      <div class="col-xs-8 col-xs-8" style="border: 1px solid black">
           <div class="row" style="border: 0.5px solid black">
                <div class="col-xs-6 col-xs-6" style="border-right:  1px solid black">

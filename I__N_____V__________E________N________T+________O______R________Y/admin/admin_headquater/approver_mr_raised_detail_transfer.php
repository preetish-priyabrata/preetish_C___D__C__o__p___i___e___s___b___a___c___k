...
.form-control[disabled],.form-control[readonly] {
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>Details Of Material To Be Transfered</div>
			<ul class="breadcrumb">
				<li><a href="zonal_dashboard.php"></a></li>
				<li class="">Dashboards</li>
				<li class="">S.M.R Management </li>
				<li class="">S.M.R Received</li>				
				<li class="active">Details Of Material To Be Transfered</li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
			   ...
			   <div class="panel-heading">
				 <div class="panel-title">Requisition Detail</div>
				     ...
				     <div class="panel-body">
					   	<form name="myFunction" class="form-horizontal" action="approver_mr_raised_detail_transfer_section_save.php" method="POST" >
						   	...
						   	<div class="col-lg-6">
						   	 <div class="form-group">
									...
									?>
									<input type="hidden" name="zonal_code" value="<?=$zonal_code?>">
							   </div>
							</div>
							<div class="form-group">
				                           ...
				                           <table id="example77" class="display nowrap" width="100%" cellspacing="0">
					        					...
					        					<tbody>
					        						<?php 
					        							...
					        							$item="SELECT * FROM `lt_master_zonal_material_requsition_details` WHERE `zmrd_slno_id`='$slno' and `zmr_unqiue_mr_id_iteam`='$list' and `transfer_status`='0' and 	`zmrd_issue_status`='0' and `zmrd_approve_status`='1'";
					        						   ...
					        						   <tr>
										                ...
										                <input type="hidden" name="zmrd_approved_qnt[]" id="Primary<?=$x?>" value="<?=$fetch_item['zmrd_approved_qnt']?>" required="">  	

										                <td><?=strtoupper($fetch_item['zmrd_name_item'])?></td>
										              	<td><?=strtoupper($fetch_item['zmrd_units_required'])?></td>
										                <td><?=$fetch_item['zmrd_approved_qnt']?> <?=strtoupper($fetch_item['zmrd_units_required'])?>
										                </td>
														<td>
														 <?php 	if(($fetch_item['transfer_status']==0) && ($fetch_item['zmrd_issue_status']==0)){?>
										                   ...
										                   <option value="2">Transfer</option>
										               	 ...
										               	 <?php }else{?>
										               	 <input type="text" name="action[]" value="3">
										               	 <?php }?>
										                	</td> 
						            					</tr>
					        						<?php

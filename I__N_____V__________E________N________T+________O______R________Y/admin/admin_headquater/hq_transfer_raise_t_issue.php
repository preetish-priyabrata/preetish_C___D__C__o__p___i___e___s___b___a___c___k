			...
			<div class="col-md-12 col-sm-12">
				<div class="panel panel-default">
			   		<div class="panel-heading">
						<div class="panel-title">List Of Transfer M.R To Be Issued </div>
				    </div>
				        					...
				        					<div class="btn-group">
			                                    ...
			                                    <ul class="dropdown-menu">
			                                        ...
			                                        <li class="divider"></li>
			                                         ...
			                                         <li><a href="hq_transfer_raise_t_complete_transfer.php?token_name=<?=$lid?>&token_id=<?=$site_list?>&status=<?php echo web_encryptIt('3')?>" onclick="return confirm('Do you want to transfer?');" >Complete Transfer</a></l>
			                                    </ul>
			                                </div>
				        				</td>
				        			</tr>

...
if($_SESSION['admin_hq']){
	...
	$hqindi_hsn_code=$result['zsindi_hsn_code'];
	$price_rate_return=$result['rate_price_unit'];

	 $insert_damage="INSERT INTO `lt_master_hq_internal_damage_info`(`hqindi_sno`, `hqindi_primary_code`, `hqindi_secondary_code`, `hqindi_component_name`, `hqindi_component_type_id`, `hqindi_component_type_name`, `hqindi_unit`, `hqindi_qnt`, `hqindi_status`, `hqindi_date`, `hqindi_time`, `hqindi_hqlocation_id`, `hqindi_return_challan_id`, `hqindi_return_slno`, `hqindi_return_location_id`,`hqindi_hsn_code`,`price_rate_return`) VALUES (Null, '$hqindi_primary_code', '$hqindi_secondary_code', '$hqindi_component_name', '$hqindi_component_type_id', '$hqindi_component_type_name', '$hqindi_unit', '$hqindi_qnt', '$hqindi_status', '$hqindi_date', '$hqindi_time', '$hqindi_hqlocation_id', '$hqindi_return_challan_id', '$hqindi_return_slno', '$hqindi_return_location_id','$hqindi_hsn_code','$price_rate_return')";

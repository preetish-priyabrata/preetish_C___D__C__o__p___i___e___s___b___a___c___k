                ...
                <div class="row invoice-info">
                  <div class="col-xs-12">
                    <h2 class="page-header">
                      ...
                      <p style='line-height:1.5; font-size:10px; margin-bottom: 0px; margin-left: 75px; margin-top: -26px'>KANSBAHAL WORKS,<br>PO : KANSBAHAL, DIST : SUNDARGARH,<br> ODISHA, 770034 <br>+916624280241,www.lntecc.com<br>599, Annapurna Complex, Lewis Road, Khordha, Odisha, Pin-751014</p>
                ...
                <div class="col-xs-12 table-responsive">
                  <table class="table" id="table_data">
                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            <td><small style='line-height:1; font-size:10px; margin-bottom: 0px;'><?=$x?></small></td>
                            <td><small style='line-height:1; font-size:10px; margin-bottom: 0px;'><?=strtoupper($fetch_item['hqzis_hsn_id'])?></small></td>
                            <td><small style='line-height:1; font-size:10px; margin-bottom: 0px;'><?=strtoupper($fetch_item['hqzis_primary_id'])?></small></td>
                            <td><small style='line-height:1; font-size:10px; margin-bottom: 0px;'><?=strtoupper($fetch_item['hqzis_item_name'])?> <?=strtoupper($fetch_item['hqzis_item_category_name'])?></small></td>
                            <td><small style='line-height:1; font-size:10px; margin-bottom: 0px;'><?=$fetch_item['hqzis_issue_qnt']?></small> / <small style='line-height:1; font-size:10px; margin-bottom: 0px;'><?=strtoupper($fetch_item['hqzis_unit'])?> </small></td>
                            <td><small style='line-height:1; font-size:10px; margin-bottom: 0px;'><?=$price_total=round($fetch_item['price_total'],2)?></small><?php $Total_id1=$Total_id1+$price_total;?></td>
    ...
    return ($Rupees ? 'Rupees ' . $Rupees : '') . $paise . " Only";
      ...
      <div id="lastDataTable"></div>
          ...
          <div class="row">
            ...
            <div class="col-xs-6">
                <p class="text-muted well well-xs no-shadow" style="margin-top: 5px;">In Words ;- <?=strtoupper(convertToIndianCurrency($Total_id1))?></p>
             <!--  <div class="table-responsive">
                <div class="Deposit">
                  <table class="table">               
                    ...
                    <tr>
                      <th>In Words:</th>
                      <td>Rs. <p  style='line-height:1.5; font-size:10px; margin-bottom: 0px;'><?=strtoupper(convertToIndianCurrency($Total_id1))?></p></td>
                    </tr>
                </table>
              </div>        
            </div> -->
        ...
        <div class="col-xs-12" style=" bottom: 0;-webkit-transform: translateZ(0);">
      ...
      <div class="col-xs-8 col-xs-8" style="border: 1px solid black">
           <div class="row" style="border: 0.5px solid black">
                <div class="col-xs-6 col-xs-6" style="border-right:  1px solid black">
                  ...
                  <p style="line-height:1.5; font-size:10px; margin-bottom: 0px;"> <small>Our GST NO :</small><strong> 21AAACL0140P4ZS</strong></p> <p style="line-height:1.5; font-size:10px; margin-bottom: 0px;"><small>PAN NO :- </small><strong> AAACL0140P</strong></p>
                  <p style="padding: 1em"></p>
                </div>
                <div class="col-xs-6 col-xs-6" style="border-left: 1px solid black">
                  <p style="padding: 1em"></p>
                  <p style="line-height:1.5; font-size:10px; margin-bottom: 0px;"><small>From :- </small><strong> Kansbahal, Odisha</strong></p>
                  <p style="line-height:1.5; font-size:10px; margin-bottom: 0px;"><small>To :- </small><strong><small><?=strtoupper($fetch_check['place_to'])?></small></strong></p>
                  <p style="padding: 1em"></p>
                </div>
            </div>
            <div class="row">

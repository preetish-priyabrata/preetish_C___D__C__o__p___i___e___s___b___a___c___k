<?php 
// Array ( [hqcg_zonal_location_id] => zonal002 [slno_transfer_id] => 93Z/d1ygfbtPCPZ0WGuQwDDYiDCFkSlW29n6UYHfRrg= [request_id] => LfvIa2W1yZwhwgbwXT4j1K+1b6wGVpbncQcRXNk7pyk= [hqcg_date] => 2017-12-12 [hqcg_site_mr_id] => site_00_4 [hqcg_slno] => 5 [hqcg_challan_no] => HQ17-12-12/5 [hqcg_time] => 17:23:21 [example77_length] => 10 [zmrd_slno] => Array ( [0] => site_00_4 ) [hqzis_slno] => Array ( [0] => 21 ) [hqzis_primary_id] => Array ( [0] => 34567 ) [hqzis_approve_qnt] => Array ( [0] => 32 ) [hq_slno] => Array ( [0] => 10 ) [hq_qnty] => Array ( [0] => 32 ) [hqzis_issue_qnt] => Array ( [0] => 32 ) [total] => 1 [submit] => Submit ) 
session_start();
if($_SESSION['admin_hq']){
	require 'FlashMessages.php';
	include '../config.php';
	$msg = new \Preetish\FlashMessages\FlashMessages();
	 $slno_transfer_id=web_decryptIt(str_replace(" ", "+", $_POST['slno_transfer_id']));
...
##################################################################################################################
		...
		$GET_TRANSFER="UPDATE `lt_master_hq_transfer_mr_zonal` SET `status`='2',`challan_id_mr`='$hqcg_challan_no' WHERE `slno_transfer_id`='$slno_transfer_id' AND `request_id`='$request_id'";
		$GET_TRANSFER_sql=mysqli_query($conn,$GET_TRANSFER);

	        					...
	        					<tbody>
	        						<?php 
	        						    ...
	        						    <td><?php if($result['u_status']=="2"){ ?>
	        								<a href="admin_add_Users_update_status.php?u_slno=<?=web_encryptIt($result['u_slno'])?>&unq_id=<?=web_encryptIt($result['user_id'])?>&u_status=<?=web_encryptIt($result['u_status'])?>">In-Active</a>
	        							<?php }else{  ?>
	        								<a href="admin_add_Users_update_status.php?u_slno=<?=web_encryptIt($result['u_slno'])?>&unq_id=<?=web_encryptIt($result['user_id'])?>&u_status=<?=web_encryptIt($result['u_status'])?>">Active</a>
	        							<?php }?></td> 						    

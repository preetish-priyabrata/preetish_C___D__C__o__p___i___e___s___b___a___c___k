...
// unset($_GET);
$check="SELECT * FROM `lt_master_zonal_material_requsition` where `zmr_slno`='$slno' and `zmr_unqiue_mr_id`='$list' and  `status`='1' and `forward_status`='0' ";
...
$user_id=$fetch_check['zmr_forward_id'];
// `zmr_forward_id`
?>
<style type="text/css">

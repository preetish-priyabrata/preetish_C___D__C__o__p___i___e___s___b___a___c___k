	...
	<div class="header">
		<div class="header-content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#"></a>Machine Details</li>
				<li class="active">View Machine List</li>
			</ul>
		</div>
	</div>
                              ...
                              <table id="example" class="display nowrap" width="100%" cellspacing="0">
	        					...
	        					<tbody>
	        						<?php 
	        							...
	        							<td><?=$x?></td>
	        							<td><?=strtoupper($result['machine_unique_id'])?></td>
	        							<td><?=strtoupper($result['machine_name'])?></td>
	        							<!-- <td><?=$result['client_name']?></td> -->
	        							<td>
	        								<?php 	
	        								// $rec=mysqli_fetch_assoc($exe_view);
	        								echo strtoupper($result['model_no']);
	        								?>
	        							</td>
	        						    <td><?=strtoupper($result['machine_mfg_date'])?></td>
	        							<td><?=strtoupper($result['machine_commissioning'])?></td>
	        							<td><?=strtoupper($result['m_count'])?></td>
	        							<td>

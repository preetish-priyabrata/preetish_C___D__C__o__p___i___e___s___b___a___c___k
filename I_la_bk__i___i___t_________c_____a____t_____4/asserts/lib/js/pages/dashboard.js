...
$(function() {
	$('.map-world-markers').vectorMap({
        ...
        selectedColor: chart_data_color_option6,
		scaleColors: [chart_data_color_option7, chart_data_color_option8],
		normalizeFunction: 'polynomial',
		regionStyle: {
			initial: {
				fill: chart_data_color_option2
			}
		},
		hoverOpacity: 0.8,
		hoverColor: false,
		markerStyle: {
			initial: {
				r: 5,
				'fill': chart_data_color_option3,
				'fill-opacity': 1,
				'stroke': chart_data_color_option4,
				'stroke-width' : 1,
				'stroke-opacity': 1
			},
			hover: {

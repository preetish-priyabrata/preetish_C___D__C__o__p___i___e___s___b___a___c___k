        ...
        <section class="content about">
            <div class="container">
                <div class="row sub_content">
                    <div class="who">
                    <div class="col-lg-6 col-md-6 col-sm-6 wow bounceInRight" data-wow-offset="200">
                            <div class="dividerHeading">
                                <h4><span>Mission Of Gender Alliance</span></h4>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 wow bounceInLeft" data-wow-offset="200">
                            <div class="img-about">
                                <div id="slider" class="swipe">
                                    <ul class="swipe-wrap">
                                        <li><img src="img/about/1.jpg" alt="" /></li>
                                        <li><img src="img/about/2.jpeg" alt="" /></li>
                                        <li><img src="img/about/3.png" alt="" /></li>
                                    </ul>

...
<section class="content-header">
    ...
    <li class="active"><a data-toggle="pill" href="#home">Replied Queries </a></li>
      ...
      <div class="container">
        ...
        <div class="table-responsive col-lg-11">
          <table id="" class="table table-bordered table-striped text-center">
            ...
            $query = "SELECT * FROM `master_queries_student` where `status_answer`='1' and `assign_status`='1' order By `slno` desc";
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                  <?php if($status==1){?>
                    <a class="btn btn-primary btn-xs" href="admin_user_view_replied_details_now.php?serial=<?=$rec['slno']?>">view</a>
                    <?php 
                  }
                ?>
                </td>                      

...
?>
 ...
 <div class="box">
    ...
    <li class="active"><a data-toggle="pill" href="#home"><h4>Unpublished Document</h4> </a></li>
            ...
            case '5':
             ?>
               <table class="table">
                ...
                <td><h4><b>Pdf</b></h4></td>
                <td>:</td>
                <td><iframe src="../uploads/pdf_file/<?php echo $fetch['photo'];?> " width="850" height="800"></iframe>
               </table>
             <?php
              break;
            default:
    ...
    <div class="row">
    <div class="text-center">
     <!-- <label class="radio-inline"><input type="radio" name="click" value="Rejected" required=""></label> -->

...
?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Message To Alumni</a></li>
          ...
          <div class="col-lg-12 ">
            <div class="box">
              <div class="panel panel-default">
                <div class="panel-heading text-center success">Message User Post</div>
                <div class="panel-body">
                
                  <form class="form-horizontal" action="admin_send_messages_alumni_save.php" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group text-center">
                          ...
                          <label class="radio-inline"><input type="radio" name="optradio" value="1" required>All Alumni</label>

...
?>
  ...
  <div class="content-wrapper">
    ...
    <li class="active"><a data-toggle="pill" href="#home">  List Of Unforwarded Documents </a></li>
      ...
      <div class="container">
        ...
        <div class="table-responsive col-lg-11">
          <table id="" class="table table-bordered table-striped text-center">
            ...
            <?php
            $x=0;
            $query = "SELECT * FROM `user_sharing_Info` where `admin_status`='0'";
            ...
            ?>
              ...
              <tr>
               ...
               <td><a href="admin_forword_moderator.php?sl_no=<?php echo $rec['sl_no'] ;?>" class="label label-success">Forward To Moderator</a></td>

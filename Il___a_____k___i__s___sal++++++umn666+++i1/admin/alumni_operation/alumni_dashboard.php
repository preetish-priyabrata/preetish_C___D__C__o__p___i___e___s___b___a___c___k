    ...
    <section class="content">
       ...
       <div class="row">
            ...
            ?>
                ...
                <?php }?>
                    <div class="card-body">
                        ...
                        <li class="pull-right"><a href="#" class="link-black text-sm"><i class="fa fa-comments-o margin-r-5"></i> Comments(<?=$res_admin['comment']?>)</a></li>
                      </ul>
                        <a href="admin_send_messages_alumni_group_view.php?serial=<?=$res_admin['slno']?>" class="btn btn-primary">Read More &rarr;</a>
                    </div>
            ...
            <?php
                 ...
                 if($lastpage > 1)
    {   
      echo "<div class='pagination justify-content-center mb-4'>";
        if ($page > 1)
            echo "<a href=\"$_PHP_SELF?Page=".($prev)."\" onClick='changePagination(".($prev).");'>&laquo; Previous&nbsp;&nbsp;</a>";
        else

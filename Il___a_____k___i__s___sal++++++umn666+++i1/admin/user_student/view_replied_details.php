        ...
        <div class="panel-body">
          ...
          $serial=$_REQUEST['serial'];
           $s_user_id=$_SESSION['email'];
            $query = "SELECT * FROM `master_queries_student` WHERE `s_user_id`='$s_user_id' and  `slno`='$serial'";
          ...
          <div class="row">
            <div class="col-md-12">
              <a href="alumni_replied_query.php" class="btn btn-info" role="button">Back</a>
            </div>
          </div>
        </div>

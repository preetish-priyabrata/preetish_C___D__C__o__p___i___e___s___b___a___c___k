  ...
  <div class="content-wrapper">
    ...
    <div class="col-lg-6">
      <div class="panel panel-default">
        <div class="panel-heading"> <h4><b>Url Sharing</b></h4></div>
        <div class="panel-body">
            <br>
            <form class="form-inline" action="alumni_share_url_save.php" method="POST">
            <div class="form-group">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="Photos">Url:</label>
                <div class="col-sm-10">

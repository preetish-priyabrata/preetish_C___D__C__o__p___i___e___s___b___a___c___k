...
$results_per_page='4';
 ...
 echo $query1 ="SELECT * FROM `user_sharing_info_details` where `status`='1'  ORDER BY `sl_no` desc LIMIT $start_from, $results_per_page";
...
for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
  ?>
  <li <?php if ($i==$page){ ?> class="active" <?php } ?>><a href='alumni_view_public_approved_post_details2.php?page=".$i."'><?=$i?></a></li>
 <?php           
}
?>
</ul>

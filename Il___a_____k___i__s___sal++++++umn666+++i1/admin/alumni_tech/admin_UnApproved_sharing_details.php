...
?>
  ...
  <div class="content-wrapper">
    ...
    <li class="active"><a data-toggle="pill" href="#home"> Unapproved Sharing Lists </a></li>
          ...
          <table id="" class="table table-bordered table-striped text-center">
            ...
            ?>
              ...
              <tr>
               ...
               <td><a href="admin_UnApproved_sharing_details_view.php?sl_no=<?php echo $rec['sl_no'] ;?>" class="label label-success">View</a></td> 

...
<form method="POST" action="alumni_permanent_address_insert.php" enctype="multipart/form-data">
<center>
...
<i><h3 style="color:blue; font-family: Times New Roman, Georgia, Serif;"><B><u>Permanent Address</u></B></h3></i>
...
<tr>
<td colspan="2">
<a href="alumni_present_address.php"><input type="button" name="Back" value="Back"/></a></td>
<td style="text-align: right;">
<input type="submit" name="submit" value="Save"/>
<a href="alumni_remarks_profile.php"><input type= "button" value="Next"></a>
</td>
</tr>
</form>
</table>

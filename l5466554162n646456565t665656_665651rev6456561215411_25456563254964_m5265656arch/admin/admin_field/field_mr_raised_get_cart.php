...
###################################################################################################
				$itemArray=array($result1_new['item_second_code']=>array('item_second_code'=>$item_second_code,'item_primary_code'=>$item_primary_code,'it_de_unit_m'=>$it_de_unit_m,'item_name'=>$item_name,'ITEM_MASTER_SERIAL'=>$ITEM_MASTER_SERIAL,'item_category_id'=>$item_category_id,'category_name'=>$category_name,'hsn_code'=>$hsn_code));
				// print_r($itemArray);
...
<?php
	...
	?>
					<tr>
						<td><?=$y?></td>
						<td><?php echo strtoupper($item["hsn_code"]);?></td>
					...
					<td><?php echo strtoupper($item["item_category_id"]); ?></td>					
					<td>

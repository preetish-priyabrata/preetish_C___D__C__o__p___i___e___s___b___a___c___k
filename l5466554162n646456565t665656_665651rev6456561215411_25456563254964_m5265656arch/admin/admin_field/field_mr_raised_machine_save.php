	...
	if($form_type=="field_mr1"){
		...
		if(isset($_POST['secondary_details'])){
			...
			if(!empty($machine_no_filter)){
				...
				echo $insert="INSERT INTO `lt_master_field_material_requsition`(`fmr_slno`, `fmr_site_to_location_id`, `fmr_site_from_location_id`, `fmr_user_id`, `no_items_f`, `date`, `time`,`machine_no`,`model_id`) VALUES (Null,'$fmr_site_to_location_id','$fmr_site_from_location_id','$fmr_user_id','$no_items_f','$date','$time','$machine_no','$model_id')";

										         ...
										         <thead>
					        						...
					        						<?php 
					        						   ...
					        						   <tr>
										                ...
										                <!-- Item Name -->
										                <td><?=$maintenance_id=strtoupper($fetch_details['maintenance_id'])?><input type="hidden" name="maintenance_id[]" value="<?=$fetch_details['maintenance_id']?>" required="">
										                </td>
										                <!-- Machine No -->
										                <td><?=$fmrd_request_qnt=strtoupper($fetch_details['fmrd_request_qnt'])?><input type="hidden" name="fmrd_request_qnt[]" value="<?=$fetch_details['fmrd_request_qnt']?>" required="">
										                </td>
										                <!-- Request Quantity -->
										                ...
										                <!-- Issued Quantity -->
										                 <td><?=$zqzis_received_qnty=$fetch_item['zqzis_received_qnty']?><input type="hidden" name="zqzis_received_qnty[]" value="<?=$fetch_item['zqzis_received_qnty']?>" required="">
										                </td>
										                <!--Received Quantity-->
										                  <td><?=$damage_loss=strtoupper($fetch_item['damage_loss'])?><input type="hidden" name="damage_loss[]" value="<?=$fetch_item['damage_loss']?>" required="">
										                </td>
										                <!--Damaged Quantity-->
										                 <td><?=$receive_qnty=strtoupper($fetch_item['receive_qnty'])?><input type="hidden" name="receive_qnty[]" value="<?=$fetch_item['receive_qnty']?>" required="">
										                </td>
										                <!--Acceptable Quantity -->

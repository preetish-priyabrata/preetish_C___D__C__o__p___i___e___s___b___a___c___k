				                           ...
				                           <table id="example77" class="display nowrap" width="100%" cellspacing="0">
					        					...
					        					<tbody>
					        						<?php 
										               ...
										               <td><?=$fetch_item['fmrd_category_id']?></td>
										                <td>0
										                <input type="hidden" name="quantity_aval[]" value="0" required=""> <?=$fetch_item['fmrd_units_required']?></td>
										                <td><input type="number" name="quantity_req[]" placeholder="Please Enter Quantity" min="1" value="1" required=""> <?=strtoupper($fetch_item['fmrd_units_required'])?></td>

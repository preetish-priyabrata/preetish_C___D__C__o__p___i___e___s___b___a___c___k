			                ...
			                <?php 
			        		    ...
			        		    <div class="col-lg-6">
			        		    	<div class="form-group">
									    ...
									    <div class="col-lg-8">
											<p><?php echo $result['user_email'] ;?> </p>
									   </div>
									</div>
							     </div>
			        		    ...
			        		    <div class="col-lg-6">
			        		    	<div class="form-group">
									    ...
									    <div class="col-lg-8">
											<p><?php echo $result['user_designation'] ;?> </p>
									   </div>
									</div>
			        		    </div>
			        		    ...
			        		    <div class="col-lg-6">
			        		     ...
			        		     <div class="col-lg-6">
			        		    	<div class="form-group">
									    ...
									    <div class="col-lg-8">
											<p> <?php echo $result['user_mobile'] ;?> </p>
									   </div>
									</div>
							    </div>
						 		...
						 		case '1':
                                    ...
                                    <div class="col-lg-6">
	        		    	           <div class="form-group">
							             ...
							             <div class="col-lg-8">
								     	 <p><?php echo $result['hq_store_id'] ;?></p>
                                         </div>
						     	      </div>
                                    </div>
						 			...
						 			?>
						 			 ...
						 			 <div class="col-lg-6">
	        		    	           <div class="form-group">
							             ...
							             <div class="col-lg-8">
								     	 <p> <?php echo $result['sub_site_store_id'] ;?> </p>
							           </div>
						     	      </div>
                                    </div>
						 		...
						 		case '4':
                                     ...
                                     <div class="col-lg-6">
	        		    	           <div class="form-group">
							             ...
							             <div class="col-lg-8">
								     	 <p> <?php echo $result['sub_field_store_id'] ;?> </p>
							           </div>
						     	      </div>
                                    </div>

...
if($_SESSION['admin']){
	...
	require 'config.php';
 	...
 	// insert query 
 	 $query_insert="INSERT INTO `lt_master_zonal_place`(`slno`, `zonal_name`,`address_1`,`address_2`,`address_3`,`address_4`,`address_5`,`address_6`,`address_7`,`address_8`,`hq_code`, `district_code`, `state_code`, `country_code`, `status`, `date`, `time`) VALUES (Null,'$zonal_name','$address1','$address2','$address3','$address4','$address5','$address6','$address7','$address8','$hq_code','d001','s001','c001','1','$date','$time')";
 	;

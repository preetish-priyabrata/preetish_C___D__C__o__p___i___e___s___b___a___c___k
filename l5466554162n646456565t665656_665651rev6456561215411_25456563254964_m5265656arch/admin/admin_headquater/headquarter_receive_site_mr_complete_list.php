			        	  ...
			        	  <table id="example77" class="display nowrap" width="100%" cellspacing="0">
				        		...
				        		<tbody>
				        			<?php 
				        				...
				        				// zmr_unqiue_mr_id	// 
				        				$x=0;
				        				$Requsition_query="SELECT * FROM `lt_master_zonal_material_requsition` WHERE `zmr_site_to_location_id`= '$location' and `status`='2' and `forward_status`='1' ORDER BY DATE(`approver_date`) DESC";

										         ...
										         <thead>
					        						...
					        						<?php 
					        						   ...
					        						   <tr>
					                					...
					                					<!--hsn code-->
					                				    <td><?=$hqzis_hsn_id=strtoupper($fetch_item['hqzis_hsn_id'])?><input type="hidden" name="hqzis_hsn_id[]" value="<?=$fetch_item['hqzis_hsn_id']?>" required="">
										                </td>
					                					<!-- item code -->
										                ...
										                <!-- item code -->
					                					<td><?=$hqzis_primary_id=$fetch_item['hqzis_primary_id']?><input type="hidden" name="hqzis_primary_id[]" value="<?=$fetch_item['hqzis_primary_id']?>" required="">
										                </td>
										                <!-- Item Name -->
										                ...
										                <!-- Machine No -->
										                <td><?=$hqzis_item_category_name=strtoupper($fetch_item['hqzis_item_category_name'])?><input type="hidden" name="hqzis_item_category_name[]" value="<?=$fetch_item['hqzis_item_category_name']?>" required="">
										                </td>
										                <!-- issue Quantity -->
										                ...
										                <td><?=$hqzis_approve_qnt=$fetch_item['hqzis_approve_qnt']?><input type="hidden" name="hqzis_approve_qnt[]" value="<?=$fetch_item['hqzis_approve_qnt']?>" required=""></td>

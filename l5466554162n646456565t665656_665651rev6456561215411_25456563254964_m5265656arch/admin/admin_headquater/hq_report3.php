				     ...
				     <div class="panel-body">
					   	<div class="table-responsive">
			        		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
				        		...
				        		<tbody>
				        			<?php 
				        			// `zonal_primary_code`, `zonal_component_name`, `zonal_component_id`, `zonal_category_name`, `zonal_unit`, `zonal_qnty`
				        			$x=0;
		        				...
		        				while ($res=mysqli_fetch_assoc($sql_exe)) {
		        					...
		        					<tr>
		        						<td><?=$x?></td>
									    <td><?=$res['zonal_component_name']?></td>
			 						    <td><?=$res['zonal_primary_code']?></td>
			 						    <td><?=$res['zonal_category_name']?></td>
			 						    <td><?=$res['zonal_qnty']?></td>

...
if($_SESSION['admin_hq']){
	...
	$msg = new \Preetish\FlashMessages\FlashMessages();
		...
		switch ($form_types) {
			...
			$update_query1="UPDATE `lt_master_hq_challan_generate` SET `dc_no`='$dc_no',`date_enter`='$date_enter',`Indent_no`='$Indent_no',`Vehicle_no`='$Vehicle_no',`LR_no`='$LR_no',`LR_date`='$LR_date',`Project_No`='$Project_No',`send_status`='1',`hqcg_status`='1' WHERE `hqcg_slno`='$challan_slno'";

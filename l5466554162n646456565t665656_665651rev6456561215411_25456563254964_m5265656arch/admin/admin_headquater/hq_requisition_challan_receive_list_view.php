					    ...
					    <table id="example77" class="display nowrap" width="100%" cellspacing="0">
				        	...
				        	<tbody>
		        				...
		        				while ($res=mysqli_fetch_assoc($sql_exe)) {
		        					...
		        					<tr>
		        						<td><?=$x?></td>
									    <td><?=$res['hqcg_site_mr_id']?></td>
									    <td><?=$res['hqcg_challan_no']?></td>
			 						    <td><?=$res['hqcg_date']?></td>
			 						    <td><?=$res['hqcg_time']?></td>
			 						    <td>
				        					<div class="btn-group">
			                                    ...
			                                    <ul class="dropdown-menu">
			                                        <li><a href="hq_requisition_challan_receive_view.php?token_name=<?=$lid?>&Token_id=<?=$site_list?>&access=<?php echo web_encryptIt('3')?>" target="_blank" >View  Detail Challan</a></li>
			                                        <li class="divider"></li>

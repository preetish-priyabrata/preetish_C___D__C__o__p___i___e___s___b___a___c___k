					        					...
					        					<tbody>
					        						<?php 
										               ...
										               <td><?=strtoupper($fetch_item['zmrd_category_name'])?></td>
										                ...
										                <td><input type="number" name="quantity_req[]" placeholder="Please Enter Quantity" value="<?=$fetch_item['zmrd_request_qnt']?>" > </td>

										                <td><input type="text" name="remarks_detail[]" placeholder="Please Enter Remark" value="<?=$fetch_item['remark_id']?>" ></td>

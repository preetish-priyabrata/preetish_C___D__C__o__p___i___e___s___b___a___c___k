...
// unset($_GET);
$check="SELECT * FROM `lt_master_zonal_challan_generate` where `zqcg_challan_no`='$challan' and `zqcg_status`='0'";
					        					...
					        					<tfoot>
					        						...
					        						<?php 
					        						   ...
					        						   <tr>
										                ...
										                <td><?=$hqzis_approve_qnt_single=$fetch_item['zqzis_request_qnt']?><input type="hidden" name="zqzis_approve_qnt[]" value="<?=$fetch_item['zqzis_request_qnt']?>" required="">
										                </td>
										                ...
										                <td><?=$hq_qnty_single=$fetch_item1['zonal_qnty']?>
										                ...
										                ?>
									                    <td><input type="number" min="0" max="<?=$hqzis_approve_qnt_single?>" value="<?=$hqzis_approve_qnt_single?>" name="zqzis_issue_qnt[]" placeholder=" Enter Quantity">
									                     </td>
						            					</tr>
					        						<?php
					        						}

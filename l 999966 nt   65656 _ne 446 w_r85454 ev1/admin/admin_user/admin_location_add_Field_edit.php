...
require 'FlashMessages.php';
 ...
 $title="Edit Location Field Name";
 include 'config.php';
 $slno=$_GET['slno'];
               			...
               			<input type="hidden" value="<?php echo $rec['slno']; ?>" name="slno">
							...
							<div class="form-group">
								<label class="control-label col-lg-4 text-right">Field Name</label>
								   <div class="col-lg-8">
									<input class="form-control" name="field_name" type="text" value="<?php echo strtoupper($rec['field_name']);?>"  required="">
								</div>
							 </div>
							 <div class="form-group">
								<label class="control-label col-lg-4 text-right">Field short code</label>
								   <div class="col-lg-8">
									<input class="form-control" readonly="" type="text" value="<?php echo strtoupper($rec['manual_field_code']);?>"  >
								</div>
							 </div>
							...
							<?php 
							 ...
							 <a href="admin_location_add_Field_view.php" class="btn btn-warning"  value="Back" onclick="myFunction()">Back</a>

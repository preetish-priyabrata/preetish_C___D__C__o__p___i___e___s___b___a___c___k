						   ...
						   <div class="form-group">
							...
							<div class="form-group">
							    ...
							    <div class="col-lg-8">
									...
									<p><?=$fetch_get_machine['machine_no']. " / ".$fetch_get_machine['model_id']?></p>
							   </div>
							</div>
										         ...
										         <thead>
					        						...
					        						<?php 
					        						   ...
					        						   <tr>
										                ...
										                <!-- Request Quantity -->
										                <td><?=$zqzis_issue_qnt=$fetch_item['zqzis_issue_qnt']?> <?=strtoupper($fetch_item['zqzis_unit'])?><input type="hidden" name="zqzis_issue_qnt[]" value="<?=$fetch_item['zqzis_issue_qnt']?>" required="">
										                </td>
										                <!-- Issued Quantity -->
										                <td>INR <?=$price_rate=$fetch_item['rate_unit']?><input type="hidden" name="price_rate[]" value="<?=$fetch_item['rate_unit']?>" required="">
										                </td>
										                <!--Rate-->
										                <td>INR <?=$price_total=$fetch_item['total_price']?><input type="hidden" name="price_total[]" value="<?=$fetch_item['total_price']?>" required="">
										                </td>
										                <td><input type="number" name="received[]" min="0" max="<?=$fetch_item['zqzis_issue_qnt']?>" value="<?=$fetch_item['zqzis_issue_qnt']?>" required="">
										                </td>

										                <!-- received Quantity -->
										                <td><input type="number" name="Damage[]" min="0" max="<?=$fetch_item['zqzis_issue_qnt']?>" value="0" required="">
										                </td>
										                <!-- Damage Quantity -->
										                <td><input type="number" name="transit[]" min="0" max="<?=$fetch_item['zqzis_issue_qnt']?>" value="0" required="">
										                </td>
										                <td><input type="text" name="remark[]" required="">
										                </td>
										                <!-- remark -->
						            					</tr>
					        						<?php

...
########################################################################################################
	for ($i=0; $i < count($hqzis_issue_qnt); $i++) {  //loop start here
		...
		$received_single=$received[$i];					// single receive 
		$Damage_single=$Damage[$i];	 					// single damage 
		$transit_single=$transit[$i];					// single transit 

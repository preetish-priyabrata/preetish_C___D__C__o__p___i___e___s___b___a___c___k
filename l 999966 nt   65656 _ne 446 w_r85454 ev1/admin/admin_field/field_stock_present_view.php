			        	 ...
			        	 <table id="example77" class="display nowrap" width="100%" cellspacing="0">  <thead>
				        		...
				        		<tbody>
				        			...
				        			<tr>
				        				...
				        				<td><?=strtoupper($result['field_unit'])?></td>
				        				<td><?=strtoupper($result['field_qnty'])?><?=$result['field_unit']?></td>
				        				<td><?=$result['damage_loss']?><?=$fetch_item['field_unit']?></td>
				        				<td>
				        					<div class="btn-group">
			                                    ...
			                                    <ul class="dropdown-menu">
			                                        <li><a href="field_stock_damage_view.php?token_name=<?=$lid?>&token_id=<?=$site_list?>">Damage</a></li>
			                                    </ul>
			                                </div>
				        				</td>
				        		    </tr>

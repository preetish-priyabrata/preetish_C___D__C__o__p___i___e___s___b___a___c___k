					        					...
					        					<tbody>
					        						<?php 
					        							...
					        							while ($fetch_item=mysqli_fetch_assoc($sql_item_exe)) {
						                 				...
						                 				<td><?=$x?></td>
				 									    <!-- <td>Primary Code</td> -->
										                <td><?=strtoupper($fetch_item['zmrd_second_code'])?></td>					<input type="hidden" name="slno_item[]" value="<?=$fetch_item['zmrd_slno']?>" required=""> 	    
										               <td><?=strtoupper($fetch_item['zmrd_category_name'])?></td>
										              	<td><?=strtoupper($fetch_item['zmrd_machine_no'])?></td>

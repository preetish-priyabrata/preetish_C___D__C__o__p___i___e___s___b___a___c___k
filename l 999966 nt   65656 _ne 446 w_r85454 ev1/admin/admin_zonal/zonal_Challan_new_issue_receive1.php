					        					...
					        					<tfoot>
					        						...
					        						<?php 
					        						   ...
					        						   <tr>
										                ...
										                <td><input type="number" name="received[]" min="0" max="<?=$fetch_item['hqzis_issue_qnt']?>" value="<?=$fetch_item['hqzis_issue_qnt']?>" required="">
										                </td>
										                <!-- received Quantity -->
										                <td><input type="number" name="Damage[]" min="0" max="<?=$fetch_item['hqzis_issue_qnt']?>" value="0" required="">
										                </td>
										                <!-- Damage Quantity -->

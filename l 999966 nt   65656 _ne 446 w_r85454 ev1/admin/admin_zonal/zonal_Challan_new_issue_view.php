				                           ...
				                           <table id="example77" class="display nowrap" width="100%" cellspacing="0">
										         <thead>
								                	...
								                	<!-- <?php 
										                ...
										                <!--item name-->
										                <td><?=$zqzis_request_qnt=$fetch_item['zqzis_request_qnt']?><input type="hidden" name="zqzis_request_qnt[]" value="<?=$fetch_item['zqzis_request_qnt']?>" required="">
											                </td>
										                <!-- request Quantity -->
										                ...
										                <td><?=$rate_unit=$fetch_item['rate_unit']?><input type="hidden" name="rate_unit[]" value="<?=$fetch_item['rate_unit']?>" required="">
										                </td>
										                <!--Rate-->
										                <td><?=$total_price=$fetch_item['total_price']?><input type="hidden" name="total_price[]" value="<?=$fetch_item['total_price']?>" required="">
										                </td>
										                <!--Total price-->

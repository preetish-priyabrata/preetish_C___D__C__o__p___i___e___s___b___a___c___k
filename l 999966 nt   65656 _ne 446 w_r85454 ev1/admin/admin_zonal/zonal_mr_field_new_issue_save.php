 ...
 $msg = new \Preetish\FlashMessages\FlashMessages();
   ...
   // [list_id] => site_00_1 [slno_id] => 1 [approver_id] => user_003/
        ...
        if(!empty($array_issue_primary)){
             ...
             $fmrd_hsn_code=$fetch_detail['fmrd_hsn_code'];
             ...
             $insert_query="INSERT INTO `lt_master_zonal_issue_field_info_temp`(`zqzis_slno`,`fmrd_slno`, `zqzis_challan_id`, `zqzis_zonal_mr_id`, `zqzis_primary_id`, `zqzis_secondary_id`, `zqzis_machine_id`, `zqzis_item_name`, `zqzis_item_category_name`, `zqzis_item_category_id`, `zqzis_request_qnt`, `zqzis_approve_qnt`, `zqzis_unit`, `zqzis_date`, `zqzis_time`, `zqzis_issued_status`, `zqzis_field_location_id`, `zqzis_zonal_location`,`zqzis_hsn_id`) VALUES (NULL,'$array_issue_slno_single','$challan','$zqzis_zonal_mr_id','$array_issue_primary_single','$zqzis_secondary_id','$zqzis_machine_id','$zqzis_item_name','$zqzis_item_category_name','$zqzis_item_category_id','$zqzis_request_qnt','$zqzis_request_qnt','$zqzis_unit','$date','$time','0','$zqzis_field_location_id','$zqzis_zonal_location','$fmrd_hsn_code')";

 			$query_exe=mysqli_query($conn,$insert_query);

 			$update_item="UPDATE `lt_master_field_material_requsition_details` SET `fmrd_issue_status`='2' WHERE `fmrd_slno`='$array_issue_slno_single'and `fmrd_issue_status`='0' and `fmrd_primary_code`='$array_issue_primary_single'";

...
.panel-body p {
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>Histoty Of Challan List Received By Site</div>
			<ul class="breadcrumb">
				<li><a href="zonal_dashboard.php"></a></li>
				<li class="">Dashboards</li>
				<li class="">Challan Management</li>
				<li class="active">History Of Challan Received</li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
		...
		<?php $msg->display(); ?>
			 ...
			 <div class="panel panel-default">
			   <div class="panel-heading">
				 <div class="panel-title">History Of Received Challan List</div>
				   </div>
			        		...
			        		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
				        		...
				        		<tbody>
				        			<?php 
				        				...
				        				$x=0;
				        				$Requsition_query="SELECT * FROM `lt_master_hq_challan_generate` WHERE  `hqcg_status`='1' and `hqcg_zonal_location_id`='$zonal_place' and `hqcg_receive_status`='1'";
				        				...
				        				<td>
				        					<div class="btn-group">
			                                    ...
			                                    <ul class="dropdown-menu">
			                                        <li><a href="zonal_challan_new_receive_view_detail.php?token_name=<?=$lid?>&Token_id=<?=$site_list?>&access=<?php echo web_encryptIt('3')?>" target="_blank" >View Details</a></li>

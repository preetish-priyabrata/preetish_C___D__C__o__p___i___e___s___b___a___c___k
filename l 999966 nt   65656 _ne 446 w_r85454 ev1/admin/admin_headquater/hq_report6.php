...
.panel-body p {
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>Report On Material Dispatched To Site</div>
			<ul class="breadcrumb">
				<li><a href="zonal_dashboard.php"></a></li>
				<li class="">Dashboards</li>
				<li class="">Reporting</li>
				<li class="active">Material Dispatched To Site</li>
			</ul>
		</div>
	</div>
	<!-- /Page Header-->
		...
		<?php $msg->display(); ?>
			 ...
			 <div class="panel panel-default">
			   <div class="panel-heading">
				 <div class="panel-title">Material Dispatched To Site Report</div>
				   </div>
					   	...
					   	<form name="myFunction" class="form-horizontal" action="" method="get" >
					   		...
					   		<div class="col-lg-6">
						   	 <div class="form-group">
								    ...
								    <div class="col-lg-8">
									<input type="text" required name="start_date" id="start_date" class="filter-textfields" placeholder="Start Date" value="<?=$start_date?>" />
							   </div>
							</div>
							<div class="form-group">
						...
						<div class="col-lg-6">
						   	 <div class="form-group">
								    ...
								    <div class="col-lg-8">
									 ...
									 <input type="text" name="end_date" id="end_date" class="filter-textfields" placeholder="End Date"  required value="<?=$end_date?>"/>
							   </div>
							</div>

      ...
      <div class="container">
        ...
        <div class="table-responsive col-lg-11">
          <table id="" class="table table-bordered table-striped text-center">
            ...
            <?php
            $x=0;
            $query = "SELECT * FROM `admin_user_post` where `status`='1'";
            ...
            <tr>
              ...
              <td> <img class="img-responsive" width="180" height="50px" src="../uploads/public_post/<?=$rec['attach_file']?>" alt="Photo"> </td>
              <td>
                <a href="admin_moderator_approved_user_dashboard_post_view.php?slno=<?php echo $rec['slno'] ;?>" class="label label-success">view</a></td>

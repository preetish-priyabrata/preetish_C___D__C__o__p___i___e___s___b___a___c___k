    ...
    <section class="sidebar">
      ...
      <li class="header">Admin Tech Menu</li>
        ...
        <li class="treeview">
          ...
          <a href="#">
            <i class="fa fa-braille"></i>
            <span title="Process to create any admin user.">Student Stream</span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
             <li><a href="add_student_regd_stream.php" title="Add Stream."><i class="fa fa-square"></i>Add Stream  <small style="color:green">New</small></a></li>
         
             <li><a href="add_student_redg_stream_view.php" title="View Streams."><i class="fa fa-square"></i>View Stream</a></li> 

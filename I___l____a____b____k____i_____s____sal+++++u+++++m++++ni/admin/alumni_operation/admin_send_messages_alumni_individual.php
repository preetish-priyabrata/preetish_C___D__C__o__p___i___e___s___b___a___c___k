...
?>
 ...
 <section class="content-header">
      <h1>
         Messages <small>New</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <!-- <li><a href="#"> Messages Center</a></li> -->
       <li class="active">View sent Message To  Individual</li>
      </ol>
    </section><br>
    <!-- Main content -->
       ...
       <div class="table-responsive">
          <table id="example1" class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              $query_friend="SELECT * FROM `admin_admin_post_temp` order by `slno` desc";
              ...
              <tr class="success">
                ...
                <td>  <a class="btn btn-primary btn-xs" href="Received_Message_view_admin.php?serial=<?=$rec2['slno']?>&ids_uni=<?=$rec2['slno']?>">View Message</a> </td>
              </tr>

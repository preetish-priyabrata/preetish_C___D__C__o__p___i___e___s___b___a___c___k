...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       List Of Unpublished Photos for Photo Gallery
        <small> </small>
      </h1>
      <!---<ol class="breadcrumb">
    ...
    <li class="active"><a data-toggle="pill" href="#home"> Unpublished Photos </a></li>
      ...
      <div class="container">
        ...
        <div class="table-responsive col-lg-11">
          <table id="" class="table table-bordered table-striped text-center">
            ...
            <?php
            $x=0;
            $query = "SELECT * FROM `user_gallery_upload` WHERE `operation_status`='1' and `moderator_status`='1' and `approval_status`='1' and `publish_status`='0'";

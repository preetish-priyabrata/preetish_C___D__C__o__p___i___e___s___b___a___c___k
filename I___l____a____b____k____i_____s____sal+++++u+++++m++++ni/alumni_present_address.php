...
<style type="text/css">
  ...
  <div class="container">
       <div class="panel panel-default" style="border-color: #7A90C9;  border-width: 2px;">
         <div class="panel-body">

             <div class="tab-content">
                    <div class="tab-pane fade in active" id="home">
                      <h3 class="head text-center">PRESENT ADDRESS<sup>™</sup> <span style="color:#f48260;">♥</span></h3>
                     
                      <form  method="POST" id="myForm" action="alumni_present_address_insert.php" enctype="multipart/form-data">
 ...
 <div class="col-lg-6">
     ...
     <div class="col-lg-6">
         ...
         <div class="form-group">
            ...
            <select name="State"  class="form-control" id="State"  style=" width: 500px;height: 38px;" required="">

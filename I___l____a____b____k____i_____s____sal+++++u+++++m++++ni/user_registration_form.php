          ...
          <div class="panel-body">
            <div class="container">
              ...
              <form method="POST" id="myform1" action="user_registration_form_save1.php" enctype="multipart/form-data">
                ...
                <h1 style="color:#166f29; font-family: Times New Roman, Georgia, Serif;font-size: 30px;"><center><strong>Registration For KISS Alumni </strong></center></h1>
             ...
             <tr>
              ...
              <td>:</td>
              <td><input type="email" name="email" id="email" for="email" placeholder="Enter your email"  style="border-radius:8px;"></td>
             </tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td><input type="file" name="img" id="img" for="img"  style="width: 300px;height: 31px; border-radius:8px;" required="" accept="image/x-png, image/gif, image/jpeg" > </td>
            </tr>
            <!-- <tr>

...
if($_SESSION['email_id']){
	...
	require 'FlashMessages.php';
 	...
 	$title="Bulk Entry Of Surplus Material";
?>
<style type="text/css">
                ...
                <div class="page-title-box">
                    <div class="btn-group pull-right">
                        <ol class="breadcrumb hide-phone p-0 m-0">
                            ...
                            <li class="breadcrumb-item active">Bulk Entry Surplus Material</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Bulk Entry Surplus Material </h4>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h4 class="header-title">Bulk Entry Surplus Material Form</h4>
                    </div>
                    <form action="admin_Bulk_entry_save.php" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <a href="tblsurplusmaterial.csv" download>Download Sample</a>
                            </div>
                        </div>
                        <div class="form-group row">

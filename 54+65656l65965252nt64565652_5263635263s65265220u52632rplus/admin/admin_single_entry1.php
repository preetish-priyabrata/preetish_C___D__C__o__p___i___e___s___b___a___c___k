                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="#67a8e4" id="example-color-input" type="color">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control form-control-lg" placeholder=".form-control-lg" id="example-text-input-lg" type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input-sm" class="col-sm-2 col-form-label">Small</label>
                                    <div class="col-sm-10">
                                        <input class="form-control form-control-sm" placeholder=".form-control-sm" id="example-text-input-sm" type="text">
                                    </div>
                                </div>

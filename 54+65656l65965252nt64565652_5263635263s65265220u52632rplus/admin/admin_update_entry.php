...
if($_SESSION['email_id']){
	...
	require 'FlashMessages.php';
 	...
 	$title="Update Entry Of Surplus Material";
    // Array ( [ids] => 93Z/d1ygfbtPCPZ0WGuQwDDYiDCFkSlW29n6UYHfRrg= ) 
    $slno=preetishweb_decryptIt(str_replace(" ", "+", $_GET['ids'])); //zmr_slno
                ...
                <div class="page-title-box">
                    <div class="btn-group pull-right">
                        <ol class="breadcrumb hide-phone p-0 m-0">
                            ...
                            <li class="breadcrumb-item active">Update Entry Surplus Material</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Update Entry Surplus Material </h4>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h4 class="header-title">Update Entry Surplus Material Form</h4>
                    </div>
                    ...
                    <form action="admin_update_entry_save.php" method="POST">
                        ...
                        <div class="row">
                            <div class="col-6" style="border: 1px solid lightgreen;padding: 10px">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                      <input value="<?=$get_fetch_material['surplus_job_code']?>"   type="text" class="form-control" name="Surplus_job_code" id="Surplus_job_code"  placeholder="Surplus Job Code" required="">
                                    </div>
                                </div>
                                <div class="form-group row">

			...
			<div class="col-md-12 col-sm-12">
				<div class="panel panel-default">
			   		<div class="panel-heading">
						<div class="panel-title">List Of Transfer Request Received </div>
				    </div>
			        		...
			        		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
				        		...
				        		<tbody>
				        			<?php 
				        				...
				        				$x=0;
				        				  $Requsition_query="SELECT * FROM `lt_master_hq_request_site` JOIN `lt_master_hq_transfer_mr_zonal` ON `lt_master_hq_transfer_mr_zonal`.`request_id`=`lt_master_hq_request_site`.`requested_id` WHERE `lt_master_hq_request_site`.`site_id`='$zonal_place' AND `lt_master_hq_transfer_mr_zonal`.`issue_status`='0' and `lt_master_hq_transfer_mr_zonal`.`request_status`='1' and `lt_master_hq_transfer_mr_zonal`.`issue_status`='0' and `lt_master_hq_request_site`.`approve_status`='0'  ";$sql_Requsition_exe=mysqli_query($conn,$Requsition_query);
				        				...
				        				<td>
				        					<div class="btn-group">
			                                    ...
			                                    <ul class="dropdown-menu">
			                                        ...
			                                        <li class="divider"></li>
			                                         <li><a href="zonal_transfer_raise_t_approved.php?token_name=<?=$lid?>&token_id=<?=$site_list?>&status=<?php echo web_encryptIt('3')?>" >Approve</a></li>

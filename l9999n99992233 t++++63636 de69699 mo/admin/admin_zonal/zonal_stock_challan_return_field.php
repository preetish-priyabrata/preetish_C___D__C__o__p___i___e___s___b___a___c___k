...
.form-control[disabled],.form-control[readonly] {
	...
	<div class="header">
		<div class="header-content">
			<div class="page-title"><i class="icon-display4"></i>Stock Returned Challan Received From Filed</div>
			<ul class="breadcrumb">
                       		...
                       		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
	        					...
	        					<tbody>
	        						...
	        						// `slno`, `zonal_damage_challan`, `location_to`, `status`, `approve_status`, `issue_status`, `receive_status`, `no_items`, `date_entry`, `date_approve`, `date_receive`, `date_issue`, `time_entry`, `time_approve`, `time_receive`, `time_issue`, `user_entry_id`, `user_issue_id`, `user_approve_id`, `user_receiver_id`, `location_from`
	        							$x=0;
	        							$item="SELECT * FROM `lt_master_field_challan_damage` WHERE `location_to`='$zonal_place' and `receive_status`='0'";
						                 ...
						                 <td>
				        					<div class="btn-group">
			                                    ...
			                                    <ul class="dropdown-menu">
			                                        <li><a href="zonal_stock_challan_return_field_view.php?token_name=<?=$lid?>&token_id=<?=$site_list?>" target="_blank">View Detail</a></li>
			                                         <li class="divider"></li>

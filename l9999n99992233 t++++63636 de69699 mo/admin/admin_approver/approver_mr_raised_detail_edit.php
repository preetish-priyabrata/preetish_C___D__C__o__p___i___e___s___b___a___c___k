					        					...
					        					<tbody>
					        						<?php 
					        							...
					        							while ($fetch_item=mysqli_fetch_assoc($sql_item_exe)) {
					        								...
					        								<tr>
						                 				<td><?=$x?></td>
				 									    <td><?=$fetch_item['zmrd_primary_code']?></td>
										                <td><?=$fetch_item['zmrd_second_code']?></td>		<input type="hidden" name="slno_item[]" value="<?=$fetch_item['zmrd_slno']?>" required=""> 	<td><?=$fetch_item['zmrd_name_item']?></td>	 
										                <td><?=$fetch_item['zmrd_category_name']?></td>
										              	<td><?=$fetch_item['zmrd_machine_no']?></td>
										                <td><?=$fetch_item['zmrd_avaliable_qnt']?>
										                	 <?=$fetch_item['zmrd_units_required']?></td>
										                <td><?=$fetch_item['zmrd_request_qnt']?> <?=$fetch_item['zmrd_units_required']?></td>
										                <td>
															<input type="number" name="quantity_req[]" placeholder="Please Enter Quantity"  required="">
															<?=$fetch_item['zmrd_units_required']?>
														</td>
										                <td><?=$fetch_item['remark_id']?></td>
						            				</tr>
					        								<?php
					        							}
					        							?>

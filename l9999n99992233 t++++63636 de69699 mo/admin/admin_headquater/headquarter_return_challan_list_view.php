						   		...
						   		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
						      		<table class="table table-bordered table-hover">
				        				...
				        				while ($result=mysqli_fetch_assoc($sql_Requsition_exe)) { 
				        					?>
											<tr>
												<td><?=$result['zsindi_secondary_code']?></td>
						        				<td><?=$result['zsindi_component_name']?></td>
						        				<td><?=$result['zsindi_component_type_name']?></td>
						        				<td><?=$result['zsindi_qnt']?> <?=$result['zsindi_unit']?></td>
											</tr>
											<?php }?>
										</tbody>
									</table>

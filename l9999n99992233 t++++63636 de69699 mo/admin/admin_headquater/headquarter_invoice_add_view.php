						                 ...
						                 <td>
				        					<div class="btn-group">
			                                    ...
			                                    <ul class="dropdown-menu">
			                                       <li><a href="headquarter_invoice_add_view_details.php?token_name=<?=$lid?>" target="_blank">View Detail</a></li>
			                                       
			                                    </ul>
			                                    <!--  <ul class="dropdown-menu">
			                                       <li><a href="headquarter_invoice_add_view_details.php?token_name=<?=$lid?>&token_id=<?=$site_list?>" target="_blank">View Detail</a></li>

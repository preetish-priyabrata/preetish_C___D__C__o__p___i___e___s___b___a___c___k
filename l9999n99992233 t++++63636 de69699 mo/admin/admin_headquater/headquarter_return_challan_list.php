                       		...
                       		<table id="example77" class="display nowrap" width="100%" cellspacing="0">
	        					...
	        					<tbody>
	        						...
	        						// `slno`, `zonal_damage_challan`, `location_to`, `status`, `approve_status`, `issue_status`, `receive_status`, `no_items`, `date_entry`, `date_approve`, `date_receive`, `date_issue`, `time_entry`, `time_approve`, `time_receive`, `time_issue`, `user_entry_id`, `user_issue_id`, `user_approve_id`, `user_receiver_id`, `location_from`
	        							$x=0;
	        							$item="SELECT * FROM `lt_master_zonal_challan_damage` WHERE `location_to`='$location' and `receive_status`='0'";
						                 ...
						                 <td>
				        					<div class="btn-group">
			                                    ...
			                                    <ul class="dropdown-menu">
			                                       <li><a href="headquarter_return_challan_list_view.php?token_name=<?=$lid?>&token_id=<?=$site_list?>" target="_blank">View Detail</a></li>
			                                       <li class="divider"></li>
			                                       <li><a href="headquarter_return_challan_list_view_save.php?token_name=<?=$lid?>&token_id=<?=$site_list?>">Confirm Receive Of Damage</a></li>
			                                    </ul>
			                                </div>
				        				</td>
		            					</tr>

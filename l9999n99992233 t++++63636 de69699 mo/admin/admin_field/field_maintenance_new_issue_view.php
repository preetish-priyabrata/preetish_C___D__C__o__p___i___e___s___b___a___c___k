										 ...
										 <div class="table-responsive">
				                            <table class="table table-bordered table-hover">
												...
												while ($res=mysqli_fetch_assoc($sql_material)) {?>
													...
													<tr>
														<td widtd="15%"><?=$res['fmgd_secondary_id']?></td>
														<td widtd="15%"><?=$res['fmgd_item_name']?></td>
														<td widtd="15%"><?=$res['fmgd_category_name']?></td>
														<td widtd="15%"><?=$res['fmgd_unit_id']?></td>
														<td widtd="15%"><?=$res['fmgd_available_id']?></td>
														<td widtd="15%"><?=$res['fmgd_quantity_id']?></td>

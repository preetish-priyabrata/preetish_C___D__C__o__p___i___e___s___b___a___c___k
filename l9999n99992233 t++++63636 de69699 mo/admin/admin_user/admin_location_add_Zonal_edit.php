               			...
               			<input type="hidden" value="<?php echo $rec['slno']; ?>" name="slno">
							...
							<div class="form-group">
								<label class="control-label col-lg-4 text-right">Zonal Name</label>
								   <div class="col-lg-8">
									<input value="<?php echo $rec['zonal_name'];?>" class="form-control" name="zonal_name" type="text" required="">
								</div>
							 </div>
							 <div class="form-group">
								<label class="control-label col-lg-4 text-right">Address 1</label>
								<div class="col-lg-8">
									<input value="<?php echo $rec['address_1'];?>" class="form-control" name="address1" placeholder="Enter Zonal Address 1" type="text" required="">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-lg-4 text-right">Address 2</label>
								<div class="col-lg-8">
									<input value="<?php echo $rec['address_2'];?>" class="form-control" name="address2" placeholder="Enter Zonal Address 2" type="text" required="">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-lg-4 text-right">C/O</label>
								<div class="col-lg-8">
									<input value="<?php echo $rec['address_3'];?>" class="form-control" name="address3" placeholder="Enter Zonal C/O" type="text" required="">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-lg-4 text-right">PO</label>
								<div class="col-lg-8">
									<input value="<?php echo $rec['address_4'];?>" class="form-control" name="address4" placeholder="Enter Zonal PO" type="text" required="">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-lg-4 text-right">City</label>
								<div class="col-lg-8">
									<input value="<?php echo $rec['address_5'];?>" class="form-control" name="address5" placeholder="Enter Zonal City" type="text" required="">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input value="<?php echo $rec['address_6'];?>" class="form-control" name="address6" placeholder="Enter Zonal District" type="text" required="">
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-lg-4 text-right">State</label>
								<div class="col-lg-8">
									<input value="<?php echo $rec['address_7'];?>" class="form-control" name="address7" placeholder="Enter Zonal State" type="text" required="">
								</div>
							</div>
								<div class="form-group">
								<label class="control-label col-lg-4 text-right">Pin</label>
								<div class="col-lg-8">
									<input value="<?php echo $rec['address_8'];?>" class="form-control" name="address8" placeholder="Enter Zonal Pin" type="number" required="">
								</div>
							</div>
